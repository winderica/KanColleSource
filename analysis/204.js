const function204 = function (t, e, i) {
    ...
    var o = i(5), r = i(0), s = i(1), a = i(65), _ = i(8), u = i(40), l = i(14), c = i(205), h = i(637), p = i(207),
        d = function (t) {
            function e(e, i, n, l) {
                void 0 === l && (l = null);
                ...
                return c._moveCard = function () {
                    ...
                    var t = r.default.model.ship.getMst(c._mst_id), e = r.default.model.ship_graph.get(c._mst_id),
                        i = e.getCenterOffset(!1);
                    c._bonus.alpha = 1, c._bonus.initialize(t.mstID, t.name, t.shipTypeName, t.message_text, i), createjs.Tween.get(c._insert.card).to({ alpha: 0 }, 800), createjs.Tween.get(c._insert.flash).to({
                        scaleX: 3.5,
                        scaleY: 3.5
                    }, 800), createjs.Tween.get(c._bonus).to({ alpha: 1 }, 400), createjs.Tween.get(c._insert).wait(800).to({ alpha: 0 }, 200).call(function () {
