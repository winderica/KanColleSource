const function1384 = function (t, e, i) {
    ...
    var h = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function (t) {
            this.scale.x = t ? 1 : -1;
            var e = t ? 1 : 0;
            this._bg1.texture = u.BATTLE_TELOP_SP.getTexture(e), this._bg2.texture = u.BATTLE_TELOP_SP.getTexture(e)
        }, e.prototype.show = function (t) {
            createjs.Tween.get(this._bg1).wait(t).to({
                x: 305,
                y: 63,
                alpha: 1
            }, 233), createjs.Tween.get(this._bg2).wait(t).to({ x: 62, y: 767, alpha: 1 }, 233)
        }, e
        ...
        return n(e, t), e.prototype.initialize = function (t, e, i) {
            ...
            createjs.Tween.get(this._item2).wait(t).call(function () {
                _.SE.play("105")
            }).to({ x: -332, y: 636, alpha: 1 }, 233).call(function () {
                _.SE.play("109")
            }), createjs.Tween.get(this._item3).wait(t).to({ x: 326, y: 54, alpha: 1 }, 233)
        }, e.prototype.hide = function (t) {
            createjs.Tween.get(this._item2).wait(t).to({
                scaleX: 2,
                scaleY: 2
            }, 500), createjs.Tween.get(this._item3).wait(t).to({ scaleX: 2, scaleY: 2 }, 500)
        }, e
        ...
        return n(e, t), e.prototype.initialize = function (t, e, i) {
            ...
            createjs.Tween.get(this._item2).wait(t).to({
                x: -555 * e,
                alpha: 1
            }, 200), createjs.Tween.get(this._item3).wait(t).to({ x: 555 * e, alpha: 1 }, 200)
        }, e
        ...
        return n(e, t), e.prototype.initialize = function (t, e) {
            ...
            var i = t ? 1 : 0;
            this._bg.texture = u.BATTLE_TELOP_SP.getTexture(i), this._item.texture = e
        }, e.prototype.show = function (t) {
            var e = this;
            createjs.Tween.get(this._bg).wait(t).to({ x: 18, y: 399, alpha: 1 }, 366).wait(200).call(function () {
                var t = new l.Wave;
                t.initialize(), t.position.set(0, 360), e.addChild(t), t.play()
            }), createjs.Tween.get(this._item).wait(t + 166).call(function () {
                _.SE.play("105")
            }).to({ scaleX: .8, scaleY: .8, alpha: 1 }, 500).call(function () {
                _.SE.play("109")
            })
        }, e.prototype.hide = function (t) {
            createjs.Tween.get(this._item).wait(t).to({ scaleX: 1.4, scaleY: 1.4 }, 500)
        }, e
        ...
        return n(e, t), e.prototype.initialize = function (t) {
            ...
            createjs.Tween.get(this).wait(t).to({ scaleX: 1.15, scaleY: 1.15, alpha: 1 }, 200)
        }, e
    }(a.Sprite)
}