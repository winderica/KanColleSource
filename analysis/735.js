const function735 = function (t, e, i) {
    ...
    var o = i(1), r = i(108), s = i(325), a = i(34), _ = i(82), u = i(4), l = i(21), c = i(9), h = i(56),
        p = i(312), d = i(13), f = function (t) {
            function e() {
                ...
                v.name = "img_lv";
                var m = new PIXI.Sprite(l.COMMON_MAIN.getTexture(23));
                m.name = "img_houg";
                var g = new PIXI.Sprite(l.COMMON_MAIN.getTexture(24));
                g.name = "img_raig";
                ...
                return e.containerName.mask = T, e.containerName.addChild(e.textName, T), n.addChild(y), e.addChild(i, e.starRateView, e.containerName, v, e.textLevel, m, e.textHoug, g, e.textRaig, I, e.textTaiku, x, e.textSoukou, b, e.fuelMeterView, w, e.ammoMeterView, e.hpGaugeView, e.slotItemSlotContainer, e.textHp, e.shipBanner, e.changeButton, n), e._defaultPosition(), e
            }
