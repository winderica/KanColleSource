const function1093 = function (t, e, i) {
    ...
    var o = i(0), r = i(2), s = i(18), a = i(235), _ = function () {
        function t() {
        }
        ...
        return n(e, t), e.prototype._start = function () {
            ...
            var t = this, e = new s.UIImageLoader("item");
            e.add("item_ilist_medal.json"), e.add("item_ilist_medal_kou.json"), e.add("item_ilist_presentbox.json"), e.add("item_ilist_hishimochi.json"), e.add("item_ilist_sanma.json"), e.load(function () {
                t._loadSkinResource()
            })
