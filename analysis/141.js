...
const function141 = function (t, e, i) {
    ...
    var n = function () {
         ...
         * n?: number; // font size
         * o?: number; // color
         * r?: string; // font family
         */
        t.init = function (t, e, i, n, o, r) {
            void 0 === n && (n = 16),
            void 0 === o && (o = 0),
            void 0 === r && (r = "font_j");
            ...
            s.style.width = i + "px";
            var a = this._editBox;
            a.style.fontFamily = "'" + r + "'",
            a.style.width = s.style.width,
            a.style.fontSize = s.style.fontSize = n + "pt",
            a.style.color = "#" + ("000000" + o.toString(16)).slice(-6)
        };
        /*
         * set visibility
         * display: "block" | "none";
         ...
         * validate user input
         * t: string; // content
         * e: string; // default value
         * i: boolean; // don't allow ideographic space
         */
        t.validation = function (t, e, i) {
            void 0 === i && (i = !0);
            return "" != t && (0 != t.length && ((!t.match(/^\s*$|^\u3000*$/) || !i) && (t != e && !(t.length > 12))))
        };
        return t
    }();
    e.EditTextBoxUtil = n
