const function1350 = function (t, e, i) {
    ...
    var o = i(4), r = i(60), s = i(69), a = i(23), _ = i(15), u = function (t) {
        ...
        return n(e, t), e.prototype.initilize = function (t) {
            ...
            if (this.removeChildren(), this._bg = null, this._gauge = null, null != this._slotIcons) for (var t = 0, e = this._slotIcons; t < e.length; t++) {
                var i = e[t];
                i.dispose()
            }
            ...
            var i;
            i = e.length >= 5 ? t ? 124 : 122 : t ? 123 : 121, this._bg.texture = _.BATTLE_MAIN.getTexture(i)
