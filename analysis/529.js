...
const function529 = function (t, e, i) {
    ...
    var n = i(262), o = function () {
        ...
        // BMG volume
        Object.defineProperty(t.prototype, "vol_bgm", {
            get: function () {
        ...
        t.prototype.initialize = function () {
            this.vol_bgm = this.__vol_bgm__;
            this.vol_se = this.__vol_se__;
            this.vol_voice = this.__vol_voice__;
            this.voice_be_left = this.__v_beleft__;
            this.voice_duty = this.__v_duty__
        };
        // set cookie
        t.prototype.save = function () {
            var t = this.__vol_bgm__;
            /*
             * the third param of `n.CookieUtil.setItem` is time
             * if its value is `Infinity`, it will be converted to "Tue, 19 Jan 2038 03:14:07 GMT"
             * (see https://en.wikipedia.org/wiki/Year_2038_problem)
             */
            t != this.vol_bgm && n.CookieUtil.setItem(this._KEY_VOL_BGM, this.vol_bgm.toString(), 1 / 0);
            t = this.__vol_se__;
            t != this.vol_se && n.CookieUtil.setItem(this._KEY_VOL_SE, this.vol_se.toString(), 1 / 0);
            (t = this.__vol_voice__) != this.vol_voice && n.CookieUtil.setItem(this._KEY_VOL_VOICE, this.vol_voice.toString(), 1 / 0);
            var e = this.__v_beleft__;
            e != this.voice_be_left && n.CookieUtil.setItem(this._KEY_V_BELEFT, this.voice_be_left ? "1" : "0", 1 / 0);
            (e = this.__v_duty__) != this.voice_duty && n.CookieUtil.setItem(this._KEY_V_DUTY, this.voice_duty ? "1" : "0", 1 / 0)
        };
        // log
