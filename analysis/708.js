const function708 = function (t, e, i) {
    ...
    var o = i(0), r = i(49), s = i(8), a = i(109), _ = i(6), u = i(21), l = i(157), c = i(709), h = i(318),
        p = i(710), d = i(321), f = i(57), y = i(322), v = i(713), m = i(714), g = function (t) {
            function e(e) {
                ...
                i.headIndex = 0, i.PAGE_NUM = 5, i.OPEN_KEY_ITEMID = 49, i._onClickBack = function () {
                    ...
                    var e = o.default.model.deck.get(i.deckId), n = new m.PresetRegisterAPI(i.deckId, t, e.name);
            ...
            return n(e, t), e.prototype.dispose = function () {
                if (this.removeChildren(), this.btnBack.dispose(), this.presetTitle.dispose(), this.longShipBannerContainer.dispose(), this.presetEditContainer.dispose(), this.arrowTopButton.dispose(), this.arrowBottomButton.dispose(), this.presets) for (var t = 0; t < this.presets.length; t++) this.presets[t] = null;
