const function848 = function (t, e, i) {
    ...
    var o = i(849), r = i(850), s = i(82), a = i(4), _ = i(221), u = i(3), l = i(23), c = i(13), h = i(851),
        p = i(1), d = function (t) {
            function e() {
                ...
                var m = new _.RepairHpGaugeView;
                m.position.set(0, 66);
                var g = new PIXI.Container;
                g.name = "info", g.position.set(436, 20), g.addChild(n, h, p, y, v, m);
                ...
                return x.position.set(66, 36), e.addChild(i, g, b, w, e._craneContainer, x), e.useItemButton = w, e.repairShipBanner = x, e.textHp = v, e.textLevel = h, e.textName = d, e.textTime = b, e.starRateView = p, e.repairHpGaugeView = m, e.containerName = y, e.informationContainer = g, e
            }
