const function150 = function (t, e, i) {
    "use strict";
    ...
    var s = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function () {
            ...
            var t = createjs.Tween.get(this.scale, { loop: !0 }).to({ x: .75, y: .75 }, 1100).to({
                    x: 1,
                    y: 1
                }, 400).set({ x: 0, y: 0 }),
                e = createjs.Tween.get(this, { loop: !0 }).wait(1100).to({ alpha: 0 }, 400).set({ alpha: 1 });
