const function1475 = function (t, e, i) {
    ...
    var o = i(5), r = i(0), s = i(17), a = i(1), _ = i(2), u = i(22), l = i(8), c = i(58), h = i(55), p = i(14),
        d = i(1476), f = i(1477), y = i(1478), v = i(1479), m = i(1480), g = i(434), b = i(18), w = function (t) {
            ...
            switch (t) {
                ...
                case 425:
                    ...
                    o.add("battle_result_event_e5_" + e + ".json"), o.load(function () {
                        n._img1.texture = m.BATTLE_RESULT_EVENT_E5_JGKFZTHFKFJACRCM.getTexture(0), n._img2.texture = m.BATTLE_RESULT_EVENT_E5_JGKFZTHFKFJACRCM.getTexture(1), i()
