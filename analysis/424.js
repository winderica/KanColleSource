const function424 = function (t, e, i) {
    ...
    var s = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function () {
            this.texture = o.REVAMP_REVAMP.getTexture(23)
            ...
            this._tween = createjs.Tween.get(this).wait(300 * Math.random() + 300).to({ alpha: 1 }, 150).to({ alpha: 0 }, 150).call(function () {
                2 * Math.random() > 1 ? t.texture = o.REVAMP_REVAMP.getTexture(23) : t.texture = o.REVAMP_REVAMP.getTexture(24), t._tween = null, t._anim()
            })
        }, e
    }(PIXI.Sprite)
}