const function1244 = function (t, e, i) {
    ...
    var o = i(0), r = i(2), s = i(240), a = i(28), _ = i(13), u = i(1245), l = i(1246), c = i(1247), h = i(1248),
        p = i(1250), d = i(1252), f = i(1253), y = i(1257), v = i(1262), m = i(1263), g = i(1264), b = i(1265),
        w = i(1267), x = i(1269), I = i(1273), T = i(438), O = function (t) {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "battle_model", {
                ...
                39 != i || 1 != n || 13 != o && 18 != o ? 2 == r ? t = new m.CellTaskItem(this._scene, this._model) : 3 == r ? t = new v.CellTaskHappening(this._scene, this._model) : 4 == r ? t = this._createCellTaskBattle(!1) : 5 == r ? t = this._createCellTaskBattle(!0) : 6 == r ? t = new g.CellTaskFancy(this._scene, this._model) : 7 == r ? t = new b.CellTaskAirReconnaissance(this._scene, this._model) : 8 == r ? t = new w.CellTaskAnchor(this._scene, this._model) : 9 == r && (t = new x.CellTaskLanding(this._scene, this._model)) : t = new m.CellTaskItem(this._scene, this._model), null != t ? t.start(function () {
                    e._endTask()
                }) : this._endTask()
                ...
                if (this._battle_model.map_info.init(o, r, a, t, _), 1 == e.hasEventMapData()) {
                    var u = this._model.sortie.getNextCell().gauge_max, l = this._model.sortie.getNextCell().gauge_now,
                    ...
                    var u = this._model.sortie.map.defeat_required, l = u - this._model.sortie.map.defeat_count,
