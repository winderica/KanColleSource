const function945 = function (t, e, i) {
    ...
    var o = i(0), r = i(333), s = i(4), a = i(60), _ = i(123), u = i(50), l = i(6), c = i(26), h = i(356),
        p = i(946), d = i(947), f = i(949), y = i(950), v = i(951), m = i(1), g = function (t) {
            function e(e) {
    ...
    var b = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function () {
            ...
            this.removeChildren(), this._name.destroy(), this._distance.destroy(), this._status.dispose(), this._level.dispose(), this._icon.dispose(), this._over.dispose(), this._relocation.dispose()
        }, e
        ...
        return n(e, t), e.prototype.initialize = function () {
            ...
            1 != this.buttonMode && (this.buttonMode = !0, this.on(m.EventType.MOUSEOVER, this._onMouseOver), this.on(m.EventType.MOUSEOUT, this._onMouseOut), this.on(m.EventType.CLICK, this._onClick), this._lockicon.on(m.EventType.CLICK, this._onClickLockIcon))
        }, e.prototype.deactivate = function () {
            this.buttonMode = !1, this.off(m.EventType.MOUSEOVER, this._onMouseOver), this.off(m.EventType.MOUSEOUT, this._onMouseOut), this.off(m.EventType.CLICK, this._onClick), this._lockicon.off(m.EventType.CLICK, this._onClickLockIcon)
        }, e.prototype.dispose = function () {
