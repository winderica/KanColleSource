const function784 = function (t, e, i) {
    ...
    var o = i(84), r = i(334), s = i(21), a = i(209), _ = i(85), u = i(785), l = i(786), c = i(787), h = i(788),
        p = function (t) {
            function e() {
                ...
                for (var p = new PIXI.Point(54, 54), d = p.x, f = 0; f < 10; f++) {
                    var y = new PIXI.Sprite(i), v = new h.ListItem(f), m = 45 * f + p.y;
                    v.position.set(d, m), v.onClick = e._onClick, v.onClickLock = e._onClickLock, y.width += 45, y.position.set(d + 30, m + 45 - y.height), e.lines.push(y), e.listItems.push(v)
                }
