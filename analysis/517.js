...
const function517 = function (t, e, i) {
    ...
    var u = function (t) {
        ...
        n(e, t);
        // set data of owned equipments
        e.prototype.setMemData = function (t) {
            /*
             * key: equipment's (mem) id
        ...
        // set data of equipments
        e.prototype.setMstData = function (t) {
            /*
             * key: equipment's (mst) id
             * value: equipment data
             */
            this._mapMst = {};
            if (null != t) for (var e = 0, i = t; e < i.length; e++) {
        ...
        // set data of equipment categories
        e.prototype.setMstEquipTypeData = function (t) {
            /*
             * key: equipment's category id
             * value: equipment's category data
             */
        ...
        // set data of unequipped equipments
        e.prototype.setUnsetData = function (t) {
            /*
             * key: equipment's category id
             * value: array of equipment's (mem) id
             */
            this._mapUnset = {};
            for (var e in t) {
