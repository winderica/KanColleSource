const function643 = function (t, e, i) {
    ...
    var o = i(267), r = i(268), s = i(33), a = i(151), _ = i(208), u = i(125), l = i(104), c = i(644), h = i(645),
        p = i(646), d = i(647), f = i(648), y = i(649), v = i(650), m = i(652), g = i(654), b = function (t) {
            function e(e) {
                void 0 === e && (e = 0);
            ...
            return n(e, t), e.prototype.start = function () {
                ...
                switch (this._sceneId) {
                    case 0:
                        return this._isGoNextPath = !0, new v.SceneInputName(this._ev);
                    case 1:
                        return this._isGoNextPath = !0, new m.SceneSelectShip(this._ImageManager, this._ev);
                    case 2:
                ...
                e.add(new g.APIFirstShip(i)), e.add(new a.UserDataAPI), e.add(new _.UserShipAPI), e.add(new u.UserSlotItemAPI), e.start(function () {
