const function1267 = function (t, e, i) {
    ...
    var o = i(5), r = i(0), s = i(2), a = i(8), _ = i(51), u = i(22), l = i(40), c = i(58), h = i(243), p = i(20),
        d = i(242), f = i(1), y = function (t) {
            function e(e, i) {
                ...
                return n._vanishGauge = function () {
                    ...
                    n._model.sortie.getNextCell().getEOSupplyWarResult() > 0 ? (n._dialog = new m, n._dialog.position.set(o.default.width / 2, o.default.height / 2), n._dialog.initialize(), n._dialog.activate(), n._dialog.scale.set(1.2), n._dialog.alpha = 0, n._scene.view.universal_layer.addChild(n._dialog), createjs.Tween.get(n._dialog).wait(500).to({
                        scaleX: 1,
                        scaleY: 1,
                        alpha: 1
                    }, 350).call(function () {
