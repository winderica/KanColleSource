const function398 = function (t, e, i) {
    "use strict";
    ...
    var o = i(309), r = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function () {
            ...
            if (null == this._t) {
                var e = 0;
                e = 1 == this._eye_open_flag ? 3e3 * Math.random() + 200 : 200 * Math.random() + 100, this._t = createjs.Tween.get(null, { onChange: this._onUpdate }).wait(e).call(function () {
