const function1049 = function (t, e, i) {
    "use strict";
    ...
    var o, r = i(11), s = i(0), a = i(17), _ = i(3), u = i(377), l = i(232), c = i(378), h = i(1052), p = i(379),
        d = i(1053), f = i(1054), y = i(17), v = i(13), m = i(152), g = i(1);
    !function (t) {
    ...
    var b = function (t) {
        function e(e) {
            ...
            i._selected = null, i._recordRankingModel = new Array(101), i._onKeyDown = function () {
                ...
                if (i._nowComment != v.EditTextBoxUtil.text && 0 != i._validation) {
                    ...
                    var e = i._GadgetIP;
                    window.parent.postMessage(m.PostMessageType.COMMENT + "\t" + i._nowComment, e), window.addEventListener("message", i._onCallback)
                }
        ...
        return n(e, t), e.prototype.cancel = function () {
            ...
            this._recordRankingModel = null, this._recordInfoModel = null, v.EditTextBoxUtil.setVisibility(!1)
        }, e.prototype._start = function () {
            var t = this;
            this._topView.btn_back.on(g.EventType.CLICK, this._onClickBtnBack), this._topView.btn_modeInfo.on(g.EventType.CLICK, this._onClickBtnModeInfo), this._topView.btn_modeRanking.on(g.EventType.CLICK, this._onClickBtnModeRanking), this._viewInfo.btn_USER_BTN_EDIT.on(g.EventType.CLICK, this._updateComment), this._viewRanking.btn_RankMy.on(g.EventType.CLICK, function () {
                t._onClickBtnLists(0)
            }), this._viewRanking.btn_RankTop.on(g.EventType.CLICK, function () {
                t._onClickBtnLists(1)
            }), this._viewRanking.btn_Rank500.on(g.EventType.CLICK, function () {
                t._onClickBtnLists(2)
            }), this._viewRanking.btn_ArrowPrev.on(g.EventType.CLICK, function () {
                t._onClickBtnLists(3)
            }), this._viewRanking.btn_ArrowNext.on(g.EventType.CLICK, function () {
            ...
            var t = this;
            v.EditTextBoxUtil.onEventDestroy(), this._topView.btn_back.off(g.EventType.CLICK, this._onClickBtnBack), this._topView.btn_modeInfo.off(g.EventType.CLICK, this._onClickBtnModeInfo), this._topView.btn_modeRanking.off(g.EventType.CLICK, this._onClickBtnModeRanking), this._viewInfo.btn_USER_BTN_EDIT.off(g.EventType.CLICK, this._updateComment), this._viewRanking.btn_RankMy.off(g.EventType.CLICK, function () {
                t._onClickBtnLists(0)
            }), this._viewRanking.btn_RankTop.off(g.EventType.CLICK, function () {
                t._onClickBtnLists(1)
            }), this._viewRanking.btn_Rank500.off(g.EventType.CLICK, function () {
                t._onClickBtnLists(2)
            }), this._viewRanking.btn_ArrowPrev.off(g.EventType.CLICK, function () {
                t._onClickBtnLists(3)
            }), this._viewRanking.btn_ArrowNext.off(g.EventType.CLICK, function () {
                t._onClickBtnLists(4)
            })
