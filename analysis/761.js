const function761 = function (t, e, i) {
    ...
    var n = i(0), o = i(33), r = i(31), s = i(21), a = i(9), _ = i(70), u = i(330), l = i(218), c = i(331),
        h = i(762), p = i(763), d = i(764), f = i(85), y = i(765), v = i(766), m = i(767), g = i(768), b = i(86),
        w = i(52), x = i(161), I = i(779), T = i(790), O = i(808), P = i(819), C = i(825), k = i(162), M = i(6),
        S = i(828), A = i(829), j = i(109), E = i(107), N = i(830), L = i(8), B = function () {
            function t(t) {
                var e = this;
            ...
            return t.prototype.dispose = function () {
                ...
                var m = h && b.RemodelUtil.canKaizo(e.mstID, e.level);
                this.kaizoButton.update(m), this.shipDetail.update(e.name, y, e.hpNow, e.hpMax, e.starNum, o), this.shipCard.update(e, a), this.shipParameter.update(e.hpMax, e.soukou, e.kaihi, e.tousai, e.speed, e.range, e.karyoku, e.raisou, e.taiku, e.taisen, e.sakuteki, e.lucky), this._updateExtraSlot_(d, f), this._updateExtensionButton_(e, l), this._updateMarriageButton_(y, a, c);
                var g = p.length, x = 0 < g, I = 0 != p.indexOf(null), T = x && 0 == c && 0 == a, O = T && 0 == c && I;
                this._updateSlotItem_(e, p, O, T), this._updateDetachAllButton_(g, O)
