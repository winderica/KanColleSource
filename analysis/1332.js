const function1332 = function (t, e, i) {
    ...
    var o = i(5), r = i(0), s = i(2), a = i(8), _ = i(145), u = i(12), l = i(19), c = i(14), h = i(18), p = i(6),
        d = i(441), f = i(1333), y = function (t) {
    ...
    var v = function (t) {
        function e() {
            ...
            return e._bg = new _.MapBG, e._ships = new m, e._frame = new PIXI.Sprite, e._mozi_layer = new g, e.addChild(e._bg), e.addChild(e._ships), e.addChild(e._frame), e.addChild(e._mozi_layer), e
        }
