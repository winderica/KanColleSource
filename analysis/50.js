...
const function50 = function (t, e, i) {
    ...
    !function (t) {
        ...
        function e(t, e, i) {
            void 0 === i && (i = !0), null != t && (
                0 == e // sort in default way
                    ? t.sort(function (t, e) {
                        if (1 == i) {
                            // `equipTypeSp` is `api_mst_slotitem_equiptype.api_id`
                            if (t.equipTypeSp < e.equipTypeSp) return -1;
                            if (t.equipTypeSp > e.equipTypeSp) return 1
                        } else {
                            // `equipType` is different from `api_mst_slotitem_equiptype.api_id`. 大口径主砲（II） is counted into 大口径主砲, 大型電探（II） is counted into 大型電探, 艦上偵察機（II） is counted into 艦上偵察機
                            if (t.equipType < e.equipType) return -1;
                            if (t.equipType > e.equipType) return 1
                        }
                        return t.mstID < e.mstID ? -1 : t.mstID > e.mstID ? 1 : t.memID < e.memID ? -1 : t.memID > e.memID ? 1 : 0
                    })
                    : 1 == e // sort by improvement(改修) from high to low(thirdly)
                    ? t.sort(function (t, e) {
                        if (1 == i) {
                            if (t.equipTypeSp < e.equipTypeSp) return -1;
                            if (t.equipTypeSp > e.equipTypeSp) return 1
                    ...
                    : 2 == e // sort by improvement(改修) from low to high(thirdly)
                    && t.sort(function (t, e) {
                        if (1 == i) {
                            if (t.equipTypeSp < e.equipTypeSp) return -1;
                            if (t.equipTypeSp > e.equipTypeSp) return 1
        ...
        function i(t, e) {
            ...
            if (i = 0 == e || 12 == e ? n.default.model.slot.getEquipTypeAll().map(function (t, e, i) {
                ...
                for (var s in o.SlotConst.FILTERING_CATEGORIES)
                    // the same as r.push(...o.SlotConst.FILTERING_CATEGORIES[s]) isn ES6
