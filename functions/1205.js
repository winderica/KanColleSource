const function1205 = function (t, e, i) {
    "use strict";
    ...
    var o = i(2), r = i(242), s = i(427), a = i(1208), _ = i(1211), u = function (t) {
        function e(e, i) {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "model", {
            ...
            var t = this, e = new a.TaskFormationSelect(this._scene, this._option.deck_f);
            e.start(function () {
            ...
            this._scene.battle.bg.setDay(function () {
                createjs.Tween.get(t._scene.view).to({ alpha: 0 }, 300), t._scene.battle.shutter2.open(0), createjs.Tween.get(t._scene.battle).to({ alpha: 1 }, 300), new s.SallyAnimationTask(t._scene).start(function () {
                    t._cutin()
                })
            })
        }, e.prototype._cutin = function () {
            var t = this, e = this._option.deck_f.ships, i = this._option.deck_f.medal_num,
                n = this._option.deck_e.ships, o = this._option.deck_e.medal_num,
