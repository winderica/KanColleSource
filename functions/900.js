const function900 = function (t, e, i) {
    ...
    var o = i(0), r = i(1), s = i(111), a = i(34), _ = i(113), u = i(4), l = i(35), c = i(901), h = i(348),
        p = function (t) {
            function e() {
                ...
                var m = new PIXI.Sprite(l.ARSENAL_MAIN.getTexture(136));
                m.position.set(d.x, 2), m.name = c.DisassemblyTypeName.BTN, e.typeContainer.addChild(f, y, v, m), e.textAlert = new u.TextBox(15, d.color);
