        ...
        I = function (t) {
            function e(e) {
                ...
                return i._selected = null, i._UnlockSetItems = [
                    ...
                    i._listView.namePopUp[t].visible = !0, i._listView.containerName[t].visible = !1, i._listView.list_kosho_mask[t].texture = l.REVAMP_LIST.getTexture(9)
                }, i._onNamePopupMouseOut = function (t) {
                    i._listView.namePopUp[t].visible = !1, i._listView.containerName[t].visible = !0, i._listView.list_kosho_mask[t].texture = l.REVAMP_LIST.getTexture(15)
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                switch (t) {
                    ...
                    case 6:
                        return l.REVAMP_LIST.getTexture(22);
                    case 7:
                        return l.REVAMP_LIST.getTexture(23);
                    default:
                ...
                for (var t = this, e = 10 * this._ListNowPage, i = this._items.slice(e, e + 10), n = this, r = 0; r < 10; r++) ! function (e) {
                    ...
                    if (0 == r) {
                        ...
                        if (null != n._UnlockSetItems[1][i[e].memID]) {
                            var l = o.default.model.ship.get(n._UnlockSetItems[1][i[e].memID]);
                            if (l.getSlotitems().forEach(function (n) {
                                    null != n && i[e].memID == n.memID && (t._UnlockBtnParam[e] = [l.memID, s], a = !0), s++
                                }), 0 == a) {
                                var c = l.getSlotitemEx();
                                null != c && i[e].memID == c.memID && (n._UnlockBtnParam[e] = [l.memID, -1], a = !0)
                            }
                            if (a) {
                                n._listView.removeSlotItemBtn[e].visible = !0, u = "" + l.name;
                                var h = o.default.model.deck.isInDeck(l.memID);
                                n._listView.namePopUp[e].update(u, l.level, null == h ? [-1, -1] : h), n._listView.focus_txt[e].textColorChangeEnabled = !1, n._listView.list_kosho_mask[e].visible = !0
                            }
                        }
                    }
