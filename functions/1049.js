const function1049 = function (t, e, i) {
    ...
    var o = i(377), r = i(29), s = i(1050), a = i(1051), _ = i(1), u = function (t) {
        function e() {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "btn_back", {
            ...
            this._disposed = !0, this._medalist.dispose(), this._kira.dispose(), this.removeChildren(), this._btn_back.dispose(), this._btn_modeInfo.dispose(), this._btn_modeRanking.dispose()
        }, e
    }(PIXI.Container);
    e.ViewTop = u;
    var l = function (t) {
