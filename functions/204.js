const function204 = function (t, e, i) {
    "use strict";
    ...
    var o = i(5), r = i(0), s = i(1), a = i(64), _ = i(8), u = i(41), l = i(14), c = i(205), h = i(630), p = i(207),
        d = function (t) {
            function e(e, i, n) {
                void 0 === n && (n = null);
                ...
                return l._moveCard = function () {
                    ...
                    a.TweenUtil.create3BezierTween(l._insert.card, t, i, n, e, 700), createjs.Tween.get(l._insert.card).to({
                        scaleX: .86,
                        scaleY: .86,
                        rotation: 4 * Math.PI
                    ...
                    var t = r.default.model.ship.getMst(l._mst_id), e = r.default.model.ship_graph.get(l._mst_id),
                        i = e.getCenterOffset(!1);
                    l._bonus.initialize(t.mstID, t.name, t.shipTypeName, t.message_text, i), createjs.Tween.get(l._insert.card).to({ alpha: 0 }, 800), createjs.Tween.get(l._insert.flash).to({
                        scaleX: 3.5,
                        scaleY: 3.5
                    }, 800), createjs.Tween.get(l._bonus).to({ alpha: 1 }, 400), createjs.Tween.get(l._insert).wait(800).to({ alpha: 0 }, 200).call(function () {
                    ...
                    e.interactive = !0, e.buttonMode = !0, l._bonus.addChild(e), l._voice = r.default.sound.voice.play(l._mst_id.toString(), 1), e.once(s.EventType.CLICK, function () {
                        r.default.sound.voice.stop(l._voice), l._voice = null, l._bonus.removeChild(e), l._finalize(t)
                    })
                }, l._layer = e, l._mst_id = i, l._pre_task = n, l
            }
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                this._insert.initialize(3), this._insert.alpha = 0, this._insert.card.scale.set(.38), this._insert.card.position.set(o.default.width / 2 - 228, o.default.height / 2 + 521), this._insert.flash.position.set(o.default.width / 2, o.default.height / 2), this._layer.addChild(this._insert), createjs.Tween.get(this._insert).to({ alpha: 1 }, 500).call(this._moveCard)
