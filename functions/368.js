const function368 = function (t, e, i) {
    "use strict";
    ...
    var a = function (t) {
        function e() {
            ...
            return e._onMouseOver = function () {
                e._stopAnimation(), e._img.texture = o.SALLY_COMMON.getTexture(37), e._over.visible = !0
        ...
        return n(e, t), e.prototype.initialize = function (t) {
            this._cb_onClick = t, this._img.texture = o.SALLY_COMMON.getTexture(35), this._over.texture = o.SALLY_COMMON.getTexture(44)
        }, e.prototype.activate = function () {
            ...
            null == this._t && (this._t = createjs.Tween.get(this), this._t.loop = !0, this._t.call(function () {
                t._img.texture = o.SALLY_COMMON.getTexture(35)
            }), this._t.wait(300), this._t.call(function () {
                t._img.texture = o.SALLY_COMMON.getTexture(36)
            }), this._t.wait(300))
        ...
        return n(e, t), e.prototype.initialize = function () {
            this.texture = o.SALLY_COMMON.getTexture(38)
        }, e
    }(PIXI.Sprite)
}