const function690 = function (t, e, i) {
    ...
    var o = i(3), r = i(4), s = i(33), a = i(1), _ = function (t) {
        function e() {
            ...
            var c = o.ORGANIZE_MAIN.getTexture(16), h = new PIXI.Sprite(c), p = o.ORGANIZE_MAIN.getTexture(8);
        ...
        return n(e, t), e.prototype.dispose = function () {
            this.removeChild(this.background), this.removeChild(this.buttonBack), this.removeChild(this.message), this.removeChild(this.firstDeckName), this.removeChild(this.secondDeckName);
            ...
            this.toFirstDeckErrorMessageView.dispose(), this.toSecondDeckErrorMessageView.dispose(), this.toFirstDeckErrorMessageView = null, this.toSecondDeckErrorMessageView = null, this.onClickYES = null, this.background = null, this.buttonBack = null, this.message = null, this.firstDeckName = null, this.secondDeckName = null, this.firstShipInDeckBanners = null, this.secondShipInDeckBanners = null, this.removeChildren()
