const function166 = function (t, e, i) {
    ...
    var n = i(0), o = i(29), r = i(224), s = function () {
        ...
        return t.convert = function (e, i, n, o) {
            ...
            if (this._slots = t, null != this._slots) {
                var n = this.slotNum;
                this._slots.length > n && this._slots.pop(), this._slots.length < n && this._slots.push(null)
            }
            this._slot_ex = e, this._tousai = i
            ...
            var e = new t(this._friend, this._practice, this._index, this.mst_id, this.mem_id, this.level, this._speed);
