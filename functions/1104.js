const function1104 = function (t, e, i) {
    "use strict";
    ...
    var o = i(0),
        ...
        l = function (t) {
            function e() {
                ...
                return e._boxes = new h, e._boxes.position.set(7, 190), e.addChild(e._boxes), e._icon = new u, e.addChild(e._icon), e._name = new c, e._name.position.set(150, 19), e.addChild(e._name), e._params = new _.SlotParamsContainer, e._params.position.set(159, 66), e.addChild(e._params), e
            }
            return n(e, t), e.prototype.dispose = function () {
                ...
                this.texture = r.ALBUM_MAIN.getTexture(92), this._boxes.initialize(), this._boxes.update(t.equipType), this._icon.update(t.iconType), this._name.update(t.equipType, t.iconType), this._params.update(t)
            }, e
        }(PIXI.Sprite);
