const function1104 = function (t, e, i) {
    ...
    var o = i(0), r = i(3), s = i(89), a = i(116), _ = i(399), l = i(1106), u = i(237), c = i(1), h = function (t) {
        function e() {
            ...
            return e._onSelect = function (t) {
                ...
                if (null != i) {
                    var n = o.default.view.overLayer, r = new u.TaskUseItem(n, i);
                    r.start(function () {
        ...
        return n(e, t), e.prototype.initialize = function () {
            ...
            for (var e = 0; e < this._icons.length; e++) {
                var i = this._icons[e], n = a.ITEMLIST_ORDER[e], r = o.default.model.useItem.get(n),
                    s = null == r ? 0 : r.count;
                i.update(n, s)
            }
