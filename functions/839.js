    ...
    var o = i(3),
        ...
        u = function (t) {
            function e() {
                ...
                return S.name = "after", S.text = "9999", S.position.set(146, 7), e._labelArr.push(S), e._useRepairKitCount.addChild(S), y.position.set(297, 516), f.position.set(580, 516), y.addListener(l.EventType.CLICK, e._onClickNO), f.addListener(l.EventType.CLICK, e._onClickYES), y.interactive = y.buttonMode = !0, f.interactive = f.buttonMode = !0, e.addChild(i, u, c, h, p, d, x, v, b, g, e._useRepairKitTime, w, y, f, n, _, m, e._useRepairKitCount), e.textName = I, e.textSteelCount = v, e.textFuelCount = b, e.textUseOption = w, e.textRequireTime = g, e.buttonYes = f, e.buttonNo = y, e.shipBanner = m, e.containerName = x, e
            }
