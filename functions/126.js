const function126 = function (t, e, i) {
    "use strict";
    ...
    var o = i(12),
        ...
        s = function (t) {
            ...
            return n(e, t), e.prototype.initialize = function () {
                ...
                var t = this;
                this._activate(), createjs.Tween.get(this._circle).to({
                    scaleX: .3,
                    scaleY: .3
                }, 200).to({
                    scaleX: .6,
                    scaleY: .6,
                    alpha: 0
                }, 200), createjs.Tween.get(this._light1.scale).to({
                    x: 1,
                    y: 1
                }, 100).wait(100).to({
                    x: 0,
                    y: 0
                }, 100), createjs.Tween.get(this._light2.scale).to({
                    x: 1,
                    y: 1
                }, 100).wait(100).to({
                    x: 0,
                ...
                null == this._t1 && (this._t1 = createjs.Tween.get(this._light1).to({
                    rotation: 2 * Math.PI
                }, 1e3), this._t1.loop = !0), null == this._t2 && (this._light2.rotation = Math.PI / 4, this._t2 = createjs.Tween.get(this._light2).to({
                    rotation: 2 * -Math.PI
                }, 1e3), this._t2.loop = !0)
