    ...
    var o = i(0),
        ...
        l = function (t) {
            ...
            return n(e, t), e.prototype.dispose = function () {
                ...
                this.texture = r.ALBUM_MAIN.getTexture(96), this._boxes.initialize(), this._boxes.update(t.equipType), this._icon.update(t.iconType), this._name.update(t.equipType, t.iconType), this._params.update(t)
            }, e
        }(PIXI.Sprite);
