const function974 = function (t, e, i) {
    ...
    var o = i(0), r = i(4), s = i(30), a = i(52), _ = i(370), u = i(371), l = i(975), c = function (t) {
        function e(e) {
        ...
        return n(e, t), e.prototype.initialize = function () {
            var t = new PIXI.Sprite(s.SALLY_COMMON.getTexture(26));
            t.position.set(0, 138), this.addChild(t);
            var e = new PIXI.Sprite(s.SALLY_COMMON.getTexture(49));
            ...
            var c = new PIXI.Sprite(s.SALLY_COMMON.getTexture(45));
            ...
            this._selected_id = t.mst_id, this._map_name_txt.text = t.name, this._areaText.update(t.area_id), this._ope_name_txt.text = t.operation_name, this._ope_detail_txt.text = t.operation_detail.replace(/<br.*?>/g, "\n"), this._err_txt.text = "";
            ...
            this._areaText.dispose(), this._shop.deactivate(), this._btn.off("dicision", this._onClick)
        }, e
    }(PIXI.Container);
    e.PanelDetail = c
}