const function974 = function (t, e, i) {
    ...
    function n(t, e, i, n) {
        ...
        for (var p = !1, d = !1, f = 0, y = l; f < y.length; f++) {
            var v = y[f];
            null != v && (-1 != i.indexOf(v.memID) && (p = !0), (v.fuelNow <= 0 || v.ammoNow <= 0) && (d = !0))
        }
        ...
        if (0 != e.getCombinedType()) {
            ...
            var m = l[6].getDamageType();
            if (50 == m || 25 == m || 0 == m) return { result: !1, reason: 21 }
        } else if (25 == g || 0 == g) return { result: !1, reason: 3 };
    ...
    function o(t, e) {
        ...
        if (0 == i) {
            if (e.getCount() > 6) return 1 == n.yugeki ? null : { result: !1, reason: 35 };
