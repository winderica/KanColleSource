const function1255 = function (t, e, i) {
    "use strict";
    ...
    var o = i(0), r = i(4), s = i(32), a = i(242), _ = i(30), u = i(20), l = i(434), c = function (t) {
        function e(e, i) {
        ...
        return n(e, t), e.prototype.initialize = function () {
            this._taihi.initialize(), this._taihisezu.initialize(), this._txt1.texture = u.MAP_COMMON.getTexture(143), this._txt2.texture = u.MAP_COMMON.getTexture(144), this._txt3.texture = u.MAP_COMMON.getTexture(145), this._title.initialize(!1), this._title.update(u.MAP_COMMON.getTexture(103)), this._title.activate()
        }, e.prototype.updateTargetShipBanner = function (t, e, i, n, r) {
            var s = "", a = o.default.model.ship.getMst(t);
            null != a && (s = a.name);
            var u = _.ShipUtil.isDamaged(n, r), l = _.ShipUtil.getDamageType(n, r);
            ...
            var o = _.ShipUtil.isDamaged(i, n), r = _.ShipUtil.getDamageType(i, n);
