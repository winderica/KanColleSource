const function1047 = function (t, e, i) {
    ...
    var o, r = i(11), s = i(0), a = i(18), _ = i(3), u = i(375), l = i(230), c = i(376), h = i(1050), p = i(377),
        d = i(1051), f = i(1052), y = i(18), m = i(14), v = i(151), g = i(1);
    !function (t) {
        ...
        function e(e) {
            ...
            i._selected = null, i._recordRankingModel = new Array(101), i._onKeyDown = function () {
                ...
                if (i._nowComment != m.EditTextBoxUtil.text && 0 != i._validation) {
                    ...
                    var e = i._GadgetIP;
                    window.parent.postMessage(v.PostMessageType.COMMENT + "\t" + i._nowComment, e), window.addEventListener("message", i._onCallback)
                }
                ...
                i._topView.btn_modeInfo.interactive = i._topView.btn_modeInfo.buttonMode = !1, i._topView.btn_modeInfo.texture = u.RECORD_MENU.getTexture(4), i._topView.btn_modeRanking.interactive = i._topView.btn_modeRanking.buttonMode = !0, i._topView.btn_modeRanking.texture = u.RECORD_MENU.getTexture(1), i._viewRanking.visible = !1, i._viewInfo.visible = !0, i._topView.sideMenu_light1.texture = u.RECORD_MENU.getTexture(5), i._topView.sideMenu_light1.position.set(i._topView.btn_modeInfo.x, i._topView.btn_modeInfo.y), i._NowMode = o.MODE_INFO, -1 != i._rankingMyPage && (i._rankingLastPage < 51 && i._viewRanking.btn_Rank500.position.set(-150, -150), i._rankingNowPage = i._rankingMyPage, m.EditTextBoxUtil.setVisibility(!0)), i._keydownInput()
            }, i._onClickBtnModeRanking = function () {
                i._topView.btn_modeInfo.interactive = i._topView.btn_modeInfo.buttonMode = !0, i._topView.btn_modeInfo.texture = u.RECORD_MENU.getTexture(4), i._topView.btn_modeRanking.interactive = i._topView.btn_modeRanking.buttonMode = !1, i._topView.btn_modeRanking.texture = u.RECORD_MENU.getTexture(1), i._viewRanking.visible = !0, i._viewInfo.visible = !1, i._setRankingPage(0), i._NowMode = o.MODE_RANKING, i._topView.sideMenu_light1.texture = u.RECORD_MENU.getTexture(2), i._topView.sideMenu_light1.position.set(i._topView.btn_modeRanking.x, i._topView.btn_modeRanking.y), m.EditTextBoxUtil.setVisibility(!1)
