const function119 = function (t, e, i) {
    ...
    var o = i(24), r = i(2), s = i(16), a = function (t) {
        function e(e, i, n, o) {
        ...
        return n(e, t), e.prototype._start = function () {
            ...
            var i = this._a_banner.getGlobalPos(), n = this._d_banner.getGlobalPos();
            ...
            r.x = 600, r.y = i.y + (n.y - i.y) / 2, this._layer.addChild(e), createjs.Tween.get(e).to({
                ...
                x: r.x,
                y: r.y
            }, 1e3, createjs.Ease.sineIn), createjs.Tween.get(e.img).wait(1800).to({ alpha: 0 }, 200).call(function () {
