    ...
    var o = i(17),
        ...
        a = function (t) {
            ...
            return n(e, t), e.prototype.update = function (t, e) {
                t == o.EVENT_AREA_ID ? (e >= 2 ? (this._content.position.set(1016, 329), this._content.texture = s.SALLY_EVENT.getTexture(9)) : (this._content.position.set(1037, 350), this._content.texture = s.SALLY_EVENT.getTexture(10)), this._light.texture = s.SALLY_EVENT.getTexture(11), this._light.position.set(1015, 330), this._light.alpha = 0) : (this._content.position.set(1031, 332), this._content.texture = r.SALLY_SORTIE.getTexture(15), this._light.texture = r.SALLY_SORTIE.getTexture(16), this._light.position.set(this._content.x - 26, this._content.y - 24), this._light.alpha = 0)
