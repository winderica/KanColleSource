const function1354 = function (t, e, i) {
    ...
    var o = i(0), r = i(8), s = i(19), a = i(6), _ = i(44), u = i(452), l = i(1355), c = i(63), h = function (t) {
        ...
        return n(e, t), e.prototype._start = function () {
            ...
            this._canvas = new l.CutinKuboNightCanvas, this._canvas.bg.alpha = 0;
            ...
            u.position.set(h.x, h.y), c.position.set(h.x, h.y), this._canvas.chara.addChild(u), this._canvas.chara.addChild(c), this._canvas.chara.alpha = 0, this._canvas.chara.x = (this._friend ? 0 : 600) - 54, this._canvas.chara.y = 615, this._canvas.plane1.position.set(600 - 917 * e, 387), this._canvas.plane1.initialize(this._slot_mst_id1, this._friend);
