const function1182 = function (t, e, i) {
    ...
    var o = i(4), r = i(3), s = i(1), a = function (t) {
        function e(e, i, n) {
            ...
            }, r._cb_onClick = e, r._cb_onMouseOver = i, r._cb_onMouseOut = n, r._icon = new _, r._icon.position.set(9, 7), r.addChild(r._icon), r._title = new o.TextBox(21, 4999235), r._title.position.set(105, 2), r.addChild(r._title), r._description = new o.TextBox(15, 4999235), r._description.position.set(105, 27), r.addChild(r._description), r._bonus = new PIXI.Sprite, r._bonus.position.set(115, 70), r.addChild(r._bonus), r._mat = new l, r._mat.position.set(234, 66), r.addChild(r._mat), r._progress = new u, r._progress.position.set(715, 69), r.addChild(r._progress), r._type = new c, r._type.position.set(70, 54), r.addChild(r._type), r._status = new h, r._status.position.set(849, 0), r.addChild(r._status), r.interactive = !0, r
        }
        ...
        return n(e, t), Object.defineProperty(e.prototype, "model", {
            ...
            this.texture = r.DUTY_COMMON.getTexture(0), this._bonus.texture = r.DUTY_COMMON.getTexture(15), this._mat.initialize()
    ...
    var _ = function (t) {
        ...
        return n(e, t), e.prototype.update = function (t) {
            var e;
            if (1 == t) e = 39; else if (2 == t) e = 34; else if (3 == t) e = 35; else if (4 == t) e = 36; else if (5 == t) e = 37; else if (6 == t) e = 40; else if (7 == t) e = 38; else if (8 == t) e = 34; else {
        ...
        return n(e, t), e.prototype.initialize = function () {
            var t = r.DUTY_COMMON.getTexture(6), e = new PIXI.Sprite(t);
            e.position.set(0, 1), this.addChild(e), t = r.DUTY_COMMON.getTexture(7), e = new PIXI.Sprite(t), e.position.set(82, 3), this.addChild(e), t = r.DUTY_COMMON.getTexture(8), e = new PIXI.Sprite(t), e.position.set(165, 1), this.addChild(e), t = r.DUTY_COMMON.getTexture(9), e = new PIXI.Sprite(t), e.position.set(247, 1), this.addChild(e), this.addChild(this._fuel), this.addChild(this._ammo), this.addChild(this._steel), this.addChild(this._baux)
        ...
        return n(e, t), e.prototype.update = function (t) {
            2 == t ? (this.texture = r.DUTY_COMMON.getTexture(11), this.visible = !0) : 1 == t ? (this.texture = r.DUTY_COMMON.getTexture(10), this.visible = !0) : this.visible = !1
        }, e
        ...
        return n(e, t), e.prototype.update = function (t) {
            this.texture = 1 == t ? r.DUTY_COMMON.getTexture(14) : 2 == t ? r.DUTY_COMMON.getTexture(19) : 3 == t ? r.DUTY_COMMON.getTexture(16) : 4 == t ? r.DUTY_COMMON.getTexture(17) : 5 == t ? r.DUTY_COMMON.getTexture(18) : PIXI.Texture.EMPTY
        }, e
        ...
        return n(e, t), e.prototype.update = function (t) {
            3 == t ? (this._img.texture = r.DUTY_COMMON.getTexture(12), this._over.texture = r.DUTY_COMMON.getTexture(13), this._over.visible = !0, this._startAnimation()) : 2 == t ? (this._img.texture = r.DUTY_COMMON.getTexture(47), this._over.visible = !1, this._stopAnimation()) : (this._img.texture = PIXI.Texture.EMPTY, this._over.visible = !1, this._stopAnimation())
        }, e.prototype.dispose = function () {
            this._stopAnimation()
