    ...
    var o = i(0),
        ...
        w = function (t) {
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                1 == t.isNeedUpdateUserBasic() && i.add(new c.UserDataAPI), 1 != t.isNeedUpdateSlotitem() && 318 != this._model.id && 513 != this._model.id || i.add(new d.UserSlotItemAPI), 1 == t.isNeedUpdateSlotitem() && i.add(new u.UnsetSlotAPI);
                var r = [511, 513, 620, 621, 688, 689, 690, 695, 696];
                if ((1 == t.isNeedUpdateUseitem() || r.indexOf(this._model.id) >= 0) && i.add(new l.UseItemAPI), t.getRewards(2).length > 0 && i.add(new a.DeckAPI), t.getRewards(11).length > 0) i.add(new p.UserShipAPI);
