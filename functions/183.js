    ...
    var o = i(5),
        ...
        d = function (t) {
            function e(e, i, n, s) {
                ...
                a._preAnim = function () {
                    var t = a._friend ? 1 : -1,
                        e = a._attacker.mst_id,
                        i = a._attacker.isDamaged();
                    ...
                    a._canvas.slot1.position.set(t / 2 + 825 * e, 390), a._canvas.slot2.position.set(t / 2 - 1425 * e, 600), a._canvas.slot1_text.anchor.set(a._friend ? 1 : 0, .5), a._canvas.slot1_text.position.set(a._friend ? 0 : t, 390), a._canvas.slot2_text.anchor.set(a._friend ? 0 : 1, .5), a._canvas.slot2_text.position.set(a._friend ? t : 0, 600), createjs.Tween.get(a._canvas.plane).to({
                        ...
                        x: t / 2 - 300 * e,
                        alpha: 1
                    }, 233), createjs.Tween.get(a._canvas.slot_bg2).wait(200).to({
                        x: t / 2
                    }, 266), createjs.Tween.get(a._canvas.slot2).wait(200).to({
                        x: t / 2 + 300 * e,
                        alpha: 1
                    ...
                    a._canvas.dispose(), createjs.Tween.get(t).to({
                        alpha: 0
                ...
                var h = null == a._plane ? 0 : a._plane.mstID,
                    d = null == a._slot1 ? 0 : a._slot1.mstID,
                    f = null == a._slot2 ? 0 : a._slot2.mstID;
                return a._preload_task = new u.PreloadCutinDanchaku(e, h, d, f), a
            }
