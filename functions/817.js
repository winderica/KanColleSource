        ...
        f = function (t) {
            ...
            return n(e, t), e.prototype.dispose = function () {
                ...
                n.add(t.mstID, !1, "text_remodel_mes"), n.load(function () {
                    ...
                    var n = t.getClassType();
                    i.textName.text = r.ShipUtil.getShipClassTypeText(n) + "\u300c" + t.name + "\u300d";
                    for (var s = 0; s < 6; s++) i.icons[s].visible = !1, i.textItems[s].visible = !1;
                    for (var s = 0; s < e.length; s++) i.icons[s].visible = !0, i.textItems[s].visible = !0, i.icons[s].texture = u.COMMON_ITEMICONS.getTextureFromMstID(e[s].id), i.textItems[s].text = e[s].count
                })
