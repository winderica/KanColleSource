const function1264 = function (t, e, i) {
    ...
    var o = i(20), r = i(243), s = function (t) {
        function e() {
        ...
        return n(e, t), e.prototype.initialize = function (t, e, i) {
            switch (this._bg.texture = o.MAP_COMMON.getTexture(49), 2 == t ? (this._label1.texture = o.MAP_COMMON.getTexture(169), this._label1.position.set(20, -117), this._label2.texture = o.MAP_COMMON.getTexture(171), this._label2.position.set(20, -41)) : 1 == t ? (this._label1.texture = o.MAP_COMMON.getTexture(170), this._label1.position.set(24, -117), this._label2.texture = o.MAP_COMMON.getTexture(171), this._label2.position.set(20, -41)) : (this._label1.texture = o.MAP_COMMON.getTexture(172), this._label1.position.set(11, -86), this._label2.texture = PIXI.Texture.EMPTY), e) {
                case 2:
