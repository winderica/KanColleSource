const function966 = function (t, e, i) {
    "use strict";
    ...
    var o = i(0), r = i(9), s = i(30), a = i(362), _ = i(364), u = i(365), l = i(226), c = i(366), h = i(227),
        p = i(368), d = i(971), f = i(972), y = i(973), v = i(109), g = function (t) {
            function e(e, i, n) {
                ...
                }, r._cb_onGo = n, r._banners = new a.PanelDeckSelectBanners, r._banners.position.set(30, 95), r._decks = new h.CompDeckBtns(r._onDeckChange), r._decks.position.set(30, 54), r._rader = new c.RaderCanvas, r._rader.position.set(488, 293), r._arrow = new l.CompArrow2, r._arrow.position.set(567, 537), r._alert = new u.CompAlertBalloon, r._alert.anchor.set(1, .5), r._alert.position.set(299, 566), r.interactive = !0, r._airunit_limit = e, r._event_sortie_condition = i, r._btn = new d.BtnGo(r._onGo), r._btn.position.set(302, 539), r._shop = new f.BtnShop, r._shop.position.set(15, 538), r._temp_supply_btn = new p.TempSupplyBtn, r._temp_supply_btn.position.set(210, 528), r
            }

            return n(e, t), e.prototype.initialize = function (t, e, i) {
                this._selected_map = t;
                var n = new PIXI.Sprite(s.SALLY_COMMON.getTexture(25));
                n.position.set(-8, 36);
                var a = new PIXI.Sprite(s.SALLY_COMMON.getTexture(49));
                a.position.set(0, 0);
                var _ = new PIXI.Sprite(s.SALLY_COMMON.getTexture(14));
                ...
                if (this._btn.air_unit = l > 0 && h.length > 0, this._alert.update(u.reason), this._arrow.enabled = u.result, this._arrow.update(r), this._arrow.activate(), 0 == o.default.model.basic.getExtraSupplySortie()) this._temp_supply_btn.visible = !1; else if (r) this._temp_supply_btn.visible = !1; else if (0 != u.reason && 2 != u.reason && 14 != u.reason) this._temp_supply_btn.visible = !1; else {
                    ...
                    var f = o.default.model.useItem.getCount(31), v = o.default.model.useItem.getCount(32),
                        g = p > 0 && p <= f, m = d > 0 && d <= v;
                    this._temp_supply_btn.enabled = 0 != g || 0 != m, this._temp_supply_btn.visible = !0
                }
