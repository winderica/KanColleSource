const function1425 = function (t, e, i) {
    ...
    var o = i(5), r = i(24), s = i(4), a = i(6), _ = i(1426), u = i(1427), l = function (t) {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "friend", {
            ...
            this._entered = !1;
            var e = 0;
            return e = 1 == this._friend ? -r.BannerSize.W : r.BannerSize.W, createjs.Tween.get(this).wait(t).to({ x: e }, 300).to({ alpha: 0 }, 50)
            ...
            var e = [createjs.Tween.get(this._content.scale).wait(t).to({
                x: 1,
                y: 1
            }, 300), createjs.Tween.get(this._content.img).wait(t).to({ x: 0 }, 300, createjs.Ease.cubicInOut), this._content.frame.getAnimationTween(t)].concat(this._content.img.getAnimationTweens(t), [createjs.Tween.get(this._content.flagship_mark).wait(t).to({
                x: 210,
                alpha: 1
            }, 300), createjs.Tween.get(this).wait(t).to({ x: 0, y: this.y - 3 }, 300)]);
            return 1 == this._friend && e.push(createjs.Tween.get(this._text).wait(t).to({ x: 262 }, 300)), e
