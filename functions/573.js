const function573 = function (t, e, i) {
    ...
    var o = i(5), r = i(4), s = i(188), a = i(1), _ = function (t) {
        function e(e) {
            var i = t.call(this) || this;
            return i._tween = new Array(2), i._textScrollEnable = !0, i._onChibiClick = function () {
                i._textScrollEnable && !i._musicChibiJumping && (i._musicChibiJumping = !0, i._tween[4] = createjs.Tween.get(i._musicChibi).to({ y: i._offset_y + 144.5 }, 1).to({ y: i._offset_y + 144.5 - 48 }, 250, createjs.Ease.cubicOut).to({ y: i._offset_y + 144.5 }, 250, createjs.Ease.cubicIn).call(function () {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "jukebox_close", {
            ...
            this._textScrollEnable && (this._tween[0] = createjs.Tween.get(this._text, { loop: !0 }).to({ x: 1138 }, 1).to({ x: 613 }, 5e3).wait(1e3).to({ x: 88 }, 5e3))
            ...
            var t = this;
            this._textScrollEnable && (this._tween[1] = createjs.Tween.get(this._musicChibi, { loop: !0 }).to({
                x: 867,
                width: 94,
                height: 82
            }, 1).to({ x: 232 }, 5e3).to({ width: 1 }, 500).call(function () {
                t._musicChibi.scale.x = -1, t._musicChibi.width = 1
            }).to({ width: 94 }, 500).to({ x: 867 }, 5e3).to({ width: 1 }, 500).call(function () {
                t._musicChibi.scale.x = 1, t._musicChibi.width = 1
            }).to({ width: 94 }, 500))
        }, e.prototype._musicChibiTexture = function () {
            var t = this;
            this._textScrollEnable && (this._tween[2] = createjs.Tween.get(this._musicChibi, { loop: !0 }).wait(250).call(function () {
            ...
            this._textScrollEnable && (this._tween[3] = createjs.Tween.get(this._musicChibi, { loop: !0 }).to({ rotation: .05 }, 1).wait(249).to({ rotation: -.05 }, 1).wait(249))
        }, e.prototype.discard = function () {
            this._musicChibi.off(a.EventType.CLICK, this._onChibiClick), this._textScrollEnable = !1;
            for (var t = 0; this._tween.length; t++) {
                if (null == this._tween[t]) return;
                this._tween[t].setPaused(!0), this._tween[t].removeAllEventListeners()
            }
