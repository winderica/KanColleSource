const function1164 = function (t, e, i) {
    ...
    var o = i(4), r = i(3), s = i(1), a = function (t) {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "model", {
            ...
            this._model = null, this._status.dispose(), this._deactivate()
    ...
    var _ = function (t) {
        ...
        return n(e, t), e.prototype.update = function (t) {
            3 == t ? (this._img.texture = r.DUTY_COMMON.getTexture(16), this._over.texture = r.DUTY_COMMON.getTexture(17), this._over.visible = !0, this._startAnimation()) : 2 == t ? (this._img.texture = r.DUTY_COMMON.getTexture(57), this._over.visible = !1, this._stopAnimation()) : (this._img.texture = PIXI.Texture.EMPTY, this._over.visible = !1, this._stopAnimation())
        }, e.prototype.dispose = function () {
            this._stopAnimation()
