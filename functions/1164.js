const function1164 = function (t, e, i) {
    ...
    var o = i(0), r = i(2), s = i(18), a = i(4), _ = i(3), l = i(3), u = i(407), c = i(1165), h = i(1),
        p = function (t) {
            function e(e, i) {
    ...
    var d = function (t) {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "result", {
            ...
            var t = this;
            _.SE.play("215"), this._result = !0, new u.FurnitureExchangeAPI(this._model).start(function () {
        ...
        return n(e, t), e.prototype.initialize = function () {
            this.texture = l.ITEM_FSHOP.getTexture(54), this._btn_no.texture = l.ITEM_FSHOP.getTexture(6), this._btn_yes.texture = l.ITEM_FSHOP.getTexture(7);
            var t = new PIXI.Sprite(l.ITEM_FSHOP.getTexture(9));
            t.position.set(573, 234), this.addChild(t), t = new PIXI.Sprite(l.ITEM_FSHOP.getTexture(8)), t.position.set(576, 308), this.addChild(t);
            var e = l.ITEM_FSHOP.getTexture(0), i = new PIXI.Sprite(e);
