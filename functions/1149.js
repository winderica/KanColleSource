const function1149 = function (t, e, i) {
    "use strict";
    ...
    var o = i(0), r = i(2), s = i(8), a = i(18), _ = i(4), l = i(201), u = i(3), c = i(397), h = i(169),
        p = i(1150), d = i(153), f = i(1), y = function (t) {
            function e(e, i, n) {
                ...
                return r._count = 1, r._onUp = function () {
                    ...
                    var t = "" + location.hostname, e = r._mst.id, i = r._mst.price, n = r._count,
                        a = r._mst.description.replace(/<br>/g, ""), _ = r._mst.name,
                        l = "http://" + t + "/kcs/images/purchase_items/" + e + ".jpg",
                        u = e + "\t" + i + "\t" + n + "\t" + a + "\t" + _ + "\t" + l;
                    r._GadgetIP = "http://" + o.default.settings.osapi_root;
                    var c = r._GadgetIP;
                    window.parent.postMessage(d.PostMessageType.BUY + "\t" + u, c), window.addEventListener("message", r._onCallback)
            ...
            return n(e, t), Object.defineProperty(e.prototype, "layer", {
                ...
                var t = this;
                this._dialog = new m, this._dialog.initialize(this._type, this._mst, this._onUp, this._onDown, this._onBack, this._onBuy), this._dialog.update(this._count, this._mst.price * this._count, this._limit), this._dialog.alpha = 0, this._layer.addChild(this._dialog), createjs.Tween.get(this._dialog).to({ alpha: 1 }, 300).call(function () {
                    t._dialog.activate()
                })
    ...
    var m = function (t) {
        function e() {
            ...
            return e._bg = new PIXI.Sprite, e._bg.position.set(48, 102), e.addChild(e._bg), e._header = new PIXI.Sprite, e._header.position.set(439, 123), e.addChild(e._header), e._icon = new PIXI.Sprite, e._icon.position.set(562, 195), e.addChild(e._icon), e._description = new _.TextBox(21, 16774898), e._description.position.set(534, 282), e._description.style.breakWords = !0, e._description.style.wordWrap = !0, e._description.style.wordWrapWidth = 306, e.addChild(e._description), e._count = new _.TextBox(21, 16774898), e._count.anchor.x = 1, e._count.position.set(568, 418), e.addChild(e._count), e._price = new _.TextBox(21, 16724736), e._price.position.set(574, 456), e.addChild(e._price), e._btn_up = new v, e._btn_up.position.set(604, 418), e.addChild(e._btn_up), e._btn_down = new g, e._btn_down.position.set(604, 438), e.addChild(e._btn_down), e._btn_back = new c.BackBtn, e._btn_back.position.set(108, 571), e.addChild(e._btn_back), e._btn_purchase = new b, e._btn_purchase.position.set(424, 568), e.addChild(e._btn_purchase), e
        }

        return n(e, t), e.prototype.initialize = function (t, e, i, n, o, r) {
            this._bg.texture = u.ITEM_ISHOP.getTexture(8);
            var s = new PIXI.Sprite(u.ITEM_ISHOP.getTexture(36));
            s.position.set(267, 18), this._bg.addChild(s), s = new PIXI.Sprite(u.ITEM_ISHOP.getTexture(9)), s.position.set(366, 183), this._bg.addChild(s), s = new PIXI.Sprite(u.ITEM_ISHOP.getTexture(10)), s.position.set(366, 316), this._bg.addChild(s), s = new PIXI.Sprite(u.ITEM_ISHOP.getTexture(11)), s.position.set(366, 354), this._bg.addChild(s), s = new PIXI.Sprite(u.ITEM_ISHOP.getTexture(12)), s.position.set(499, 358), this._bg.addChild(s), this._label = new _.TextBox(21, 16777215), this._label.text = "\u500b", this._label.position.set(520, 316), this._bg.addChild(this._label), this._header.texture = 0 == t ? u.ITEM_ISHOP.getTexture(29) : 1 == t ? u.ITEM_ISHOP.getTexture(28) : 2 == t ? u.ITEM_ISHOP.getTexture(27) : u.ITEM_ISHOP.getTexture(31), this._icon.texture = h.getPayitemIcon(e.id), this._description.text = e.description.replace(/<br>/g, "\n"), this._btn_up.initialize(i), this._btn_down.initialize(n), this._btn_back.initialize(o), this._btn_purchase.initialize(r)
        ...
        return n(e, t), e.prototype.initialize = function (t) {
            ...
            this.texture = 0 == t ? u.ITEM_ISHOP.getTexture(2) : u.ITEM_ISHOP.getTexture(0)
        }, e
    }(PIXI.Sprite), g = function (t) {
        function e() {
            return null !== t && t.apply(this, arguments) || this
        }

        return n(e, t), e.prototype._update = function (t) {
            this.texture = 0 == t ? u.ITEM_ISHOP.getTexture(3) : u.ITEM_ISHOP.getTexture(1)
        }, e
    }(v), b = function (t) {
        function e() {
            return null !== t && t.apply(this, arguments) || this
        ...
        return n(e, t), e.prototype._update = function (t) {
            0 == this._enabled ? this.texture = u.ITEM_ISHOP.getTexture(33) : this.texture = 0 == t ? u.ITEM_ISHOP.getTexture(32) : u.ITEM_ISHOP.getTexture(34)
        }, e
    }(l.BtnBase);
    e.PurchaseBtn = b
}