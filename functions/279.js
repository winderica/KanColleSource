    ...
    var o = i(0), r = i(17), s = i(10), a = i(7), _ = function (t) {
        ...
        return n(e, t), e.prototype._connect = function () {
            ...
            if (null != n) {
                ...
                if (null != s) for (var _ = 0, l = s; _ < l.length; _++) {
                    var u = l[_], c = a.ObjUtil.getNumber(u, "api_type3No"),
            ...
            var e = this._getSeed(t), i = Math.floor(Date.now() / 1e3),
                ...
                l = parseInt(t.toString().substr(0, 4)), u = (4132653 + r) * (l + 1e3) - i + (1875979 + 9 * r),
                c = u - t, h = c * e, p = n.toString() + h.toString() + o.toString();
            p = s.toString() + p;
