const function553 = function (t, e, i) {
    ...
    var o = i(0), r = i(1), s = i(188), a = i(271), _ = i(187), l = function (t) {
        function e() {
        ...
        return n(e, t), e.prototype.initialize = function () {
            ...
            this._bg = new PIXI.Sprite(t), this._container = new PIXI.Container, this._container.alpha = 0, this._logo = new PIXI.Sprite(_.TITLE_MAIN.getTexture(3)), this._logo.anchor.set(.5, .5), this._logo.position.set(942, 273), this._kira = new a.KiraLayer, this._kira.position.set(765, 114), this._kira.initialize(), this._btn = new u, this._btn.initialize(), this._btn.position.set(914, 755), this._btn.alpha = 0, this.addChild(this._bg), this._container.addChild(this._logo), this._container.addChild(this._kira), this._container.addChild(this._btn), this.addChild(this._container)
        }, e.prototype.dispose = function () {
            this._kira.dispose(), this._btn.dispose()
        }, e.prototype.showTween = function (t) {
            var e = this;
            createjs.Tween.get(this._container).to({ alpha: 1 }, 300).call(function () {
                e._showTween2(t)
            })
            ...
            this._btn.interactive = this._btn.buttonMode = !0, this._btn.once(r.EventType.CLICK, function () {
                e._btn.interactive = e._btn.buttonMode = !1, createjs.Tween.get(e._btn).to({ alpha: 0 }, 200), t()
            })
        }, e.prototype._showTween2 = function (t) {
            var e = this;
            createjs.Tween.get(this._btn).to({ y: 605, alpha: 1 }, 1e3).wait(800).call(function () {
                e._showTween3(t)
            })
        }, e.prototype._showTween3 = function (t) {
            var e = this;
            createjs.Tween.get(this._btn.scale).to({ x: 1.1, y: 1.1 }, 100).call(function () {
                e._btn.disabled = !1
            }).to({ x: 1, y: 1 }, 100).call(function () {
