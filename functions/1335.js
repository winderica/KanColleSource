const function1335 = function (t, e, i) {
    ...
    var o = i(27), r = i(39), s = i(2), a = i(16), _ = i(1336), l = i(1337), u = i(1338), c = i(1339), h = i(1340),
        p = i(1341), d = function (t) {
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                var i = null;
                if (1 == this._type) i = new r.WaitTask(500); else if (3 == this._type) i = new _.AnimAntiAircraftFunshin(this._banner); else if (2 == this._type) i = new u.AnimAntiAircraftKoukaku(this._banner); else if (5 == this._type) {
                ...
                } else if (4 == this._type) i = new l.AnimAntiAircraftFunshinKai2(this._banner); else if (6 == this._type) {
                    var n = new o.ParallelTask;
    ...
    var f = function (t) {
        function e() {
            var e = t.call(this) || this, i = a.BATTLE_MAIN.getTexture(120);
