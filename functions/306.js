const function306 = function (t, e, i) {
    "use strict";
    ...
    var o = i(4), r = i(80), s = i(5), a = i(105), _ = function (t) {
        function e(e, i) {
        ...
        return n(e, t), e.prototype.start = function () {
            createjs.Tween.get(this._btnOuter, { loop: !0 }).to({ rotation: 2 * Math.PI }, 6e3, createjs.Ease.linear)
        }, e.prototype.flashText = function (t, e) {
            var i = this;
            void 0 === e && (e = 40);
            var n = createjs.Tween.get(null, { loop: !0 }).wait(e).call(function () {
                var e = t.substr(0, 1);
