const function489 = function (t, e, i) {
    ...
    var o = i(2),
        ...
        h = function (t) {
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                var t = this;
                this._initializeBGStampLineImages(), this._bg = new p, this._bg.initialize(this._BGStampLineVisible), this._bg.alpha = 0, this._layer.addChild(this._bg), createjs.Tween.get(this._bg).to({
                    alpha: 1
                }, 500).call(function () {
    ...
    var p = function (t) {
            ...
            return n(e, t), e.prototype.initialize = function (t) {
                ...
                if (e.texture = u.BATTLE_RESULT_EVENT_BASE.getTexture(5), e.position.set(0, 65), e.alpha = .9, this.addChild(e), t) {
                    var i = u.BATTLE_RESULT_EVENT_BASE.getTexture(6),
                        n = new PIXI.Sprite(i);
                    n.position.set(270, 8), this.addChild(n);
                    var o = u.BATTLE_RESULT_EVENT_BASE.getTexture(3),
                        r = new PIXI.Sprite(o);
                    r.rotation = Math.PI, r.position.set(984, 713), this.addChild(r)
                }
            }, e
        }(PIXI.Container),
        d = function (t) {
