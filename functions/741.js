const function741 = function (t, e, i) {
    ...
    var o = i(5), r = i(0), s = i(30), a = i(47), _ = i(109), l = i(31), u = i(327), c = i(69), h = i(217),
        p = i(742), d = i(743), f = i(744), y = i(745), m = i(749), v = i(752), g = i(753), b = i(754), w = i(755),
        x = i(756), I = i(759), T = i(154), O = i(21), P = function (t) {
            function e() {
            ...
            return n(e, t), e.prototype.preInitialize = function () {
                ...
                var _ = new l.APIConnector, p = new u.ChargeAPI(3, t);
                ...
                var n = new l.APIConnector, o = new u.ChargeAPI(2, t);
                ...
                var n = new l.APIConnector, o = new u.ChargeAPI(1, t);
                n.add(o), 40 == r.default.model.basic.getTutorialProgress() && n.add(new c.UpdateTutorialAPI(50)), n.start(function () {
                    var t = r.default.model.useItem.get(31).count, n = r.default.model.useItem.get(32).count;
                    i.materialCounterView.update(t, n), o.usedBauxite && i._animationBauxTelop(), e()
                })
