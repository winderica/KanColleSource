const function18 = function (t, e, i) {
    ...
    var o = i(5), r = i(8), s = function (t) {
        ...
        return n(e, t), e.prototype.isNowAnimation = function () {
            ...
            var i = this;
            void 0 === t && (t = 0), void 0 === e && (e = null), this._stopShowTween(), this._stopHideTween(), t <= 0 ? (this.alpha = 1, null != e && e()) : this._tween_show = createjs.Tween.get(this).to({ alpha: 1 }, t).call(function () {
                i._tween_show = null, null != e && e()
            })
        }, e.prototype.hide = function (t, e) {
            var i = this;
            void 0 === t && (t = 0), void 0 === e && (e = null), this._stopShowTween(), this._stopHideTween(), t <= 0 ? (this.alpha = 0, null != e && e()) : this._tween_hide = createjs.Tween.get(this).to({ alpha: 0 }, t).call(function () {
