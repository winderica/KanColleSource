const function881 = function (t, e, i) {
    "use strict";
    ...
    var o, r = i(0), s = i(1), a = i(49), _ = i(8), u = i(113), l = i(4), c = i(21), h = i(35), p = i(87),
        d = i(882);
    !function (t) {
    ...
    var f = function (t) {
        function e(e) {
            ...
            var m = new PIXI.Sprite(c.COMMON_MAIN.getTexture(64));
            m.position.set(0, -37);
            var g = new PIXI.Sprite(h.ARSENAL_MAIN.getTexture(5));
            return g.anchor.set(0, .5), g.position.set(22, Math.floor(m.height / 2 - 4)), i.addChild(f, i.configureMaterialView_fuel, i.configureMaterialView_ammo, i.configureMaterialView_steel, i.configureMaterialView_bauxite, n, r), i._buildKitSwitch = new y(i._onChangeValue), i._buildKitSwitch.position.set(229, 427), i.addChild(i._buildKitSwitch), i._devKitSwitch = new v(i._onChangeValue), i._devKitSwitch.position.set(547, 427), i.addChild(i._devKitSwitch), i.textDevKitBefore = new l.TextBox(24, 5523516), i.textDevKitBefore.anchor.x = 1, i.textDevKitBefore.position.set(591, 438), i.addChild(i.textDevKitBefore), i.textDevKitAfter = new l.TextBox(24, 12467003), i.textDevKitAfter.position.set(619, 438), i.addChild(i.textDevKitAfter), i.addChild(i.btn_kenzou), i._btnToNormal = new PIXI.Sprite(h.ARSENAL_MAIN.getTexture(37)), i._btnToNormal.interactive = !0, i._btnToNormal.buttonMode = !0, i._btnToNormal.position.set(60, 492), i.addChild(i._btnToNormal), i.addChild(m), i.position.set(1200, 139), m.addChild(g), i.dialogBackground = new _.AreaBox(a.UISettings.DIALOG_BG_ALPHA), i.mainView.addChild(i.dialogBackground), i.mainView.addChild(i), i._btnToNormal.on(s.EventType.CLICK, i._onClickNormal), i.dialogBackground.on(s.EventType.CLICK, i._onClickBack), i
        }
