const function342 = function (t, e, i) {
    ...
    var o = i(5), r = i(8), s = i(302), a = i(23), _ = i(12), l = i(3), u = i(888), c = function (t) {
        function e(e) {
        ...
        return n(e, t), e.prototype.preload = function (t) {
            ...
            var e = this;
            this._cb_onComplete = t, this._bg.alpha = 0, this.addChild(this._bg), createjs.Tween.get(this._bg).to({ alpha: 1 }, 100).call(function () {
                e._01_flyCard()
            })
            ...
            this._card.position.set(o.default.width / 2, o.default.height / 2 + 540), this._card.alpha = 0, this._card.scale.set(0), this.addChild(this._card), createjs.Tween.get(this._card).to({
                ...
                scaleY: .57,
                alpha: 1
            }, 700).to({ y: o.default.height / 2, scaleX: 1, scaleY: 1 }, 500).call(function () {
                t._01_light()
            })
            ...
            this._bigflash.x = o.default.width / 2, this._bigflash.y = o.default.height / 2, this._bigflash.scale.set(0), this._bigflash.anchor.set(.5, .5), this.addChild(this._bigflash), createjs.Tween.get(this._bigflash).to({
                scaleX: 3.3,
                scaleY: 3.3
            }, 300).to({ scaleX: 2, scaleY: 2 }, 1700), createjs.Tween.get(null).wait(1500).call(function () {
