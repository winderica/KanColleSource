const function342 = function (t, e, i) {
    "use strict";
    ...
    var o = i(0), r = i(8), s = i(58), a = i(14), _ = i(799), u = function (t) {
        function e(e) {
    ...
    var l = function (t) {
        function e(e) {
            var i = t.call(this) || this;
            i.PROGRESS_WEIGHT = 50, i.ALLROT = 4, i.animation = { progress: 0 }, i._onUpdate = function () {
                for (var t = i.animation.progress, e = i._positions, n = 2 + t * i.PROGRESS_WEIGHT * .05, o = 0; o < i._elements.length; o++) {
                    ...
                    if (r.alpha = 0, o < e.length) {
                        var s = 1;
                        t > .5 && (s = 1 - (t - .5) / .5);
                        var a = e[o][0] - 600, _ = e[o][1] - 360, u = Math.sqrt(a * a + _ * _),
                            l = Math.atan2(_, a);
                        l += i.ALLROT * Math.PI / 180 * (t * i.PROGRESS_WEIGHT), u -= n * (t * i.PROGRESS_WEIGHT);
                        var c = u * Math.cos(l) + 600, h = u * Math.sin(l) + 360;
        ...
        return n(e, t), e.prototype.play = function (t) {
            ...
            var r = createjs.Tween.get(this.animation, { onChange: this._onUpdate }).to({ progress: 1 }, 1600).call(function () {
            ...
            switch (t) {
                case 1:
                    return [[293, 353]];
                case 2:
                    return [[176, 192], [1092, 621]];
                case 3:
                    return [[176, 192], [1092, 362], [311, 648]];
                case 4:
                    return [[114, 86], [1092, 173], [311, 648], [1022, 585]];
                case 5:
                    return [[71, 248], [1092, 191], [420, 69], [1022, 585], [171, 632]]
            }
            return []
        }, e
    }(PIXI.Container)
