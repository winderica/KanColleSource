const function912 = function (t, e, i) {
    ...
    var o = i(5), r = i(0), s = i(17), a = i(264), _ = i(28), u = i(16), l = i(34), c = i(66), h = i(223),
        p = i(30), d = i(52), f = i(913), y = i(225), v = i(226), g = i(914), m = i(923), b = i(924), w = i(953),
        x = i(963), I = i(964), T = i(966), O = i(975), P = i(977), C = i(993), k = i(1), M = function (t) {
            function e(e, i) {
                ...
                return n._serial_id = null, n._onChangeArea = function (t) {
                    ...
                    if (1 != n._cancelArea.isNowAnimation()) {
                        ...
                        var o = r.default.model.map.getMapMem(t), s = r.default.view.overLayer, _ = n._detailPanel,
                            u = r.default.model.map.getMapMem(t - 1), l = 0;
                        null != u && (l = u.getSelectedOperationType());
                        new w.TaskShowDetailPanel(o, l, s, _).start(null, function () {
                    ...
                    if (-1 == e) n._onCancel(), n._deckSelectPanel.deactivate(), n._deckSelectPanel.cancelArea.hide(300), createjs.Tween.get(n._deckSelectPanel.panel).to({ x: o.default.width }, 300).call(function () {
                        ...
                        if (r.default.sound.voice.playAtRandom(a.toString(), [13, 14], [50, 50]), t >= 412) return;
                        var _ = new l.APIConnector, u = r.default.model.map.getMapMem(t),
                            p = new g.APIMapStart(u, e, n._serial_id), d = p.model;
            ...
            return n(e, t), e.prototype.initialize = function () {
                ...
                if (this._selected_area_id != t) {
                    ...
                    i.add(new m.TaskLoadGaugeResources(o)), i.start(function () {
                        r.default.view.loading.hide(200), e._selected_area_id = t, e._area_icons.update(t), e._offset_list = [], e._layout.update(t, 0, n)
                    })
                }
