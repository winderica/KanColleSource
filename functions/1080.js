const function1080 = function (t, e, i) {
    "use strict";
    ...
    var o = i(0), r = i(1), s = i(8), a = i(69), _ = i(1081), u = i(389), l = i(391), c = i(390), h = i(392),
        p = function (t) {
            function e() {
            ...
            return n(e, t), e.prototype.initialize = function (t, e) {
                ...
                this.deactivate(), this._prevBtn.dispose(), this._nextBtn.dispose(), this._voiceBtn.dispose(), this._movieBtn.dispose(), this._ring.dispose(), this._stopVoice();
                for (var t = 0, e = this._extraVoiceBtn.length; t < e; t++) this._extraVoiceBtn[t].dispose()
