const function711 = function (t, e, i) {
    ...
    var o = i(3), r = i(4), s = i(1), a = function (t) {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "index", {
            ...
            this._positiveButton.removeAllListeners(s.EventType.CLICK), this._positiveButton.removeAllListeners(s.EventType.MOUSEOUT), this._positiveButton.removeAllListeners(s.EventType.MOUSEOVER), this._background.removeAllListeners(s.EventType.MOUSEOUT), this._background.removeAllListeners(s.EventType.MOUSEOVER), this.onClick = null, this.onMouseOut = null, this.textMessage = null, this.negativeButton = null, this._index = null, this._background = null, this._positiveButton = null, this._presetId = null, this._onClick = null, this._onMouseOut = null, this.removeChildren()
    ...
    var _ = function (t) {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "index", {
            ...
            this._background.removeAllListeners(s.EventType.MOUSEOUT), this._background.removeAllListeners(s.EventType.MOUSEOVER), this._positiveButton.removeAllListeners(s.EventType.MOUSEOUT), this._positiveButton.removeAllListeners(s.EventType.MOUSEOVER), this._positiveButton.removeAllListeners(s.EventType.CLICK), this._onMouseOut = this._onMouseOver = this._onMouseOut = this._onMouseOver = this._onClick = null, this._positiveButton.texture = PIXI.Texture.EMPTY, this._negativeButton.texture = PIXI.Texture.EMPTY, this._background.texture = PIXI.Texture.EMPTY, this._index = null, this.onClick = null, this.onMouseOut = null, this.textMessage = null, this._positiveButton = null, this._negativeButton = null, this._presetId = null, this.removeChildren()
