const function672 = function (t, e, i) {
    "use strict";
    ...
    var o = i(0), r = i(17), s = i(152), a = i(106), _ = i(31), l = i(69), u = i(6), c = i(673), h = i(674),
        p = i(675), d = i(676), f = i(677), y = i(687), m = i(213), v = i(214), g = i(689), b = i(690), w = i(694),
        x = i(695), I = function (t) {
            function e(e) {
                ...
                r.add(new m.ChangeAPI(!1, t, 0, -2)), 10 == o.default.model.basic.getTutorialProgress() && r.add(new l.UpdateTutorialAPI(20)), r.start(function () {
                    ...
                    if (0 < s.length) {
                        for (var a = 0; a < i.shipSlotLayer.ShipSlots.length; a++) if (-1 != s.indexOf(a)) {
                            var l = i.shipSlotLayer.ShipSlots[a], u = function () {
                            };
