const function228 = function (t, e, i) {
    ...
    var o = i(0), r = i(74), s = i(77), a = i(229), _ = i(203), u = i(52), l = i(980), c = i(981), h = i(982),
        p = i(372), d = i(1), f = function (t) {
            ...
            return n(e, t), e.prototype.initialize = function (t) {
                ...
                this._initClearBadge(t), this._initializeGauge(t), this.addChild(this._image), this.addChild(this._focus), this.addChild(this._clear), this.addChild(this._lock), this.addChild(this._gauge), this.addChild(this._airUnitBanner)
                ...
                this._clear.show(e)
            }, e.prototype._initializeGauge = function (t) {
                if (null != t && (0 != t.defeat_required || 0 != t.gauge_max) && 1 != t.isCleared() && 0 != t.isOpened()) {
                    ...
                    if (null != a) if (this._gauge.initialize(a), this._gauge.x = a.x, this._gauge.y = a.y, t.defeat_required > 0) {
                        var _ = t.defeat_required, u = _ - t.defeat_count;
                        this._gauge.update(u, _)
                    } else {
                        var u = t.gauge_now, _ = t.gauge_max;
                        this._gauge.update(u, _)
                    }
                }
