const function932 = function (t, e, i) {
    "use strict";
    ...
    var o = i(0), r = i(1), s = i(141), a = i(8), _ = i(4), u = i(26), l = i(351), c = i(352), h = i(353),
        p = i(940), d = i(355), f = function (t) {
            function e(e, i, n) {
                ...
                }, r._cb_onDrop = e, r._cb_onSupply = i, r._area = new PIXI.Graphics, r.addChild(r._area), r._tabs = new p.AirUnitPanelTabContainerWithExtend(r._onChangeTab, n), r._tabs.x = 30, r.addChild(r._tabs), r._base = new PIXI.Sprite, r._base.position.set(0, 21), r.addChild(r._base), r._base.hitArea = new PIXI.Rectangle(0, 0, 0, 0), r._banner = new l.AirUnitPanelBanner, r._banner.position.set(26, 45), r.addChild(r._banner), r._name = new _.TextBox(21, 0), r._name.position.set(33, 119), r.addChild(r._name), r._tag = new d.AirUnitPanelWoodenTag, r._tag.position.set(314, 47), r.addChild(r._tag), r._items = [];
                for (var s = 0; s < 4; s++) {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "selected_airunit_id", {
                ...
                this._area_id = t, this._models = e, this._tabs.initialize(this._models.length), this._base.texture = u.SALLY_AIRUNIT.getTexture(7), this._area.beginFill(0, 0), this._area.drawRect(this._base.x, this._base.y, this._base.width, this._base.height), this._area.endFill(), this._banner.initialize(t);
                ...
                if (void 0 === e && (e = !1), (0 != e || this._selected_airunit_id != t) && !(t <= 0 || t > this._models.length)) {
                    ...
                    this._banner.update(t, _), this._tag.skipAnimation(), 0 == _ ? (this._tag.update(0, !1), this._tag.enabled = !1) : (this._tag.update(i.airUnitState, !1), this._tag.enabled = !0), this._supply_btn.update(u)
                }
                ...
                this.off(r.EventType.CLICK, this._onClick), this._tabs.dispose(), this._banner.dispose(), this._tag.dispose();
                for (var t = 0, e = this._items; t < e.length; t++) {
                    e[t].dispose()
                }
        ...
        function e(e, i, n) {
            ...
            return s._onMouseOut = function () {
                ...
                if (null == s._drag) {
                    ...
                    if (0 == e.isNoneData() && 0 == e.isRelocation() && 0 == e.hitArea.contains(i.x, i.y)) {
                    ...
                    for (var l = 0; l < s._items.length; l++) {
                        var e = s._items[l], i = t.data.getLocalPosition(e);
                        1 == e.hitArea.contains(i.x, i.y) ? e.alpha = 1 : e.alpha = .5
                    }
                }
                ...
                for (var e = 0; e < s._items.length; e++) {
                    ...
                    i.hitArea;
                    if (1 == i.hitArea.contains(n.x, n.y)) return s._index == e ? null == s._drag ? null != s._cb_onDrop && s._cb_onDrop(s._index, s._index) : null != s._cb_onDrop && s._cb_onDrop(-1, -1) : null == s._drag ? null != s._cb_onDrop && s._cb_onDrop(-1, -1) : null != s._cb_onDrop && s._cb_onDrop(s._index, e), void s._dispose()
                }
