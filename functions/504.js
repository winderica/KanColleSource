const function504 = function (t, e, i) {
    ...
    var o = i(7), r = i(185), s = i(143), a = i(186), _ = i(124), l = function () {
        function t() {
            this._arr = []
        }
        ...
        return n(e, t), e.prototype.setData = function (t) {
            if (this._arr = [], null != t) {
                ...
                if (null != e) for (var i = 0, n = e; i < n.length; i++) {
                    var l = n[i], u = (o.ObjUtil.getNumber(l, "api_mode"), o.ObjUtil.getNumber(l, "api_type")),
                        c = o.ObjUtil.getNumber(l, "api_mst_id"), h = o.ObjUtil.getString(l, "api_getmes"),
                        p = void 0;
