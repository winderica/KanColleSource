        ...
        C = function (t) {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "model", {
                ...
                if (1 == n.isDeadEnd()) {
                    ...
                    if (46 == o && 1 == r && 1 == s) {
                        var a = new I.EventTaskCellOpen(this._model.sortie.map_id, this._resInfo, this._view, this._model.sortie.map.getGaugeNum(), !0, !0, !0, !0, !0);
                        return void a.start(function () {
                            i._endScene(n)
                        })
                    }
                    if (46 == o && 2 == r && 1 == s) {
                        var a = new I.EventTaskCellOpen(this._model.sortie.map_id, this._resInfo, this._view, this._model.sortie.map.getGaugeNum(), !0, !1, !0, !0, !0, !0);
                        return void a.start(function () {
                            i._endScene(n)
                        })
                    }
                ...
                if (1 == o && 0 == r && 0 == s) {
                    var l = e.deck_f.name;
                    return void new v.TaskFlagShipDamaged(this._view, l, n.mst_id).start(function () {
                        i._endScene(t)
                    })
                }
