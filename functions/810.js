const function810 = function (t, e, i) {
    ...
    var o = i(5), r = i(0), s = i(1), a = i(19), _ = i(8), u = i(41), l = i(58), c = i(14), h = i(3), p = i(811),
        d = function (t) {
            function e() {
            ...
            return n(e, t), e.prototype.dispose = function () {
                ...
                var t, e = this, i = new a.TweenTask, n = new PIXI.Container;
                ...
                i = createjs.Tween.get(this._shipFull).wait(600).to({
                    ...
                    alpha: 0
                }, 900, createjs.Ease.sineIn).set({ visible: !1 }), n.addTween(i), this._shipCard.x = 443, this._shipCard.y = 135, this._shipCard.alpha = 0, t.addChild(this._shipCard), i = createjs.Tween.get(this._shipCard).wait(600).set({ visible: !0 }).to({
                    x: 770,
                    alpha: .5
                }, 900, createjs.Ease.sineOut).to({
                    x: 443,
                ...
                var e = this;
                createjs.Tween.get(this).to({ alpha: 0 }, 100).call(function () {
