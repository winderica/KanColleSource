const function1361 = function (t, e, i) {
    ...
    var o = i(5), r = i(0), s = i(2), a = i(12), _ = i(16), u = i(15), l = i(1362), c = function (t) {
        function e(e) {
            ...
            i._preAnim = function () {
                ...
                for (var t = 0; t < i._attackers.length; t++) {
                    ...
                    if (i._ships[t].texture = r.default.resources.getShip(e, n, "full"), 0 == t) {
                ...
                createjs.Tween.get(null).wait(500).call(function () {
                    createjs.Tween.get(i._ships[0]).to({ alpha: 0 }, 400), createjs.Tween.get(i._nagato).to({ alpha: 1 }, 400);
                ...
                createjs.Tween.get(i._canvas.chara[0]).wait(500).call(function () {
                    createjs.Tween.get(i._canvas.chara[0]).to({ alpha: 0 }, 500), createjs.Tween.get(i._canvas.chara[1]).to({ alpha: 0 }, 500)
                }).wait(600).call(function () {
                    i._endTask()
                })
            }, i._attackers = e, i._canvas = new l.CutinNagatoAttackCanvas, i._view = new PIXI.Container, i.view.addChild(i._canvas), i._nagato = new PIXI.Sprite, i._ships = [];
        ...
        return n(e, t), Object.defineProperty(e.prototype, "view", {
            ...
            r.default.sound.voice.play(this._attackers[0].mst_id.toString(), 900), createjs.Tween.get(this._canvas.chara[0]).to({
                x: -159,
                alpha: 1
