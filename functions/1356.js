    ...
    var o = i(1357),
        ...
        s = function (t) {
            ...
            return n(e, t), e.prototype.show = function (t, e, i, n, o, r) {
                ...
                var u = new a(s, e, this, i);
                this._dic[t] = u, u.show(n, o, r)
        ...
        return Object.defineProperty(t.prototype, "key", {
            ...
            var s = function () {
                var i = r.default.model.map.getMapMst(e, t).mst_id,
                    ...
                    s = [4],
                    a = [466];
                return "airbaseraid" == n._key && s.indexOf(o.getSelectedOperationType()) >= 0 && a.indexOf(o.mst_id) >= 0 ? 5 : n._data.type
            }();
            ...
            if (a <= 0) {
                ...
                _ = Math.pow(_, 2);
                var u = this._data.to.y - this._data.from.y;
                u = Math.pow(u, 2);
                a = Math.sqrt(_ + u) / 40
            }
