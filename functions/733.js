const function733 = function (t, e, i) {
    ...
    var o = i(1), r = i(107), s = i(323), a = i(33), _ = i(82), u = i(4), l = i(21), c = i(9), h = i(56),
        p = i(310), d = i(14), f = function (t) {
            function e() {
                ...
                var i = new PIXI.Sprite(l.COMMON_MAIN.getTexture(12)),
                    ...
                    y = new PIXI.Sprite(f), m = new PIXI.Sprite(c.COMMON_MISC.getTexture(180));
                m.name = "img_lv";
                var v = new PIXI.Sprite(l.COMMON_MAIN.getTexture(23));
                v.name = "img_houg";
