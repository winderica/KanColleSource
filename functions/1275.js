        ...
        h = function (t) {
            function e(e, i, n) {
                ...
                return r._selected_formation = 1, r._showText = function () {
                    ...
                    t.position.set(750, o.default.height / 2), t.alpha = 0, t.texture = u.MAP_COMMON.getTexture(117), createjs.Tween.get(t).to({
                        x: 630,
                        alpha: 1
                    }, 500).to({
                        x: 585
                    ...
                    e.position.set(o.default.width / 2, o.default.height / 2), e.texture = u.MAP_COMMON.getTexture(116), createjs.Tween.get(t).to({
                        alpha: 1,
                        scaleY: 1
                    }, 200).wait(950).to({
                        alpha: 0,
            ...
            return n(e, t), Object.defineProperty(e.prototype, "selected_formation", {
                ...
                t.position.set(o.default.width / 2, o.default.height / 2), t.scaleY = 0, t.alpha = 0, t.texture = u.MAP_COMMON.getTexture(114), createjs.Tween.get(t).to({
                    alpha: 1,
                    scaleY: 1
