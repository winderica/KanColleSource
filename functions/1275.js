const function1275 = function (t, e, i) {
    "use strict";
    ...
    var o = i(0), r = i(2), s = i(1), a = i(8), _ = i(4), u = i(12), l = i(14), c = i(1276), h = function (t) {
        function e(e, i, n) {
        ...
        return n(e, t), e.prototype._start = function () {
            ...
            var t = this;
            (new l.ShipLoader).add(this._mst_id, !0, "full").load(function () {
                t._loaded()
            })
        }, e.prototype._loaded = function () {
            var t = this, e = o.default.model.ship_graph.get(this._mst_id).getBattleOffset(!0),
            ...
            var t = this, e = o.default.model.ship.getMst(this._mst_id).name;
            ...
            }).wait(400).to({ alpha: 1 }, 600).call(function () {
                t._showText()
            }), createjs.Tween.get(this._mes_box).wait(100).to({ alpha: 1 }, 600), createjs.Tween.get(this._chara).to({
            ...
            var t = this;
            createjs.Tween.get(this._layer).to({ alpha: 0 }, 200).call(function () {
                t._endTask()
            })
        }, e.prototype._endTask = function () {
            this._smokeLayer.stop(), this._gear.deactivate(), this._gear.dispose(), this._layer.parent.removeChild(this._layer), t.prototype._endTask.call(this)
        }, e
    }(r.TaskBase);
    ...
    var p = function (t) {
        function e() {
            ...
            return e._anim = function () {
                ...
                } else clearInterval(e._timer_id), e.emit("complete")
        ...
        function e() {
            var e = t.call(this) || this;
            return e._s1 = new u.Sprite, e._s1.anchor.set(.5), e._s2 = new PIXI.Sprite, e._s2.anchor.set(.5), e._s3 = new PIXI.Sprite, e._s3.anchor.set(.5), e.addChild(e._s1), e.addChild(e._s2), e.addChild(e._s3), e
        }
        ...
        return n(e, t), e.prototype.initialize = function () {
            ...
            if (null == this._t1 && null == this._t2 && null == this._t3) {
                ...
                this._t1 = createjs.Tween.get(this._s1).wait(e).to({
                    ...
                    scaleX: 1,
                    scaleY: 1
                }, 150).to({ y: -128, alpha: 0, scaleX: .75, scaleY: .75 }, 400).call(function () {
