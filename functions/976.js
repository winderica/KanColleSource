const function976 = function (t, e, i) {
    ...
    var o = i(0), r = i(17), s = i(977), a = i(978), _ = i(979), u = i(984), l = i(985), c = i(990), h = i(991),
        p = i(1), d = function (t) {
            function e(e, i, n, o) {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "content", {
                ...
                this._removePreContent(), this._content = 6 == e ? new l.LayoutEventMap1(e, this._onSelect, this._onSelectAirUnit) : 4 == e ? new c.LayoutEventMap2(e, this._onSelect, this._onSelectAirUnit) : new h.LayoutEventMap4(e, this._onSelect, this._onSelectAirUnit), this._content.initialize(i), this.addChildAt(this._content, 0), this._content.activate(), this._updateBackBtn(!0), this._updateNextBtn(t, e, i)
