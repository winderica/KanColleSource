        ...
        a = function (t) {
            function e() {
                ...
                return e._onClickDeck = function (t) {
                    ...
                    e._onClickOther()
                }), e.addChild(e.deck1, e.deck2, e.deck3, e.deck4, e.deckOther), o.default.model.deck.exist3rdUnit && (e.icon3rdUnit = new PIXI.Sprite(r.COMMON_MISC.getTexture(188)), e.icon3rdUnit.position.set(75, -21), e.addChild(e.icon3rdUnit)), e
            }
