const function825 = function (t, e, i) {
    ...
    var o = i(5), r = i(0), s = i(47), a = i(826), _ = i(827), u = i(828), l = i(830), c = i(831), h = i(832),
        p = i(833), d = i(834), f = i(344), y = i(835), v = i(836), g = i(837), m = i(163), b = i(838), w = i(847),
        x = i(848), I = i(849), T = i(83), O = i(219), P = function (t) {
            function e() {
                ...
                return e.nDocks = [], e.listPageIndex = 0, e.shipSortKeyType = 4, e._onClickEmptySlot = function (t) {
                    ...
                    var i = t - 1;
                    e.timerState = x.TimerState.UpdateOnly, new v.OpenNewDockAPI(t).start(function () {
                        e.mainView.unLockAnimation(i, function () {
                            var t = r.default.model.useItem.get(m.RepairConst.OPEN_KEY_ITEMID), i = 0 < t.count;
                    ...
                    switch (s) {
                        case!1:
                            ...
                            break;
                        case!0:
                            var a = i.memShipId, _ = n.useHiSpeed, u = t - 1, l = r.default.model.ship.get(a), c = {
                                hpNow: l.hpNow,
                                hpMax: l.hpMax,
                                damaged: l.isDamaged(),
                            ...
                            e.mainView.stopAnimation(u), h.start(function () {
                                ...
                                r.default.view.portMain.updateInfo(), a.start(function () {
                                    ...
                                    _ || 1 == f.state ? (e.mainView.updateViewState(u, 1), e.mainView.updateShipInfo(u, c.hpNow, c.hpMax, l.level, l.mstID, l.name, l.memID, c.damaged, l.starNum, l.isMarriage()), e.mainView.updateDockInfo(u, 1, t, c.completeTime + Date.now())) : e.mainView.updateViewState(u, f.state), i.dispose(), n.dispose(), o.hide(function () {
                                        ...
                                        var n = l.mstID, s = c.hpNow / c.hpMax > .5 ? 11 : 12;
            ...
            return n(e, t), e.prototype.dispose = function () {
                ...
                var a = r.default.model.useItem.get(m.RepairConst.OPEN_KEY_ITEMID), _ = 0 < a.count;
