const function1386 = function (t, e, i) {
    ...
    var o = i(0), r = i(17), s = i(12), a = i(6), _ = function (t) {
        function e() {
            var e = t.call(this) || this;
            return e._bg = new r.FadeBox(.9, 0), e._chara = new PIXI.Container, e._bg_box = new u, e._item_layer = new l, e._name_layer = new c, e._bg.hide(0), e._item_layer.position.x = 600, e.addChild(e._bg), e.addChild(e._chara), e.addChild(e._bg_box), e.addChild(e._item_layer), e.addChild(e._name_layer), e
        }
