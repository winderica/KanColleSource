const function1176 = function (t, e, i) {
    ...
    var o = i(0), r = i(2), s = i(31), a = i(373), _ = i(163), l = i(125), u = i(101), c = i(151), h = i(1177),
        p = i(207), d = i(124), f = i(8), y = i(197), m = i(6), v = i(409), g = i(410), b = i(170),
        w = function (t) {
            function e(e, i, n) {
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                var _ = new v.DutyEndAPI(n, r), l = _.result;
                _.start(function () {
                ...
                var n = [511, 513, 688, 689, 690];
                if ((1 == t.isNeedUpdateUseitem() || n.indexOf(this._model.id) >= 0) && i.add(new u.UseItemAPI), t.getRewards(2).length > 0 && i.add(new a.DeckAPI), t.getRewards(11).length > 0) i.add(new p.UserShipAPI); else if (318 == this._model.id || 513 == this._model.id) {
