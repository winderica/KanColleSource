const function174 = function (t, e, i) {
    ...
    var n = i(18), o = function () {
        ...
        return t.getAttackVoiceIDs = function (t, e) {
            ...
            return "\u6f5c\u6c34\u65b0\u68f2\u59eb" == i ? 391173640 : "\u6226\u8266\u4ecf\u68f2\u59eb" == i ? 394174540 : "\u6b27\u5dde\u68f2\u59eb" == i ? 397175540 : "\u8b77\u885b\u72ec\u9084\u59eb" == i ? 423182140 : "\u8b77\u885b\u72ec\u9084\u59eb-\u58ca" == i ? 423182140 : -1
        }, t.getLastGaspVoiceID = function (t, e) {
            if (t.data.model.map_info.area_id != n.EVENT_AREA_ID) return -1;
            if (0 == t.data.model.map_info.isBoss()) return -1;
            var i = (t.data.model.map_info.map_no, e.name);
            return "\u6f5c\u6c34\u65b0\u68f2\u59eb" == i || "\u6f5c\u6c34\u65b0\u68f2\u59eb \u30d0\u30ab\u30f3\u30b9mode" == i ? 391173641 : "\u91cd\u5de1\u590f\u59eb" == i ? 35470540 : "\u6226\u8266\u4ecf\u68f2\u59eb-\u58ca" == i ? 394174840 : "\u6226\u8266\u590f\u59eb" == i ? 27605574 : "\u7a7a\u6bcd\u590f\u59eb" == i ? 29405864 : "\u6b27\u5dde\u68f2\u59eb-\u58ca" == i ? 397175840 : "\u96c6\u7a4d\u5730\u68f2\u59eb" == i || "\u96c6\u7a4d\u5730\u68f2\u59eb \u30d0\u30ab\u30f3\u30b9mode" == i ? 33265340 : "\u96c6\u7a4d\u5730\u68f2\u59eb-\u58ca" == i || "\u96c6\u7a4d\u5730\u68f2\u59eb \u30d0\u30ab\u30f3\u30b9mode-\u58ca" == i ? 33265640 : "\u6e2f\u6e7e\u590f\u59eb" == i || "\u6e2f\u6e7e\u590f\u59eb-\u58ca" == i ? 35369940 : "\u6cca\u5730\u6c34\u9b3c" == i || "\u6cca\u5730\u6c34\u9b3c \u30d0\u30ab\u30f3\u30b9mode" == i ? 30506094 : "\u8b77\u885b\u72ec\u9084\u59eb" == i ? 423182440 : "\u8b77\u885b\u72ec\u9084\u59eb-\u58ca" == i ? 423182440 : -1
            ...
            return "\u91cd\u5de1\u590f\u59eb" == n ? {
                ...
                a: [423182120],
                d: [423182130]
            } : "\u8b77\u885b\u72ec\u9084\u59eb-\u58ca" == n ? { a: [423182420], d: [423182430] } : void 0
        }, t
    }();
    e.EnemyVoiceConst = o
}