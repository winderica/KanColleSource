const function546 = function (t, e, i) {
    var n;
    !function () {
        function o(t, e, i) {
        ...
        function c(t, e, i) {
            ...
            for (var n = t.className.split(/\s+/), o = 0; o < e.length; o += 1) {
                for (var r = !1, s = 0; s < n.length; s += 1) if (e[o] === n[s]) {
                    r = !0;
                    break
                }
                r || n.push(e[o])
            ...
            for (e = [], o = 0; o < n.length; o += 1) {
                for (r = !1, s = 0; s < i.length; s += 1) if (n[o] === i[s]) {
                    r = !0;
                    break
                }
                r || e.push(n[o])
        ...
        function d(t, e, i) {
            ...
            e = _(t, "link", { rel: "stylesheet", href: e, media: "all" });
            var o = !1, r = !0, s = null, a = i || null;
        ...
        function M(t) {
            if (t.g) {
                var e = h(t.f, t.a.c("wf", "active")), i = [], n = [t.a.c("wf", "loading")];
        ...
        function E(t, e) {
            this.c = t, this.f = e, this.a = _(this.c, "span", { "aria-hidden": "true" }, this.f)
        }
        ...
        function R(t, e, i, n, o, r, s) {
            this.v = t, this.B = e, this.c = i, this.a = n, this.s = s || "BESbswy", this.f = {}, this.w = o || 3e3, this.u = r || null, this.m = this.j = this.h = this.g = null, this.g = new E(this.c, this.s), this.h = new E(this.c, this.s), this.j = new E(this.c, this.s), this.m = new E(this.c, this.s), t = new w(this.a.c + ",serif", T(this.a)), t = N(t), this.g.a.style.cssText = t, t = new w(this.a.c + ",sans-serif", T(this.a)), t = N(t), this.h.a.style.cssText = t, t = new w("serif", T(this.a)), t = N(t), this.j.a.style.cssText = t, t = new w("sans-serif", T(this.a)), t = N(t), this.m.a.style.cssText = t, L(this.g), L(this.h), L(this.j), L(this.m)
        }
        ...
        function X(t) {
            ...
            (e = i === t.f.serif && n === t.f["sans-serif"]) || (e = D() && U(t, i, n)), e ? ot() - t.A >= t.w ? D() && U(t, i, n) && (null === t.u || t.u.hasOwnProperty(t.a.c)) ? F(t, t.v) : F(t, t.B) : V(t) : F(t, t.v)
        }
        ...
        function Y(t, e, i, n, o) {
            ...
            (t.f || t.g) && setTimeout(function () {
                var t = o || null, a = n || null || {};
                if (0 === i.length && r) M(e.a); else {
                    e.f += i.length, r && (e.j = r);
                    var _, u = [];
                    for (_ = 0; _ < i.length; _++) {
                        var l = i[_], h = a[l.c], p = e.a, d = l;
                        if (p.g && c(p.f, [p.a.c("wf", d.c, T(d).toString(), "loading")]), S(p, "fontloading", d), p = null, null === _t) if (window.FontFace) {
        ...
        function H(t, e, i) {
            var n = [], o = i.timeout;
            k(e);
            var n = j(t.a, i, t.c), r = new z(t.c, e, o);
        ...
        function tt(t) {
            for (var e = t.f.length, i = 0; i < e; i++) {
                var n = t.f[i].split(":"), o = n[0].replace(/\+/g, " "), r = ["n4"];
                if (2 <= n.length) {
                    var s, a = n[1];
                    if (s = [], a) for (var a = a.split(","), _ = a.length, u = 0; u < _; u++) {
                        var l;
                        if (l = a[u], l.match(/^[\w-]+$/)) {
                            var c = pt.exec(l.toLowerCase());
                            if (null == c) l = ""; else {
                                if (l = c[2], l = null == l || "" == l ? "n" : ht[l], null == (c = c[1]) || "" == c) c = "4"; else var h = ct[c],
        ...
        b.prototype.c = function (t) {
            ...
            var t = this.c.o.document, e = this, i = ot(), n = new Promise(function (n, o) {
                function r() {
                ...
                r()
            }), o = null, r = new Promise(function (t, i) {
                o = setTimeout(i, e.f)
            });
        ...
        z.prototype.g = function (t) {
            ...
            var e = this.a;
            if (e.g) {
                var i = h(e.f, e.a.c("wf", t.c, T(t).toString(), "active")), n = [],
            ...
            this.c = new a(this.j, t.context || this.j), this.g = !1 !== t.events, this.f = !1 !== t.classes, H(this, new C(this.c, t), t)
            ...
            var e, i, n = this.a.urls || [], o = this.a.families || [], r = this.a.testStrings || {}, s = new y;
            for (e = 0, i = n.length; e < i; e++) d(this.c, n[e], v(s));
            var a = [];
            for (e = 0, i = o.length; e < i; e++) if (n = o[e].split(":"), n[1]) for (var _ = n[1].split(","), u = 0; u < _.length; u += 1) a.push(new w(n[0], _[u])); else a.push(new w(n[0]));
            g(s, function () {
                t(a, r)
            })
        };
        var ut = "https://fonts.googleapis.com/css", lt = {
                latin: "BESbswy",
        ...
        et.prototype.load = function (t) {
            var e = new y, i = this.c, n = new J(this.a.api, this.a.text), o = this.a.families;
            Z(n, o);
            var r = new $(o);
            tt(r), d(i, Q(n), v(e)), g(e, function () {
                t(r.a, r.c, dt)
            })
            ...
            e ? f(this.c, (this.a.api || "https://use.typekit.net") + "/" + e + ".js", function (e) {
                if (e) t([]); else if (i.Typekit && i.Typekit.config && i.Typekit.config.fn) {
                    ...
                    for (var n = [], o = 0; o < e.length; o += 2) for (var r = e[o], s = e[o + 1], a = 0; a < s.length; a++) n.push(new w(r, s[a]));
                    try {
            ...
            e ? (i.__webfontfontdeckmodule__ || (i.__webfontfontdeckmodule__ = {}), i.__webfontfontdeckmodule__[e] = function (e, i) {
                for (var o = 0, r = i.fonts.length; o < r; ++o) {
                    var s = i.fonts[o];
                    n.a.push(new w(s.name, P("font-weight:" + s.weight + ";font-style:" + s.style)))
                }
                t(n.a)
