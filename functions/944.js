        ...
        S = function (t) {
            ...
            return n(e, t), e.prototype.initialize = function () {
                ...
                if (this._selected_area_id != t) {
                    ...
                    t == s.EVENT_AREA_ID && null == this._event_sortie_condition && (this._event_sortie_condition = new P.EventSortieCondition, i.add(this._event_sortie_condition.getPreLoadTask()));
                    ...
                    i.add(new v.TaskLoadGaugeResources(o)), i.start(function () {
