const function676 = function (t, e, i) {
    ...
    var o = i(110), r = i(317), s = i(81), a = i(4), _ = i(20), u = i(9), l = i(318), c = i(678), h = i(319),
        p = i(13), d = function (t) {
            function e() {
                var e = t.call(this) || this, i = new PIXI.Sprite;
                i.texture = _.COMMON_MAIN.getTexture(60), i.position.set(0, -37);
                ...
                var f = new PIXI.Sprite(_.COMMON_MAIN.getTexture(61));
                e.shipCard = new r.ShipCard(!0, !0), e.sixSlotMessage = new PIXI.Sprite(_.COMMON_MAIN.getTexture(62));
