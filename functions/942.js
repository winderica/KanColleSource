const function942 = function (t, e, i) {
    "use strict";
    ...
    var o = i(26), r = i(1), s = function (t) {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "enabled", {
            ...
            this._under.texture = o.SALLY_AIRUNIT.getTexture(25), this._bg.texture = o.SALLY_AIRUNIT.getTexture(23), this._txt.texture = o.SALLY_AIRUNIT.getTexture(26), this._over.texture = o.SALLY_AIRUNIT.getTexture(25), null != this._t && (this._t.setPaused(!0), this._t = null), this._update(!1)
            ...
            0 == this._enabled ? (this._under.visible = !1, this._bg.texture = o.SALLY_AIRUNIT.getTexture(24), this._txt.visible = !1, this._over.visible = !1) : 1 == t ? (this._under.visible = !1, this._bg.texture = o.SALLY_AIRUNIT.getTexture(23), this._txt.visible = !0, this._over.visible = !0) : (this._bg.texture = o.SALLY_AIRUNIT.getTexture(23), this._txt.visible = !0, this._over.visible = !1)
        }, e
    }(PIXI.Container);
