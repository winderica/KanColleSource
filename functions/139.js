const function139 = function (t, e, i) {
    ...
    var o = i(5), r = i(0), s = i(2), a = i(12), _ = i(15), l = i(25), u = i(44), c = i(451), h = i(452),
        p = function (t) {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "view", {
                ...
                var t = this._attacker.mst_id, e = this._attacker.isDamaged(),
                    i = r.default.resources.getShip(t, e, "full"), n = new a.Sprite(i), o = new u.ShipFlash(i),
                    s = r.default.model.ship_graph.get(t), _ = s.getBattleOffset(e);
                n.x = o.x = _.x, n.y = o.y = _.y;
                var l = this._friend ? 1 : -1, c = Math.floor(4 * Math.random());
