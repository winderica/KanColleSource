        ...
        h = function (t) {
            function e(e, i, n) {
                ...
                return r._selected_formation = 1, r._showText = function () {
                    ...
                    t.position.set(750, o.default.height / 2), t.alpha = 0, t.texture = l.MAP_COMMON.getTexture(115), createjs.Tween.get(t).to({
                        x: 630,
                        alpha: 1
                    }, 500).to({
                        x: 585
                    ...
                    var t = 1 == r._deck.isCombined() ? r._deck.getCountSubDeck() : r._deck.getCount();
                    if (r._layer.boxes.initialize(t, r._onSelectFormation, 6), r._layer.boxes.alpha = 0, r._layer.boxes.count <= 1 || r._isLongRange) {
                        var e = r._telopContainer.bg;
                        createjs.Tween.get(e).wait(150).to({
                            alpha: 0,
                            scaleY: 0
                        }, 100).call(r._showText2);
                        var i = r._telopContainer.text;
                    ...
                    e.position.set(o.default.width / 2, o.default.height / 2), e.texture = l.MAP_COMMON.getTexture(114), createjs.Tween.get(t).to({
                        alpha: 1,
                        scaleY: 1
                    }, 200).wait(950).to({
                        alpha: 0,
            ...
            return n(e, t), Object.defineProperty(e.prototype, "selected_formation", {
                ...
                t.position.set(o.default.width / 2, o.default.height / 2), t.scaleY = 0, t.alpha = 0, t.texture = l.MAP_COMMON.getTexture(112), createjs.Tween.get(t).to({
                    alpha: 1,
                    scaleY: 1
