const function655 = function (t, e, i) {
    ...
    var o = i(82), r = i(5), s = i(106), a = i(107), _ = i(656), l = i(1), u = function (t) {
        function e(e, i) {
        ...
        return n(e, t), e.prototype.initialize = function () {
            ...
            var r = o.getChildByName(this._suffix.bg), s = o.getChildByName(this._suffix.txt),
                a = o.getChildByName(this._suffix.full), _ = this._charaPosition[i], l = createjs.Ease.linear;
            createjs.Tween.get(r).to({ alpha: 1 }, 100, l), createjs.Tween.get(s).to({ alpha: 1 }, 100, l), createjs.Tween.get(a).wait(150).to({
                alpha: 1,
                x: _.x
            }, 150, l).call(function () {
