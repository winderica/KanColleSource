            ...
            function e(e, i) {
                ...
                return n._selected_formation = 12, n._showText = function () {
                    ...
                    if (n._layer.boxes.initialize(t, e, n._onSelectFormation), n._layer.boxes.alpha = 0, n._layer.boxes.count <= 1) {
                        ...
                        }), n._layer.description.alpha = 0, 1 == t ? n._layer.description.texture = u.SALLY_JIN.getTexture(18) : 2 == t ? n._layer.description.texture = u.SALLY_JIN.getTexture(38) : 3 == t && (n._layer.description.texture = u.SALLY_JIN.getTexture(43)), createjs.Tween.get(n._layer.description).to({
                            alpha: 1
                        }, 300)
                    }
                    ...
                    n._selected_formation = t, n._layer.boxes.deactivate(), createjs.Tween.get(n._layer.boxes).to({
                        alpha: 0
                    }, 200), createjs.Tween.get(n._layer.description).to({
                        alpha: 0
