const function1155 = function (t, e, i) {
    ...
    var o = i(0), r = i(2), s = i(79), a = i(77), _ = i(195), u = i(6), l = i(405), c = i(1156), h = i(1),
        p = function (t) {
            function e(e) {
                ...
                return i._selected = null, i._FurnitureIdsonPage = new Array(10), i._ids_before = new Array(7), i._ids_after = new Array(7), i._ids_season = new Array(6), i._onClickBtnGoFigure = function (t) {
                    i._ListNowPage = i._ListPagerLeft + t, u.SE.play("249"), i._drawList()
                    ...
                    switch (i._selected) {
                        case i._topView.btn_wall:
                            i._ids_after[1] != i._NowFurnitureSelected && u.SE.play("246"), t = i._ids_season[1], i._ids_after[1] = i._NowFurnitureSelected;
                            break;
                        case i._topView.btn_floor:
                            i._ids_after[0] != i._NowFurnitureSelected && u.SE.play("246"), t = i._ids_season[0], i._ids_after[0] = i._NowFurnitureSelected;
                            break;
                        case i._topView.btn_desk:
                            i._ids_after[5] != i._NowFurnitureSelected && u.SE.play("246"), t = i._ids_season[5], i._ids_after[5] = i._NowFurnitureSelected;
                            break;
                        case i._topView.btn_window:
                            i._ids_after[2] != i._NowFurnitureSelected && u.SE.play("246"), t = i._ids_season[2], i._ids_after[2] = i._NowFurnitureSelected;
                            break;
                        case i._topView.btn_object:
                            i._ids_after[3] != i._NowFurnitureSelected && u.SE.play("246"), t = i._ids_season[3], i._ids_after[3] = i._NowFurnitureSelected;
                            break;
                        case i._topView.btn_chest:
                            i._ids_after[4] != i._NowFurnitureSelected && u.SE.play("246"), t = i._ids_season[4], i._ids_after[4] = i._NowFurnitureSelected
                    }
                    ...
                    i._selected = i._topView.btn_wall, i._topView.menumoji.texture = l.INTERIOR_PARTS.getTexture(19), i.interactiveAllLeftMenuSet(!0), i._topView.btn_wall.interactive = !1, i._topView.btn_wall.texture = l.INTERIOR_PARTS.getTexture(29), i._changeList()
                }, i._onClickBtnFloor = function () {
                    i._selected = i._topView.btn_floor, i._topView.menumoji.texture = l.INTERIOR_PARTS.getTexture(18), i.interactiveAllLeftMenuSet(!0), i._topView.btn_floor.interactive = !1, i._topView.btn_floor.texture = l.INTERIOR_PARTS.getTexture(26), i._changeList()
                }, i._onClickBtnDesk = function () {
                    i._selected = i._topView.btn_desk, i._topView.menumoji.texture = l.INTERIOR_PARTS.getTexture(23), i.interactiveAllLeftMenuSet(!0), i._topView.btn_desk.interactive = !1, i._topView.btn_desk.texture = l.INTERIOR_PARTS.getTexture(41), i._changeList()
                }, i._onClickBtnWindow = function () {
                    i._selected = i._topView.btn_window, i._topView.menumoji.texture = l.INTERIOR_PARTS.getTexture(20), i.interactiveAllLeftMenuSet(!0), i._topView.btn_window.interactive = !1, i._topView.btn_window.texture = l.INTERIOR_PARTS.getTexture(32), i._changeList()
                }, i._onClickBtnObject = function () {
                    i._selected = i._topView.btn_object, i._topView.menumoji.texture = l.INTERIOR_PARTS.getTexture(21), i.interactiveAllLeftMenuSet(!0), i._topView.btn_object.interactive = !1, i._topView.btn_object.texture = l.INTERIOR_PARTS.getTexture(35), i._changeList()
                }, i._onClickBtnChest = function () {
                    i._selected = i._topView.btn_chest, i._topView.menumoji.texture = l.INTERIOR_PARTS.getTexture(22), i.interactiveAllLeftMenuSet(!0), i._topView.btn_chest.interactive = !1, i._topView.btn_chest.texture = l.INTERIOR_PARTS.getTexture(38), i._changeList()
            ...
            return n(e, t), e.prototype.cancel = function () {
                ...
                this._topView.btn_wall.interactive = t, this._topView.btn_floor.interactive = t, this._topView.btn_desk.interactive = t, this._topView.btn_window.interactive = t, this._topView.btn_object.interactive = t, this._topView.btn_chest.interactive = t, this._topView.btn_wall.texture = l.INTERIOR_PARTS.getTexture(t ? 27 : 28), this._topView.btn_floor.texture = l.INTERIOR_PARTS.getTexture(t ? 24 : 25), this._topView.btn_desk.texture = l.INTERIOR_PARTS.getTexture(t ? 39 : 40), this._topView.btn_window.texture = l.INTERIOR_PARTS.getTexture(t ? 30 : 31), this._topView.btn_object.texture = l.INTERIOR_PARTS.getTexture(t ? 33 : 34), this._topView.btn_chest.texture = l.INTERIOR_PARTS.getTexture(t ? 36 : 37)
                ...
                this._ListNowPage == this._ListNowFurniturePage ? this._topView.iconEquipment.position.set(288, 48 * this._ListNowFurnitureLine + 59) : this._topView.iconEquipment.position.set(-150, -150), this.PagerFigureDraw(), null != t && u.SE.play(t)
