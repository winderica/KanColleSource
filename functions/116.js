const function116 = function (t, e, i) {
    ...
    var C = function (t) {
        function i() {
                ...
                switch (t) {
                    ...
                    case !0:
                        var e = i._materialAmountContainer.kDockId,
                            ...
                            p = 0 < c,
                            d = new m.CreateShipAPI(e, 0, s, n, u, l, h, p ? 1 : 0),
                            f = new b.KDockAPI,
                        ...
                        0 == o.default.model.basic.getTutorialProgress() && y.add(new _.UpdateTutorialAPI(10)), y.add(d), y.add(f), o.default.view.clickGuard = !0, y.start(function () {
                            ...
                            i.build(t.id, !1, p, u, a, _, s, c, l, h), o.default.view.portMain.updateInfo(), i.arsenalTimerMode = T.WaitComplete;
                            ...
                            switch (t) {
                                ...
                                case y.Result.START:
                                    var e = _.ammo,
                                        ...
                                        h = _.devKit,
                                        p = 0 < c,
                                        d = new m.CreateShipAPI(s, 1, n, e, u, l, h, p ? 1 : 0),
                                        g = new b.KDockAPI,
                                    ...
                                    v.add(d), v.add(g), o.default.view.clickGuard = !0, v.start(function () {
                                        ...
                                        i.build(t.id, !0, p, c, a, u, n, h, l, f)
            ...
            101 == I || 102 == I ? (n = new PIXI.Sprite(u.ARSENAL_SKIN_1.getTexture(1)), s = new PIXI.Sprite(u.ARSENAL_SKIN_1.getTexture(0)), x = new PIXI.Sprite(u.ARSENAL_SKIN_1.getTexture(2))) : 201 == I ? (n = new PIXI.Sprite(l.ARSENAL_SKIN_2.getTexture(1)), s = new PIXI.Sprite(l.ARSENAL_SKIN_2.getTexture(0)), x = new PIXI.Sprite(l.ARSENAL_SKIN_2.getTexture(2))) : 301 != I && 311 != I || (n = new PIXI.Sprite(c.ARSENAL_SKIN_3.getTexture(1)), s = new PIXI.Sprite(c.ARSENAL_SKIN_3.getTexture(0)), x = new PIXI.Sprite(c.ARSENAL_SKIN_3.getTexture(2)));
