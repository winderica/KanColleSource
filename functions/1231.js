const function1231 = function (t, e, i) {
    ...
    var _ = function (t) {
        ...
        h = function (t) {
            ...
            return n(e, t), e.prototype.update = function (t) {
                3 == t ? (this._img.texture = r.DUTY_COMMON.getTexture(12), this._over.texture = r.DUTY_COMMON.getTexture(13), this._over.visible = !0, this._startAnimation()) : 2 == t ? (this._img.texture = r.DUTY_COMMON.getTexture(46), this._over.visible = !1, this._stopAnimation()) : (this._img.texture = PIXI.Texture.EMPTY, this._over.visible = !1, this._stopAnimation())
            }, e.prototype.dispose = function () {
                this._stopAnimation()
