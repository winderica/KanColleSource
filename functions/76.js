const function76 = function (t, e, i) {
    ...
    var o = i(0), r = i(6), s = i(63), a = i(1345), _ = function (t) {
        function e() {
        ...
        return n(e, t), e.prototype._start = function () {
            ...
            for (var u = 0, c = e; u < c.length; u++) {
                var a = c[u], l = this._scene.view.bannerGroupLayer.getBanner(a.attacker);
                n.push(l)
            }
            if (null != i) {
            ...
            for (var l = {}, u = 0, c = t; u < c.length; u++) {
                var s = c[u], a = s.defender.index;
                if (null == l[a]) l[a] = { damage: s.damage, hit: s.hit, shield: s.shield }; else {
                    var _ = l[a];
                    _.damage += s.damage, 2 == _.hit || 2 == s.hit ? _.hit = 2 : 1 == _.hit || 1 == s.hit ? _.hit = 1 : _.hit = 0
                }
            }
