        ...
        p = function (t) {
            function e(e) {
                ...
                return i._waitClick = function () {
                    ...
                    i._layer.buttonMode = !1, i._chara.texture = i._getPosterGirlTexture2(), createjs.Tween.get(i._chara).wait(300).to({
                        x: 1200
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                this._chara = new PIXI.Sprite(t), this._chara.position.set(760, 705), this._layer.addChild(this._chara), createjs.Tween.get(this._chara).to({
                    y: 45
