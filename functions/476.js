const function476 = function (t, e, i) {
    ...
    var o = i(2), r = i(19), s = i(8), a = i(12), _ = i(58), l = i(475), u = i(477), c = i(1), h = function (t) {
        function e(e) {
        ...
        return n(e, t), e.prototype._start = function () {
            ...
            i.addTween(l), l = createjs.Tween.get(this._texts.text2).wait(200).to({
                ...
                alpha: 0
            }, 200), i.addTween(l), l = createjs.Tween.get(this._particles).wait(200).to({ alpha: 0 }, 200).call(function () {
                e._particles.stopAnimation(), e._layer.removeChild(e._particles)
            }), i.addTween(l), l = createjs.Tween.get(t).to({ alpha: 0 }, 500).call(function () {
                t.dispose(), e._layer.removeChild(t)
            }), i.addTween(l), l = createjs.Tween.get(this._bg).wait(200).to({ alpha: 0 }, 300), i.addTween(l), i.start(function () {
    ...
    var p = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function () {
            ...
            var e = l.BATTLE_RESULT_EVENT_BASE.getTexture(6), i = new PIXI.Sprite(e);
            i.position.set(270, 8), this.addChild(i);
            var n = l.BATTLE_RESULT_EVENT_BASE.getTexture(3), o = new PIXI.Sprite(n);
