const function1060 = function (t, e, i) {
    "use strict";
    ...
    var o = i(0), r = i(11), s = i(16), a = i(110), _ = i(167), u = i(72), l = i(72), c = i(72), h = i(72),
        p = i(381), d = i(132), f = i(132), y = i(132), v = i(132), m = i(132), g = i(42), b = function (t) {
            function e() {
                ...
                return e._selected_state = 1, e._selected_tab_no = 0, e._onChangeTab = function (t, i) {
                    ...
                    if (t instanceof c.AlbumShipModel) {
                        ...
                        var i = new m.TaskShowSlotDetail(e._over, t, e._view);
                        i.start()
                    }
                }, e._onBack = function () {
                    o.default.scene.change(0)
                }, e._option = new u.AlbumSceneOptionModel, e._model = new l.AlbumModelManager, e._view = new g.MainView(e._onChangeTab, e._onChangePage, e._onSelect), e.addChild(e._view), e._over = new s.FadeBox(1, 0, 1200, 720), e._over.hide(0), e._over.visible = !1, e.addChild(e._over), e
            }
