    ...
    var o = i(0),
        ...
        b = function (t) {
            function e() {
                ...
                }, e._option = new l.AlbumSceneOptionModel, e._model = new u.AlbumModelManager, e._view = new v.MainView(e._onChangeTab, e._onChangePage, e._onSelect), e.addChild(e._view), e._over = new s.FadeBox(1, 0, 1200, 720), e._over.hide(0), e._over.visible = !1, e.addChild(e._over), e
            }
