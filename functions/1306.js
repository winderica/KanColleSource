const function1306 = function (t, e, i) {
    ...
    var o = i(0), r = i(4), s = i(33), a = i(245), _ = i(30), l = i(20), u = i(437), c = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function () {
            this._taihi.initialize(), this._taihisezu.initialize(), this._txt1.texture = l.MAP_COMMON.getTexture(155), this._txt2.texture = l.MAP_COMMON.getTexture(158), this._title.initialize(!1), this._title.update(l.MAP_COMMON.getTexture(103)), this._title.activate()
