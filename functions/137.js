const function137 = function (t, e, i) {
    ...
    var o = i(5), r = i(0), s = i(2), a = i(12), _ = i(15), u = i(25), l = i(44), c = i(448), h = i(449),
        p = function (t) {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "view", {
                ...
                var t = this._attacker.mst_id, e = this._attacker.isDamaged(),
                    i = r.default.resources.getShip(t, e, "full"), n = new a.Sprite(i), o = new l.ShipFlash(i),
                    s = r.default.model.ship_graph.get(t), _ = s.getBattleOffset(e);
                n.x = o.x = _.x, n.y = o.y = _.y;
                var u = this._friend ? 1 : -1, c = Math.floor(4 * Math.random());
                ...
                var o = createjs.Tween.get(this._view.chara).to({
                    ...
                    alpha: 1
                }, 300).to({ x: this._base_pos.x, y: this._base_pos.y }, 250);
                ...
                var a = createjs.Tween.get(t).to({ scaleX: 1, scaleY: 1, alpha: 1 }, 533, createjs.Ease.sineOut);
                a.call(function () {
                    e.scale.x = 1, e.scale.y = 1
                }), this._addAttackTween(e, a), a.call(function () {
                    createjs.Tween.get(e).to({ scaleX: 1.25, scaleY: 1.25 }, 466)
                }), a.to({ scaleX: 1.25, scaleY: 1.25, alpha: 0 }, 466), a.call(function () {
                    o._tweenEnd(e)
                })
                ...
                this._addAttackTween(e, a), a.call(function () {
                    createjs.Tween.get(t).to({
                        scaleY: 1.66,
                        alpha: 0
                    }, 466), createjs.Tween.get(e).to({ scaleY: 1.66 }, 466).call(function () {
                        o._tweenEnd(e)
                    })
                })
