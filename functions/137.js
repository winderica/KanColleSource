const function137 = function (t, e, i) {
    "use strict";
    ...
    var o = i(5), r = i(0), s = i(45), a = i(22), _ = i(50), u = i(64), l = i(6), c = i(15), h = i(178),
        p = function (t) {
            function e() {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "mst_id", {
                ...
                var i, n, o = this, r = new PIXI.Point(this.x, this.y),
                    s = new PIXI.Point(t.x + this._offset.x, t.y + this._offset.y), a = r.x <= s.x, _ = s.x - r.x,
                ...
                var o, r, s = new PIXI.Point(this.x, this.y),
                    a = new PIXI.Point(t.x + this._offset.x, t.y + this._offset.y), _ = s.x <= a.x;
                ...
                }), this._end = a, { s: s, c1: o, c2: r, e: a, ex: c }
            }, e
        }(PIXI.Container);
    e.Plane = p;
    var d = function (t) {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "fire", {
            ...
            if (1 == _.SlotUtil.isEnemyItem(t)) {
                ...
                var o = r.default.model.slot.getMst(t), u = o.planeIconType;
            ...
            var t = this, e = Math.round(46 * Math.random() - 23), i = Math.round(46 * Math.random() - 23),
                n = 100 * Math.sqrt(Math.pow(e - this.x, 2) + Math.pow(i - this.y, 2));
            this._t = createjs.Tween.get(this).to({ y: i, x: e }, n).call(function () {
                t._tween()
            })
        }, e
        ...
        return n(e, t), e.prototype.initialize = function () {
            this._fire1.texture = c.BATTLE_MAIN.getTexture(82), this._fire2.texture = c.BATTLE_MAIN.getTexture(82)
        ...
        return n(e, t), e.prototype.initialize = function () {
            this._content.texture = c.BATTLE_MAIN.getTexture(83)
        }, e.prototype.activate = function () {
            null == this._t && (this.scale.set(0), this.visible = !0, createjs.Tween.get(this.scale).to({
                x: 1,
                y: 1
            }, 300), this._t = createjs.Tween.get(this._content, { loop: !0 }).wait(100).call(this._reverseImage))
