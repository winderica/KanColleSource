const function591 = function (t, e, i) {
    ...
    var o = i(0), r = i(4), s = i(33), a = i(9), _ = i(146), l = function (t) {
        function e() {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "ship_canvas", {
            ...
            this._ship_canvas = null, this._bg = null, this._expedition_name.destroy(), this._expedition_name = null, this._user_info.dispose(), this._user_info = null, this._banner_canvas = null;
    ...
    var u = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function (t, e) {
            ...
            this.removeChildren(), this._user_name.destroy(), this._user_lv.destroy(), this._user_rank.destroy(), this._fleet_name.destroy()
        }, e
        ...
        return n(e, t), e.prototype.initialize = function () {
            ...
            this.removeChildren(), this._name.destroy(), this._lv.destroy()
        }, e
        ...
        return n(e, t), e.prototype.initialize = function () {
            ...
            this.removeChildren(), this._total_exp.destroy()
        }, e
        ...
        return n(e, t), e.prototype.initialize = function () {
            ...
            this.removeChildren(), this._item1_name.destroy(), this._item1_count.destroy(), this._item2_name.destroy(), this._item2_count.destroy(), this._fuel.destroy(), this._ammo.destroy(), this._steel.destroy(), this._baux.destroy()
        }, e
    }(PIXI.Container)
}