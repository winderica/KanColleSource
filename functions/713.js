const function713 = function (t, e, i) {
    ...
    var o = i(0), r = i(21), s = i(109), a = i(714), _ = i(57), u = i(321), l = i(318), c = i(322),
        h = function (t) {
            function e(e, i) {
            ...
            return n(e, t), e.prototype.dispose = function () {
                if (this.presetTitle.dispose(), this.presetExpansionContainer.hideAllPopupAndFocus(), this.presetExpansionContainer.dispose(), this.btnBack.dispose(), this.arrowTopButton.dispose(), this.arrowBottomButton.dispose(), this.longShipBannerContainer.dispose(), this.presets) for (var t = 0; t < this.presets.length; t++) this.presets[t] = null;
                this.clickBack = null, this.clickExpand = null, this.deckId = null, this.headIndex = null, this.presetList = null, this.presets = null, this.presetExpansionContainer = null, this.btnBack = null, this.arrowTopButton = null, this.arrowBottomButton = null, this.longShipBannerContainer = null
