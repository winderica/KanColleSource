const function1470 = function (t, e, i) {
    ...
    var o = i(0), r = i(2), s = i(203), a = i(474), _ = i(244), l = i(6), u = i(36), c = i(475), h = function (t) {
        function e(e, i) {
        ...
        return n(e, t), e.prototype._start = function () {
            ...
            if (1 == i.isUseitem()) {
                var n = this._canvas, r = i.mst_id, l = new _.TaskBonusUseItem(n, r, i.count, !1, t);
                l.start(function () {
                    e._bonus(l)
                })
            } else if (1 == i.isShip()) {
                var n = this._canvas, r = i.mst_id, u = new s.TaskBonusShip(n, r, !1, t);
                u.start(function () {
                    e._bonus(u)
                })
            } else {
