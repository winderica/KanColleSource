const function230 = function (t, e, i) {
    ...
    var o = i(0), r = i(9), s = function (t) {
        function e() {
            var e = t.call(this) || this;
            return e._now = -1, e._max = 100, e._bar = new a, e._img = new PIXI.Sprite, e._light = new PIXI.Sprite, e._tp = new _, e.addChild(e._bar), e.addChild(e._img), e.addChild(e._light), e.addChild(e._tp), e.visible = !1, e
        }
        ...
        return n(e, t), e.prototype.initialize = function (t) {
            ...
            n = Math.max(n, 0), n = Math.min(n, 1), this._bar.update(n, i), 1 == this._tp.enabled ? (this._tp.update(t, e), this._tp.visible = !0) : this._tp.visible = !1
    ...
    var a = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function (t, e, i) {
            ...
            if (void 0 === e && (e = null), this._stopAnimation(), null == e) this.scale.x = t; else {
                var i = this.width - this.width * t, n = i / 2 / 30 * 1e3;
                this._t = createjs.Tween.get(this.scale).to({ x: t }, n).call(function () {
                    null != e && e()
                })
            }
        }, e.prototype.dispose = function () {
        ...
        return n(e, t), e.prototype.update = function (t) {
            if (t = Math.floor(t), t = Math.max(0, t), 0 != (t = Math.min(9999, t))) for (var e = !1, i = 0; i < this._nums.length; i++) {
                var n = Math.pow(10, this._nums.length - i - 1), o = Math.floor(t / n);
                o > 0 || 1 == e ? (this._nums[i].update(o), e = !0) : this._nums[i].update(-1), t %= n
            } else for (var i = 0; i < this._nums.length; i++) i == this._nums.length - 1 ? this._nums[i].update(0) : this._nums[i].update(-1)
        }, e
