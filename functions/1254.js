const function1254 = function (t, e, i) {
    ...
    var o = i(2), r = i(12), s = i(6), a = i(20), _ = function (t) {
        function e(e) {
        ...
        return n(e, t), e.prototype._start = function () {
            this._img1 = new r.Sprite(a.MAP_COMMON.getTexture(128)), this._img1.anchor.set(.5), this._img1.scale.set(.6), this._img1.y = -4, this._img1.alpha = 0, this._layer.addChild(this._img1), this._img2 = new r.Sprite(a.MAP_COMMON.getTexture(129)), this._img2.anchor.set(.5), this._img2.scale.set(.6), this._img2.y = -4, this._img2.alpha = 0, this._layer.addChild(this._img2), this._img3 = new r.Sprite(a.MAP_COMMON.getTexture(130)), this._img3.anchor.set(.5), this._img3.scale.set(.6), this._img3.y = -4, this._img3.alpha = 0, this._layer.addChild(this._img3), this._anim()
            ...
            s.SE.play("213"), createjs.Tween.get(this._img1).to({
                ...
                scaleY: 1,
                alpha: 1
            }, 200).to({ sceleX: 1.3, scaleY: 1.3, alpha: 0 }, 300).wait(300).call(function () {
