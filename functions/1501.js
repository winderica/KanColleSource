const function1501 = function (t, e, i) {
    ...
    var o = i(4), r = i(36), s = i(1502), a = function (t) {
        function e() {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "extra_result", {
            ...
            this.removeChildren(), this._line_v = null, this._line_h = null, this._bonus_label = null, this._exp_label = null, this._exp_text = null;
            for (var t = 0, e = this._exp_ships; t < e.length; t++) {
                e[t].dispose()
            }
            this._exp_ships = null
        }, e
    }(PIXI.Container);
    e.PanelExp = a;
    var _ = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function (t) {
            ...
            this.removeChildren(), this._plus = null, this._exp = null, this._text = null
        }, e
    }(PIXI.Container)
}