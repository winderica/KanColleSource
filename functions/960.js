const function960 = function (t, e, i) {
    ...
    var a = function (t) {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "type", {
            ...
            this._update(!1), this._label.texture = this._getTextureLabel(), this._circle.texture = o.SALLY_EVENT.getTexture(56)
            ...
            return 4 == this._type ? o.SALLY_EVENT.getTexture(55) : 3 == this._type ? o.SALLY_EVENT.getTexture(59) : 2 == this._type ? o.SALLY_EVENT.getTexture(52) : 1 == this._type ? o.SALLY_EVENT.getTexture(62) : PIXI.Texture.EMPTY
        ...
        return n(e, t), e.prototype.initialize = function (t) {
            ...
            1 == t ? (this._stoptAnim(), 0 == this._selected_type ? this.texture = o.SALLY_EVENT.getTexture(43) : this.texture = o.SALLY_EVENT.getTexture(49)) : 0 == this._selected_type ? (this.texture = o.SALLY_EVENT.getTexture(42), this._startAnim()) : this.texture = o.SALLY_EVENT.getTexture(48)
        }, e.prototype._startAnim = function () {
            null == this._t && (this.alpha = 1, this._t = createjs.Tween.get(this, { loop: !0 }).to({ alpha: .5 }, 700).wait(100).to({ alpha: 1 }, 700).wait(800))
