const function960 = function (t, e, i) {
    ...
    var o = i(5), r = i(0), s = i(17), a = i(1), _ = i(2), l = i(23), u = i(8), c = i(4), h = i(22), p = i(67),
        d = i(6), f = i(9), y = i(26), m = i(961), v = function (t) {
            function e(e, i, n) {
            ...
            return n(e, t), e.prototype._start = function () {
                this._bg = new u.AreaBox(.6), this._layer.addChild(this._bg), this._dialog = new g(this._onSelect), this._dialog.initialize();
                ...
                i.position.set(-i.width / 2, -i.height / 2), e.addChild(i), createjs.Tween.get(e).to({
                    ...
                    scaleX: 2.8,
                    scaleY: 2.8
                }, 300), this._white = new u.AreaBox(1, 16777215), this._white.alpha = 0, this._layer.addChild(this._white), createjs.Tween.get(this._white).wait(200).to({ alpha: 1 }, 450).call(function () {
