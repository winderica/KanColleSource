    ...
    var o = i(5),
        ...
        y = function (t) {
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                if (null == t) {
                    ...
                    o.add(n, "item_up"), o.load(function () {
                        var i = new PIXI.Container,
                            o = new PIXI.Sprite(d.BATTLE_MAIN.getTexture(31));
                        o.anchor.set(.5, 0);
                ...
                var i, n = this,
                    o = this._record.raw.sakuteki;
                i = 1 == o.isSuccess_f() ? 1 == o.hasMikikan_f() ? 2 : 1 : 1 == o.hasMikikan_f() ? 4 : 3;
                var r = this._scene.view.raderLayer,
                    s = r.rader_e;
                ...
                for (var t = null, e = 0, i = this._scene.data.model.deck_f.ships, n = 0; n < i.length; n++) {
                    var o = i[n];
                    if (null != o)
                        for (var r = 0; r < o.slots.length; r++) {
                            var s = o.slots[r];
                            if (null != s) {
                                var _ = s.equipType;
