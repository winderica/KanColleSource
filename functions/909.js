const function909 = function (t, e, i) {
    "use strict";
    ...
    var a = function (t) {
        function e() {
            ...
            for (var i = new PIXI.Sprite(o.COMMON_SORT.getTexture(53)), n = [[0, 21, 22], [1, 23, 24], [2, 25, 26], [3, 27, 28], [4, 29, 30], [5, 31, 32], [6, 33, 34], [7, 35, 36], [8, 43, 44], [9, 45, 46], [10, 47, 48], [11, 49, 50], [12, 37, 38], [13, 39, 40], [14, 41, 42]], r = [], s = 0; s < n.length; s++) {
                var a = n[s], l = a[0], u = a[1], c = a[2], h = new _(l, u, c);
    ...
    var l = function (t) {
        function e() {
            ...
            var i = new PIXI.Sprite(o.COMMON_SORT.getTexture(19)), n = new PIXI.Sprite(o.COMMON_SORT.getTexture(2));
