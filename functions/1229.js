    ...
    var o = i(120),
        r = function (t) {
            ...
            return n(e, t), e.prototype.initialize = function () {
                this.texture = o.DUTY_COMMON.getTexture(41), this._star1.texture = o.DUTY_COMMON.getTexture(44), this._star2.texture = o.DUTY_COMMON.getTexture(43)
                ...
                var t = this;
                this._stopTween(), this.texture = o.DUTY_COMMON.getTexture(42), this._t = createjs.Tween.get(null).wait(150).call(function () {
                    t.texture = o.DUTY_COMMON.getTexture(41)
                }).wait(150).call(function () {
                    t.texture = o.DUTY_COMMON.getTexture(42)
                }).wait(150).call(function () {
                    t._star1.visible = !0, t.texture = o.DUTY_COMMON.getTexture(41)
                ...
                null != this._t && (this._t.setPaused(!0), this._t = null, this.texture = o.DUTY_COMMON.getTexture(41), this._star1.visible = !1, this._star2.visible = !1)
            }, e
        }(PIXI.Sprite);
    e.MiniChara = r
}