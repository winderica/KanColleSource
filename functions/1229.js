const function1229 = function (t, e, i) {
    ...
    var a = function (t) {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "type", {
            ...
            return o.DUTY_MAIN.getTexture(t)
        }, e.prototype._getTextureOn = function () {
            var t;
            if (0 == this._type) t = 22;
            else if (1 == this._type) t = 26;
            else if (2 == this._type) t = 28;
            else if (3 == this._type) t = 30;
            else if (4 == this._type) t = 32;
            else if (5 == this._type) t = 34;
            else {
                if (9 != this._type) return PIXI.Texture.EMPTY;
                t = 24
            }
