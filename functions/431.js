    ...
    var o = i(5),
        ...
        l = function (t) {
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                var t = this,
                    e = new r.TweenTask;
                e.addTweens([createjs.Tween.get(this._bg.scale).to({
                    y: 1
                }, 200), createjs.Tween.get(this._light).to({
                    x: 0
                }, 400).wait(150).to({
                    y: o.default.height / 2 + 8
                }, 50).to({
                    y: o.default.height / 2 - 5
                }, 50).to({
                    y: o.default.height / 2
                }, 50), createjs.Tween.get(this._text1).wait(400).to({
                    alpha: 1,
                    scaleX: 1,
                    scaleY: 1
                    ...
                    createjs.Tween.get(t._canvas).to({
                        alpha: 0
                    }, 200).call(function () {
                        t._endTask()
                    })
