const function611 = function (t, e, i) {
    ...
    var o = i(80),
        ...
        d = function (t) {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "username", {
                ...
                enumerable: !0,
                configurable: !0
            }), Object.defineProperty(e.prototype, "friendlyBtn", {
                get: function () {
                    return this._btn_friend
                },
                enumerable: !0,
                configurable: !0
            }), e.prototype.changeSkin = function (t) {
                this._bg.changeSkin(t), 101 == t ? (this._userlevel.position.set(600, 13), this._userrank.position.set(651, 14), this._fleetnum.visible = !0, this._shipnum.position.set(999, 13), this._slotnum.visible = !1, this._repairKit.position.set(1094, 14), this._devKit.position.set(1194, 14), this._revKit.visible = !1) : 311 == t ? (this._userlevel.position.set(477, 13), this._userrank.position.set(528, 14), this._fleetnum.visible = !1, this._shipnum.position.set(720, 13), this._slotnum.visible = !0, this._slotnum.position.set(890, 13), this._repairKit.position.set(987, 14), this._devKit.position.set(1098, 14), this._revKit.visible = !0, this._revKit.position.set(1194, 14)) : (this._userlevel.position.set(551, 13), this._userrank.position.set(602, 14), this._fleetnum.visible = !1, this._shipnum.position.set(780, 13), this._slotnum.visible = !0, this._slotnum.position.set(887, 13), this._repairKit.position.set(987, 14), this._devKit.position.set(1098, 14), this._revKit.visible = !0, this._revKit.position.set(1194, 14)), 101 == t || 102 == t ? (this._gear.position.set(68, 60), this._btn_friend.position.set(300, 43)) : 201 == t ? (this._gear.position.set(66, 58), this._btn_friend.position.set(300, 44)) : 301 != t && 311 != t || (this._gear.position.set(67, 60), this._btn_friend.position.set(300, 45));
                var e = PIXI.Texture.EMPTY;
                101 == t || 102 == t ? (e = a.PORT_SKIN_1.getTexture(2), this._btn_record.initialize(a.PORT_SKIN_1.getTexture(37), a.PORT_SKIN_1.getTexture(38), null), p.FRIENDLY ? this._btn_friend.initialize(a.PORT_SKIN_1.getTexture(39), a.PORT_SKIN_1.getTexture(40), null, a.PORT_SKIN_1.getTexture(41)) : this._btn_friend.initialize(a.PORT_SKIN_1.getTexture(42), a.PORT_SKIN_1.getTexture(43), null), this._btn_album.initialize(a.PORT_SKIN_1.getTexture(44), a.PORT_SKIN_1.getTexture(45), null), this._btn_item.initialize(a.PORT_SKIN_1.getTexture(30), a.PORT_SKIN_1.getTexture(31), null), this._btn_interior.initialize(a.PORT_SKIN_1.getTexture(32), a.PORT_SKIN_1.getTexture(33), null), this._btn_duty.initialize(a.PORT_SKIN_1.getTexture(34), a.PORT_SKIN_1.getTexture(35), a.PORT_SKIN_1.getTexture(36)), this._btn_shop.initialize(a.PORT_SKIN_1.getTexture(22), a.PORT_SKIN_1.getTexture(23), null)) : 201 == t ? (e = _.PORT_SKIN_2.getTexture(1), this._btn_record.initialize(_.PORT_SKIN_2.getTexture(26), _.PORT_SKIN_2.getTexture(27), null), p.FRIENDLY ? this._btn_friend.initialize(_.PORT_SKIN_2.getTexture(28), _.PORT_SKIN_2.getTexture(29), null, _.PORT_SKIN_2.getTexture(30)) : this._btn_friend.initialize(_.PORT_SKIN_2.getTexture(31), _.PORT_SKIN_2.getTexture(32), null), this._btn_album.initialize(_.PORT_SKIN_2.getTexture(33), _.PORT_SKIN_2.getTexture(34), null), this._btn_item.initialize(_.PORT_SKIN_2.getTexture(19), _.PORT_SKIN_2.getTexture(20), null), this._btn_interior.initialize(_.PORT_SKIN_2.getTexture(21), _.PORT_SKIN_2.getTexture(22), null), this._btn_duty.initialize(_.PORT_SKIN_2.getTexture(23), _.PORT_SKIN_2.getTexture(24), _.PORT_SKIN_2.getTexture(25)), this._btn_shop.initialize(_.PORT_SKIN_2.getTexture(14), _.PORT_SKIN_2.getTexture(15), null)) : 301 == t ? (e = l.PORT_SKIN_3.getTexture(1), this._btn_record.initialize(l.PORT_SKIN_3.getTexture(26), l.PORT_SKIN_3.getTexture(27), null), p.FRIENDLY ? this._btn_friend.initialize(l.PORT_SKIN_3.getTexture(28), l.PORT_SKIN_3.getTexture(29), null, l.PORT_SKIN_3.getTexture(30)) : this._btn_friend.initialize(l.PORT_SKIN_3.getTexture(31), l.PORT_SKIN_3.getTexture(32), null), this._btn_album.initialize(l.PORT_SKIN_3.getTexture(33), l.PORT_SKIN_3.getTexture(34), null), this._btn_item.initialize(l.PORT_SKIN_3.getTexture(19), l.PORT_SKIN_3.getTexture(20), null), this._btn_interior.initialize(l.PORT_SKIN_3.getTexture(21), l.PORT_SKIN_3.getTexture(22), null), this._btn_duty.initialize(l.PORT_SKIN_3.getTexture(23), l.PORT_SKIN_3.getTexture(24), l.PORT_SKIN_3.getTexture(25)), this._btn_shop.initialize(l.PORT_SKIN_3.getTexture(14), l.PORT_SKIN_3.getTexture(15), null)) : 311 == t && (e = u.PORT_SKIN_3K.getTexture(3), this._btn_record.initialize(u.PORT_SKIN_3K.getTexture(42), u.PORT_SKIN_3K.getTexture(43), null), p.FRIENDLY ? this._btn_friend.initialize(u.PORT_SKIN_3K.getTexture(44), u.PORT_SKIN_3K.getTexture(46), null, u.PORT_SKIN_3K.getTexture(48)) : this._btn_friend.initialize(u.PORT_SKIN_3K.getTexture(45), u.PORT_SKIN_3K.getTexture(47), null), this._btn_album.initialize(u.PORT_SKIN_3K.getTexture(49), u.PORT_SKIN_3K.getTexture(50), null), this._btn_item.initialize(u.PORT_SKIN_3K.getTexture(35), u.PORT_SKIN_3K.getTexture(36), null), this._btn_interior.initialize(u.PORT_SKIN_3K.getTexture(37), u.PORT_SKIN_3K.getTexture(38), null), this._btn_duty.initialize(u.PORT_SKIN_3K.getTexture(39), u.PORT_SKIN_3K.getTexture(40), u.PORT_SKIN_3K.getTexture(41)), this._btn_shop.initialize(u.PORT_SKIN_3K.getTexture(30), u.PORT_SKIN_3K.getTexture(31), null)), 301 == t || 311 == t ? (this._username.style.fill = 4999235, this._userlevel.style.fill = 4999235, this._userrank.style.fill = 4999235, this._fuel.style.fill = 4999235, this._ammo.style.fill = 4999235, this._steel.style.fill = 4999235, this._baux.style.fill = 4999235, this._repairKit.style.fill = 4999235, this._devKit.style.fill = 4999235, this._revKit.style.fill = 4999235, this._shipnum.updateDefaultColor(4999235), this._slotnum.updateDefaultColor(4999235)) : (this._username.style.fill = 16774898, this._userlevel.style.fill = 16774898, this._userrank.style.fill = 16774898, this._fuel.style.fill = 16774898, this._ammo.style.fill = 16774898, this._steel.style.fill = 16774898, this._baux.style.fill = 16774898, this._repairKit.style.fill = 16774898, this._devKit.style.fill = 16774898, this._revKit.style.fill = 16774898, this._shipnum.updateDefaultColor(16774898), this._slotnum.updateDefaultColor(16774898)), this._gear.setUp(e)
    ...
    var f = function (t) {
            ...
            return n(e, t), e.prototype.changeSkin = function (t) {
                ...
                this.texture = l.PORT_SKIN_3.getTexture(6), this._createSprite(l.PORT_SKIN_3.getTexture(16), 413, 16), this._createSprite(l.PORT_SKIN_3.getTexture(17), 698, 18), this._createSprite(l.PORT_SKIN_3.getTexture(18), 791, 18), this._createSprite(l.PORT_SKIN_3.getTexture(11), 904, 17), this._createSprite(l.PORT_SKIN_3.getTexture(12), 1003, 17), this._createSprite(l.PORT_SKIN_3.getTexture(13), 1105, 16), this._createSprite(l.PORT_SKIN_3.getTexture(7), 991, 51), this._createSprite(l.PORT_SKIN_3.getTexture(8), 988, 79), this._createSprite(l.PORT_SKIN_3.getTexture(9), 1095, 52), this._createSprite(l.PORT_SKIN_3.getTexture(10), 1096, 78), this._createSprite(l.PORT_SKIN_3.getTexture(4), 415, 0)
            }, e.prototype._setUpForSkin3K = function (t) {
                this.texture = u.PORT_SKIN_3K.getTexture(22), this._createSprite(u.PORT_SKIN_3K.getTexture(32), 409, 20), this._createSprite(u.PORT_SKIN_3K.getTexture(33), 629, 21), this._createSprite(u.PORT_SKIN_3K.getTexture(34), 737, 21), this._createSprite(u.PORT_SKIN_3K.getTexture(27), 904, 17), this._createSprite(u.PORT_SKIN_3K.getTexture(28), 1003, 17), this._createSprite(u.PORT_SKIN_3K.getTexture(29), 1105, 16), this._createSprite(u.PORT_SKIN_3K.getTexture(23), 991, 51), this._createSprite(u.PORT_SKIN_3K.getTexture(24), 988, 79), this._createSprite(u.PORT_SKIN_3K.getTexture(25), 1095, 52), this._createSprite(u.PORT_SKIN_3K.getTexture(26), 1096, 78), this._createSprite(u.PORT_SKIN_3K.getTexture(20), 415, 0)
