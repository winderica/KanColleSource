const function875 = function (t, e, i) {
    ...
    var o, r = i(0), s = i(1), a = i(49), _ = i(8), u = i(115), l = i(4), c = i(20), h = i(35), p = i(86),
        d = i(876);
    !function (t) {
    ...
    var f = function (t) {
        function e(e) {
            ...
            var g = new PIXI.Sprite(c.COMMON_MAIN.getTexture(60));
            g.position.set(0, -37);
            ...
            var b = new l.TextBox(24, 5523516);
            b.anchor.x = 1, b.position.set(591, 438), i.addChild(b);
            var w = new l.TextBox(24, 12467003);
            return w.position.set(619, 438), i.addChild(w), i.addChild(i.btn_kenzou), i._btnToNormal = new PIXI.Sprite(h.ARSENAL_MAIN.getTexture(37)), i._btnToNormal.interactive = !0, i._btnToNormal.buttonMode = !0, i._btnToNormal.position.set(60, 492), i.addChild(i._btnToNormal), i.addChild(g), i.position.set(1200, 139), g.addChild(m), i.dialogBackground = new _.AreaBox(a.UISettings.DIALOG_BG_ALPHA), i.mainView.addChild(i.dialogBackground), i.mainView.addChild(i), i._btnToNormal.on(s.EventType.CLICK, i._onClickNormal), i.dialogBackground.on(s.EventType.CLICK, i._onClickBack), i
        }
        ...
        return n(e, t), Object.defineProperty(e.prototype, "fuel", {
            ...
            this._btnToNormal.off(s.EventType.CLICK, this._onClickNormal), this.dialogBackground.off(s.EventType.CLICK, this._onClickBack), this.mainView.removeChild(this.dialogBackground), this.mainView.removeChild(this), this.configureMaterialView_fuel.dispose(), this.configureMaterialView_ammo.dispose(), this.configureMaterialView_steel.dispose(), this.configureMaterialView_bauxite.dispose(), this._devKitSwitch.dispose(), this._buildKitSwitch.dispose(), this.btn_kenzou.dispose(), this.configureMaterialView_fuel = null, this.configureMaterialView_ammo = null, this.configureMaterialView_steel = null, this.configureMaterialView_bauxite = null, this.btn_kenzou = null, this.removeChildren(), this.onComplete = null, this.mainView = null, this.dialogBackground = null
