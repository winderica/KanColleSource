const function1158 = function (t, e, i) {
    "use strict";
    ...
    var o = i(0), r = i(407), s = function (t) {
        function e(e) {
        ...
        return n(e, t), e.prototype._statusUpdate506 = function () {
            var t = this._getRawProgress(), e = this._getUnsetSlotCount(145);
            if (t >= 3 && e.all >= 3) {
            ...
            if (0 != this._getRawProgress()) {
                var t = this._getUnsetSlotCount(37), e = this._getUnsetSlotCount(19), i = t.all >= 2 && e.all >= 1,
            ...
            var t = this._getUnsetSlotCount(37), e = this._getUnsetSlotCount(23), i = t.all >= 2 && e.all >= 2,
            ...
            if (0 != this._getRawProgress()) {
                var t = this._getUnsetSlotCount(16), e = this._getUnsetSlotCount(168), i = t.all >= 2 && e.all >= 1,
                    n = t.unlocked >= 2 && e.unlocked >= 1;
                if (1 == i) {
                    var o = this._getRawStatus();
                    2 == o ? (this._updateTassei(), 0 == n && (this._alert = 4)) : 1 == o && this._updateProgress(2)
            ...
            var t = this._getUnsetSlotCount(17), e = this._getUnsetSlotCount(169), i = t.all >= 2 && e.all >= 1,
                n = t.unlocked >= 2 && e.unlocked >= 1;
            if (1 == i) {
                var o = this._getRawStatus();
                2 == o ? (this._updateTassei(), 0 == n && (this._alert = 4)) : 1 == o && this._updateProgress(2)
            ...
            var t = this._getRawProgress(), e = o.default.model.useItem.getCount(31),
                i = o.default.model.useItem.getCount(32), n = e >= 750 && i >= 750, r = new a;
            ...
            var t = this._getRawProgress(), e = o.default.model.useItem.getCount(44), i = e >= 5e3, n = new a;
            ...
            var t = this._getRawProgress(), e = o.default.model.useItem.getCount(31),
                i = o.default.model.useItem.getCount(34), n = e >= 1200 && i >= 3e3,
                r = o.default.model.useItem.getCount(73), s = r >= 1;
            if (2 == t && 1 == n && 1 == s) {
            ...
            var t = this._getRawProgress(), e = this._getUnsetSlotCount(169), i = this._getUnsetSlotCount(54),
                n = e.all >= 1 && i.all >= 2, o = e.unlocked >= 1 && i.unlocked >= 2;
            if (2 == t && 1 == n) {
                var r = this._getRawStatus();
            ...
            var t = this._getRawProgress(), e = o.default.model.useItem.getCount(74),
                i = o.default.model.useItem.getCount(71), n = e >= 2 && i >= 1;
            if (2 == t && 1 == n) {
                var r = this._getRawStatus();
            ...
            var t = this._getRawProgress(), e = o.default.model.useItem.getCount(33),
                i = this._getUnsetSlotCount(18), n = this._getUnsetSlotCount(22),
                r = i.all >= 2 && n.all >= 2 && e >= 8e3, s = i.unlocked >= 2 && n.unlocked >= 2 && e >= 8e3;
            if (2 == t && 1 == r) {
                var a = this._getRawStatus();
            ...
            var t = this._getRawProgress(), e = o.default.model.useItem.getCount(3), i = e >= 10,
                n = this._getUnsetSlotCount(16), r = n.all >= 1, s = n.unlocked >= 1;
            if (2 == t && 1 == i && 1 == r) {
                var a = this._getRawStatus();
                2 == a ? (this._updateTassei(), 0 == s && (this._alert = 4)) : 1 == a && this._updateProgress(2)
            } else 2 == t && 1 == i ? this._updateProgress(1) : this._updateProgress(0)
        }, e.prototype._statusUpdate655 = function () {
            var t = this._getRawProgress(), e = o.default.model.useItem.getCount(3), i = e >= 20,
                n = this._getUnsetSlotCount(54), r = n.all >= 1, s = n.unlocked >= 1;
            if (2 == t && 1 == i && 1 == r) {
                var a = this._getRawStatus();
                2 == a ? (this._updateTassei(), 0 == s && (this._alert = 4)) : 1 == a && this._updateProgress(2)
            } else 2 == t && 1 == i ? this._updateProgress(1) : this._updateProgress(0)
            ...
            var t = this._getRawProgress(), e = o.default.model.useItem.getCount(3), i = e >= 120, n = new a;
            if (n.add(15, 2), n.add(46, 2), 2 == t && 1 == i && 1 == n.isFulfill()) {
                var r = this._getRawStatus();
                2 == r ? (this._updateTassei(), 0 == n.isFulfillUnlocked() && (this._alert = 4)) : 1 == r && this._updateProgress(2)
            } else 2 == t && 1 == i && n.fulfill_count > 0 ? this._updateProgress(2) : 1 == t && 1 == i && n.fulfill_count > 0 ? this._updateProgress(1) : this._updateProgress(0)
        }, e.prototype._statusUpdate666 = function () {
            var t = this._getRawProgress(), e = new a;
            e.add(23, 2), e.add(26, 2);
            var i = o.default.model.useItem.getCount(70), n = i >= 1;
            if (1 == t) if (1 == e.isFulfill()) if (1 == n) {
                var r = this._getRawStatus();
                2 == r ? (this._updateTassei(), 0 == e.isFulfillUnlocked() && (this._alert = 4)) : this._updateProgress(2)
            } else this._updateProgress(2); else this._updateProgress(1); else this._updateProgress(0)
        }, e.prototype._statusUpdate668 = function () {
            var t = this._getUnsetSlotCount(145), e = o.default.model.useItem.get(31).count,
                i = o.default.model.useItem.get(34).count, n = e >= 800 && i >= 150;
            if (1 == n && t.all >= 2) {
