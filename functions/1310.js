const function1310 = function (t, e, i) {
    ...
    var o = i(0), r = i(4), s = i(34), a = i(245), _ = i(30), l = i(20), u = i(441), c = function (t) {
        function e(e, i) {
        ...
        return n(e, t), e.prototype.initialize = function () {
            this._taihi.initialize(), this._taihisezu.initialize(), this._txt1.texture = l.MAP_COMMON.getTexture(155), this._txt2.texture = l.MAP_COMMON.getTexture(156), this._txt3.texture = l.MAP_COMMON.getTexture(157), this._title.initialize(!1), this._title.update(l.MAP_COMMON.getTexture(103)), this._title.activate()
        }, e.prototype.updateTargetShipBanner = function (t, e, i, n, r) {
            var s = "", a = o.default.model.ship.getMst(t);
            null != a && (s = a.name);
            var l = _.ShipUtil.isDamaged(n, r), u = _.ShipUtil.getDamageType(n, r);
