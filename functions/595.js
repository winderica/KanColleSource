const function595 = function (t, e, i) {
    ...
    var o = function (t) {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "fileName", {
            ...
            this._frame_index = 0, this._frameCount = 0, this._loopCount = 0, this._end = !1, this._updateTexture(!0), this._updateAlpha(), this._updateFrameMax()
            ...
            void 0 === t && (t = !1);
            var e = this._model.frames[this._frame_index];
            (t || this._fileName != e.filename) && (this._fileName = e.filename, "" == this._fileName ? this.texture = PIXI.Texture.EMPTY : this.texture = this._getTextureByName(this._fileName))
