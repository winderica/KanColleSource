const function1344 = function (t, e, i) {
    "use strict";
    ...
    var o = i(0),
        ...
        c = function (t) {
            ...
            return n(e, t), e.prototype.initialize = function () {
                this._taihi.initialize(), this._taihisezu.initialize(), this._txt1.texture = l.MAP_COMMON.getTexture(171), this._txt2.texture = l.MAP_COMMON.getTexture(172), this._txt3.texture = l.MAP_COMMON.getTexture(173), this._title.initialize(!1), this._title.update(l.MAP_COMMON.getTexture(113)), this._title.activate()
