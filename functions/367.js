const function367 = function (t, e, i) {
    ...
    var o = i(4), r = i(30), s = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function () {
            var t = new PIXI.Sprite(r.SALLY_COMMON.getTexture(46)),
                e = new PIXI.Sprite(r.SALLY_COMMON.getTexture(47)),
                i = new PIXI.Sprite(r.SALLY_COMMON.getTexture(47)),
                n = new PIXI.Sprite(r.SALLY_COMMON.getTexture(48)),
                o = new PIXI.Sprite(r.SALLY_COMMON.getTexture(41));
