const function754 = function (t, e, i) {
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 });
    var n = i(0), o = i(34), r = i(31), s = i(20), a = i(9), _ = i(68), u = i(334), l = i(217), c = i(335),
        h = i(755), p = i(756), d = i(757), f = i(84), y = i(758), v = i(759), g = i(760), m = i(761), b = i(85),
        w = i(51), x = i(160), I = i(772), T = i(783), O = i(801), P = i(812), C = i(818), k = i(161), M = i(6),
        S = i(821), A = i(822), j = i(111), E = i(109), L = i(823), N = i(8), B = function () {
            function t(t) {
                var e = this;
                this._onClickExtension = function () {
                    e.taskExtension = new C.TaskExtension(n.default.view.overLayer);
                    var t = function () {
                    ...
                    var t = function () {
                        switch (e._updateShipDetail_(e.memShipId), e.deckId) {
                            case null:
                                var t = 0, i = n.default.model.ship.getAllOther();
                    ...
                    var t = function () {
                        var t = n.default.model.deck.getIDs(), i = n.default.model.ship.getAllOther();
                        if (r.ShipUtil.sort(i, 1), e._updateOtherShipSource_(i), e._updateDeckSelector_(t, i.length), e._updateShipDetail_(e.memShipId), i = i.reverse(), null == e.deckId) {
                            ...
                            e._updateShipSlot_(e.deckId, e.shipInDeckOrigin);
                            var s = n.default.model.deck.get(e.deckId), a = s.isInDeck(e.memShipId),
                    ...
                    }, n = k.SceneMemory.slotItemFilter, o = k.SceneMemory.slotItemPage, r = k.SceneMemory.listMode;
                    ...
                    var t = e.memShipId, i = new o.APIConnector, r = new c.SlotSetExAPI(t, -1), s = new l.Ship3API(t),
                        a = function () {
                    ...
                    var t = e.memShipId, i = new o.APIConnector, r = new h.UnsetSlotAll(t), s = new l.Ship3API(t),
                        a = function () {
                            n.default.view.clickGuard = !1, e._updateShipDetail_(t)
                        };
                    M.SE.play("106"), n.default.view.clickGuard = !0, i.add(r).add(s), i.start(a)
                }, this._onClickDetach = function (t) {
                    var i = e.memShipId, r = new u.SlotSetAPI(i, -1, t), s = new l.Ship3API(i), a = new o.APIConnector;
                    M.SE.play("106");
                    var _ = function () {
                        n.default.view.clickGuard = !1, e._updateShipDetail_(i)
                    };
                    n.default.view.clickGuard = !0, a.add(r).add(s), a.start(_)
                }, this._onMouseDownSlot = function (t, i) {
                    var o = e.memShipId, r = n.default.model.ship.get(o), s = r.getSlotitems(),
                    ...
                    if (!r.isRepair() && (0 != s.length && null != s[t])) {
                        var _ = { x: e.shipDetail.x + e.slotItemSlotBox.x, y: e.shipDetail.y + e.slotItemSlotBox.y };
                    ...
                    n.default.view.overLayer.removeChild(e._slotDragging)
                }, this._onMouseUp = function (t) {
                    var i = e.memShipId;
                    if (null != n.default.model.ship.get(i).getSlotitems()[t]) {
                        if (0 == e._slotDragging.isClick()) return;
                        e._removeSlotDraggingLayer()
                    }
                    ...
                    n.default.view.overLayer.addChild(i), (new o.APIConnector).add(new u.SlotSetAPI(e.memShipId, -1, t)).add(new l.Ship3API(e.memShipId)).start(function () {
                        e._updateShipDetail_(e.memShipId), n.default.view.overLayer.removeChild(i)
                    })
                    ...
                    t--;
                    var i = n.default.model.deck.get(e.deckId), o = i.isInDeck(e.memShipId), r = o - t;
                ...
                for (var i = [[0, 0], [0, 81], [0, 162], [0, 243], [0, 324], [0, 405]], b = {
                    x: 206,
                    y: 222
                }, B = 0; B < i.length; B++) {
                ...
                this.deckCraneFrame = new y.DeckCraneFrame, this.otherBackground = new PIXI.Sprite(s.COMMON_MAIN.getTexture(12)), this.miniPager = new v.MiniPager, this.otherShipList = new g.OtherShipList(10), this.otherShipFrame = new y.OtherShipFrame, this.arrowTopButton = new j.ArrowTopButton, this.arrowBottomButton = new j.ArrowBottomButton, n.default.model.deck.isCombined() && (this.combinedView = new E.CombinedView, this.combinedView.position.set(0, 0)), n.default.model.deck.exist3rdUnit && (this.icon3rdUnit = new PIXI.Sprite(a.COMMON_MISC.getTexture(181))), this.shipDetail = new m.ShipDetail, this.shipDetailEmpty = new m.ShipDetailEmpty, this.kaizoButton = this.shipDetail.kaizoButton, this.kindaikaButton = this.shipDetail.kindaikaButton, this.slotItemSlotBox = this.shipDetail.slotItemSlotBox, this.extraSlotItemSlot = this.shipDetail.extraSlotItemSlot, this.shipCard = this.shipDetail.shipCard, this.detachAllButton = this.shipDetail.detachAllButton, this.shipParameter = this.shipDetail.shipParameter, this.extensionButton = this.shipDetail.extensionButton, this.marriageButton = this.shipDetail.marriageButton, this.kindaikaButton.onClick = this._onClickKindaika, this.kaizoButton.onClick = this._onClickKaizoButton, this.extraSlotItemSlot.onClick = this._onClickExtraSlot, this.extraSlotItemSlot.onClickDetach = this._onClickDetachExtraSlot, this.detachAllButton.onClick = this._onClickDetachAll, this.slotItemSlotBox.mousedown = this._onMouseDownSlot, this.slotItemSlotBox.onMouseUp = this._onMouseUp, this.slotItemSlotBox.onClickDetach = this._onClickDetach, this.extensionButton.onClick = this._onClickExtension, this.marriageButton.onClick = this._onClickMarriage, this.deckSelectView.onClickDeck = this._onClickDeckTab, this.deckSelectView.onClickOther = this._onClickOtherTab;
            ...
            return t.prototype.dispose = function () {
                ...
                var i = n.default.model.deck.getIDs(), o = n.default.model.ship.getAllOther();
                ...
                var e = n.default.model.ship.get(t), i = n.default.model.ship.getMst(e.mstID),
                    o = r.ShipUtil.isMaxGradeUp(e, i, !1), s = r.ShipUtil.isMaxGradeUp(e, i, !0), a = !1,
                    _ = n.default.model.deck.isInDeck(e.memID);
                if (_) {
                    var u = _[0];
                    a = null != n.default.model.deck.get(u).expedition
                }
                var l = n.default.model.useItem.get(w.RemodelConst.REINFORCEMENT_WORK_ITEMID).count, c = e.isRepair(),
                    h = 0 == a && 0 == c, p = e.getSlotitems(), d = e.isExtraSlot(), f = e.getSlotitemEx(), y = e.level,
                    v = h && 0 == a && 0 == c && 0 == s;
                this.kindaikaButton.update(v);
                ...
                var m = p.length, x = 0 < m, I = 0 != p.indexOf(null), T = x && 0 == c && 0 == a, O = T && 0 == c && I;
                this._updateSlotItem_(e, p, O, T), this._updateDetachAllButton_(m, O)
                ...
                for (var o = 0; o < e.length; o++) {
                    var r = e[o], s = t.getSlotitemTousai(o);
