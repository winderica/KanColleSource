const function1462 = function (t, e, i) {
    ...
    var o = i(5), r = i(0), s = i(17), a = i(19), _ = i(27), l = i(2), u = i(1463), c = i(1464), h = i(1467),
        p = i(1473), d = i(1487), f = function (t) {
            function e(e) {
    ...
    var y = function (t) {
        ...
        return n(e, t), e.prototype._start = function () {
            ...
            var r = this._scene.data.battle_model, s = this._scene.view.layer_deck_info,
                l = r.ship_info.getFirstData(!1).getTotalHP(), u = r.ship_info.getLastData(!1).getTotalHP();
