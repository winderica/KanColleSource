const function1295 = function (t, e, i) {
    "use strict";
    ...
    var o = i(0),
        ...
        a = function (t) {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "content", {
                ...
                this._bg.texture = s.MAP_COMMON.getTexture(170), this._content.initialize(t), this._gearBtn.initialize()
            }, e
        }(PIXI.Container);
    e.MapEndView = a;
    var _ = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function (t) {
            if (this._title.texture = s.MAP_COMMON.getTexture(190), null != t)
