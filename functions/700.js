const function700 = function (t, e, i) {
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 });
    var n = i(0), o = i(8), r = i(701), s = function () {
        function t(t) {
            var e = this;
        ...
        return t.prototype.dispose = function () {
            ...
            var u = 0 < r && a, c = 0 < s, h = 0 < r && 0 < s;
            this.mainView.addChild(this.dialogBackground, this.sweetsSelectView), this.sweetsSelectView.update(u, c, h), this.dialogBackground.alpha = 0, n.default.view.clickGuard = !0, this.sweetsSelectView.visible = !1, createjs.Tween.get(this.dialogBackground).to({ alpha: 1 }, 125).call(function () {
