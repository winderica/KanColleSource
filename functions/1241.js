const function1241 = function (t, e, i) {
    ...
    var o = i(2), r = i(6), s = i(18), a = i(1242), _ = i(1), u = function (t) {
        function e(e, i) {
        ...
        return n(e, t), e.prototype._start = function () {
            ...
            var t = this, e = this._model.sortie.now_cell_no, i = this._scene.resInfo.getReplenishConfirmOffset(e),
            ...
            var e = this;
            this._confirm.deactivate(), createjs.Tween.get(this._confirm.btn_yes).to({ alpha: 0 }, 200), createjs.Tween.get(this._confirm.btn_no).to({ alpha: 0 }, 200);
            var i = this._confirm.y;
            createjs.Tween.get(this._confirm).wait(200).to({ y: i, alpha: 0 }, 300).call(function () {
            ...
            var e = [], i = this._model.deck_f.ships_main, n = this._model.deck_f.ships_sub,
                o = i.slice().reverse();
    ...
    var l = function (t) {
        function e(e, i) {
            ...
            }, n._cb_onSelect = i, n._box = new PIXI.Sprite, n._box.position.set(-120, -135), n.addChild(n._box), n._beak = new PIXI.Sprite, n._beak.position.set(30, -59), n.addChild(n._beak), null != e && (n._box.x += e.x, n._box.y += e.y, n._beak.x += e.x, n._beak.y += e.y), n._btn_yes = new c(n._onClickYes), n._btn_yes.position.set(-65, 42), n.addChild(n._btn_yes), n._btn_no = new c(n._onClickNo), n._btn_no.position.set(68, 42), n.addChild(n._btn_no), n
        }
        ...
        return n(e, t), Object.defineProperty(e.prototype, "btn_yes", {
            ...
            var t = s.MAP_COMMON.getTexture(96), e = s.MAP_COMMON.getTexture(97);
            this._btn_yes.initialize(t, e), t = s.MAP_COMMON.getTexture(82), e = s.MAP_COMMON.getTexture(83), this._btn_no.initialize(t, e)
