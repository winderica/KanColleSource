const function565 = function (t, e, i) {
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 });
    var n = i(0), o = i(22), r = i(7), s = i(77), a = i(566), _ = i(275), l = i(100), u = i(78), c = function () {
        function t() {
        ...
        return Object.defineProperty(t.prototype, "model", {
            ...
            if (n.default.model.furniture.isActive(t)) {
                var r = o.MathUtil.zeroPadding(t, 3), a = l.SuffixUtil.create(t, "furniture_scripts"),
            ...
            if (this.model.hasCategory("counterbar")) {
                ...
                this._model.__overwriteFileName__(u, "standard", 1, 0)
            } else if (this.model.hasCategory("umbrellarack")) for (var c = _.FurnitureUtil.getUmbrellarackTextures(s, l), h = 0; h < c.length; h++) this._model.__overwriteFileName__(c[h], "standard", h, 0);
            ...
            if (o) for (var s = 1e6 * e + i, a = o.length - 1; a >= 0; a--) {
                var _ = o[a], l = parseInt(r.ObjUtil.getString(_, "datetime"));
                if (!isNaN(l) && s >= l) return r.ObjUtil.getString(_, "state")
            }
            var u = r.ObjUtil.getObjectArray(n, "time");
            if (u) for (var a = u.length - 1; a >= 0; a--) {
                var _ = u[a], l = parseInt(r.ObjUtil.getString(_, "time"));
