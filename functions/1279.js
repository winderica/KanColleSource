const function1279 = function (t, e, i) {
    ...
    var o = i(0), r = i(41), s = i(18), a = function (t) {
        function e() {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "content", {
            ...
            this._bg.texture = s.MAP_COMMON.getTexture(141), this._content.initialize(t), this._gearBtn.initialize()
        }, e
    }(PIXI.Container);
    e.MapEndView = a;
    var _ = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function (t) {
            if (this._title.texture = s.MAP_COMMON.getTexture(160), null != t) for (var e = 0; e < t.length; e++) {
