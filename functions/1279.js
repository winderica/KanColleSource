const function1279 = function (t, e, i) {
    ...
    var m = function (t) {
            ...
            return n(e, t), e.prototype.initialize = function (t, e) {
                switch (t) {
                    case 1:
                        this._bg.texture = p.MAP_COMMON.getTexture(52);
                        break;
                    case 2:
                        this._bg.texture = p.MAP_COMMON.getTexture(56);
                        break;
                    case 3:
                        this._bg.texture = p.MAP_COMMON.getTexture(60);
                        break;
                    case 4:
                        this._bg.texture = p.MAP_COMMON.getTexture(64);
                        break;
                    default:
