const function838 = function (t, e, i) {
    ...
    var o = i(3), r = i(3), s = i(220), a = i(4), _ = i(32), u = i(23), l = i(111), c = i(1), h = i(13),
        p = function (t) {
            function e() {
                ...
                return E.mask = L, E.addChild(N, L), T.anchor.x = 1, O.anchor.x = 1, C.anchor.x = 1, i.interactive = !0, e.addChild(i, n, u, c, p, y, P, m, v, E, x, I, b, g, T, O, C, S, w, M, k), e.textName = N, e.textLevel = x, e.textHp = I, e.textSteel = T, e.textFuel = O, e.textAlert = P, e.hiSpeedToggle = g, e.startButton = m, e.textRequire = C, e.shipBanner = w, e.downArrowAnimationView = k, e.disableDownArrowAnimationView = M, e.hpGaugeView = b, e.headerContainer = S, e.containerName = E, e
            }
