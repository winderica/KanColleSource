const function838 = function (t, e, i) {
    ...
    var o = i(3), r = i(0), s = i(4), a = i(33), _ = i(22), u = i(1), l = function (t) {
        function e() {
            ...
            return S.name = "after", S.text = "9999", S.position.set(146, 7), e._labelArr.push(S), e._useRepairKitCount.addChild(S), y.position.set(297, 516), f.position.set(580, 516), y.addListener(u.EventType.CLICK, e._onClickNO), f.addListener(u.EventType.CLICK, e._onClickYES), y.interactive = y.buttonMode = !0, f.interactive = f.buttonMode = !0, e.addChild(i, l, c, h, p, d, x, g, b, v, e._useRepairKitTime, w, y, f, n, _, m, e._useRepairKitCount), e.textName = I, e.textSteelCount = g, e.textFuelCount = b, e.textUseOption = w, e.textRequireTime = v, e.buttonYes = f, e.buttonNo = y, e.shipBanner = m, e.containerName = x, e
        }
