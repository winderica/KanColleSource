const function933 = function (t, e, i) {
    ...
    var o = i(4), r = i(25), s = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function () {
            this._img[0].texture = r.SALLY_AIRUNIT.getTexture(107), this._img[1].texture = r.SALLY_AIRUNIT.getTexture(115), this._img[2].texture = r.SALLY_AIRUNIT.getTexture(108), this._img[3].texture = r.SALLY_AIRUNIT.getTexture(108)
