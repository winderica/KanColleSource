                ...
                e.itemMemory = {
                    ...
                    switch (t) {
                        ...
                        case c.Result.DEVELOP:
                            ...
                            var a = new u.CreateItemAPI(i, n, r, s, !1);
                        ...
                        case c.Result.MULTIPLE_DEV:
                            ...
                            var y = new u.CreateItemAPI(h, p, d, f, !0);
                    ...
                    o.default.view.overLayer.addChild(s), s.preload(function () {
                        if (i[n] > 0) {
                            var a = o.default.model.slot.getMst(i[n]),
                                u = "",
                                l = o.default.model.slot.getEquipTypeById(a.equipType);
                            u = l.needsDisplayName() ? "\u300c" + l.name + "\u3000" + a.name + "\u300d\u3092\u5165\u624b\u3057\u307e\u3057\u305f\uff01" : "\u300c" + a.name + "\u300d\u3092\u5165\u624b\u3057\u307e\u3057\u305f\uff01";
                            var c = new d.RewardAnimationMultiSlot(!1);
                            c.preload(i[n], u, a.rarity, function () {
                                s.play(function () {
                    ...
                    for (var i = "", n = 0, r = 0; r < t.length; r++)
                        if (!(t[r] <= 0)) {
                            var s = o.default.model.slot.getMst(t[r]),
                                ...
                                u = s.rarity;
                            n < u && (n = u), a.needsDisplayName() ? i += "\u300c" + a.name + "\u3000" + s.name + "\u300d" : i += "\u300c" + s.name + "\u300d", i += "\n"
                        } var l = new d.RewardAnimationMultiSlot(!0);
                    l.preMultiload(t, i, n, function () {
                        _.ArsenalUtil.playFlagshipVoice(26), o.default.view.overLayer.removeChild(e.multiple_bg), o.default.view.overLayer.addChild(l), l.play(function () {}, function () {
