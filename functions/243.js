const function243 = function (t, e, i) {
    ...
    var n = i(1208), o = function () {
        ...
        }), Object.defineProperty(t.prototype, "has_next_stage", {
            get: function () {
                return this._has_next_stage
            }, enumerable: !0, configurable: !0
        ...
        }, t.prototype.setMapGaugeInfo = function (t, e, i, n, o) {
            this._gauge_now = t, this._gauge_max = e, this._gauge_type = i, this._stage = n, this._has_next_stage = o
    ...
    var r = function () {
        ...
        return t.prototype.add = function (t, e) {
            ...
            if (null == this._list) return null;
            if (0 == this._list.length) return null;
            var e = this._list.length, i = this._list[e - 1];
            return t ? i.f : i.e
        }, t
    }()
}