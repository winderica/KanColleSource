    ...
    var o = i(0),
        ...
        _ = function (t) {
            ...
            return n(e, t), e.prototype.initialize = function (t) {
                ...
                var e = s.ITEM_ILIST_MEDAL.getTexture(2),
                    i = s.ITEM_ILIST_MEDAL.getTexture(3);
                ...
                this.removeChildren(), this._message.destroy(), this._btn_plan.dispose(), this._btn_mat.dispose(), this._btn_rev.dispose(), this._btn_back.dispose()
            }, e
        }(PIXI.Sprite);
    e.TopView = _
}