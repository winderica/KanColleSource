const function1245 = function (t, e, i) {
    ...
    var o = i(2), r = i(28), s = i(18), a = i(1246), _ = function (t) {
        function e(e, i, n) {
    ...
    var u = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function () {
            this._bg.texture = s.MAP_COMMON.getTexture(49), this._icon.texture = s.MAP_COMMON.getTexture(77), this._label.texture = s.MAP_COMMON.getTexture(155)
        }, e
    }(PIXI.Container)
}