const function921 = function (t, e, i) {
    "use strict";
    ...
    var o = i(5),
        ...
        y = function (t) {
            function e(e) {
                ...
                return i._clickGuard = new a.AreaBox(0), i._bg_itemlost = new PIXI.Sprite(h.COMMON_ANIMATION.getTexture(0)), i._penguin = new _.FailedPenguin, i._leafDashes = new d.LeafDashes, i._obj_leaf = new PIXI.Sprite(h.COMMON_ANIMATION.getTexture(1)), i._obj_leaf.anchor.set(.5, .5), i._messageBox = new u.MessageBox(!1), i._gearBtnHome = new l.GearBtnHome, i._gearBtnHome.initialize(), i._gearBtnHome.x = 1140, i._gearBtnHome.y = 660, i._white = new a.AreaBox(1, 16777215), i._leafTween = r.LeafAnimationUtil.LeafWithDashAnimation(i._obj_leaf, i._leafDashes.dashes, new PIXI.Point(0, 60)), i._leafTween.setPaused(!0), i._isLast = e, i
            }
