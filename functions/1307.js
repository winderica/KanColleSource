const function1307 = function (t, e, i) {
    ...
    var o = i(5), r = i(0), s = i(18), a = i(2), _ = i(14), u = i(1308), l = i(67), c = i(15), h = i(1309),
        p = i(1310), d = i(1311), f = i(1312), y = i(1313), v = i(1314), g = function (t) {
            function e(e) {
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                new u.TaskLoadResourcesBattle(r, o).start(function () {
                    t._showTextImage()
                })
            }, e.prototype._showTextImage = function () {
                var t = this, e = c.BATTLE_MAIN.getTexture(139);
                ...
                t = 1 == i.model.isPractice() ? new y.APIPracticeStart(i) : 1 == i.model.map_info.isNightStart() ? new f.APIBattleStartNight(i) : 1 == i.model.map_info.isAirBattle() ? new p.APIBattleStartAirBattle(i) : 1 == i.model.map_info.isAirRaid() ? new d.APIBattleStartAirRaid(i) : new h.APIBattleStart(this._scene.data), t.start(function () {
                    e._initData()
                })
                ...
                var t = this._scene.data.getFirstRecord(), e = t.common.getBossModels();
                if (null != e && e.length > 1) {
                    var i = this._scene.data.model.map_info.area_id, n = i == s.EVENT_AREA_ID,
                        o = this._scene.data.model.gauge_type;
                    if (n && 3 != o) {
                        var r = this._scene.data.model.deck_e.ships[0], a = this._scene.data.model.gauge_now,
                            _ = r.hp_now;
                        if (a > 0 && _ >= a) {
                ...
                var t = this, e = this._getBossModel();
                if (null != e) {
                    var i = this._scene.view.layer_cutin;
                    new v.TaskBossCutin(i, e).start(function () {
                        t._enterShips()
                    })
                } else {
                ...
                if (42 == n && 2 == o && a > 1 && 9 == s) return void this._endTask();
                if (42 == n && 3 == o && a > 1 && (13 == s || 21 == s)) return void this._endTask();
                if (42 == n && 4 == o && a > 1 && 12 == s) return void this._endTask();
                if (42 == n && 5 == o && a > 1 && (10 == s || 13 == s)) return void this._endTask();
                if (42 == n && 5 == o && a > 2 && 26 == s) return void this._endTask();
                var _ = l.GaugeSetModel.createKey(n, o, a), u = r.default.resources.gauge.createLoaderHorizontal();
                u.add(_), u.load(function () {
