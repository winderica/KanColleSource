const function1244 = function (t, e, i) {
    ...
    var o = i(55), r = i(2), s = i(1245), a = function (t) {
        function e(e, i, n) {
            void 0 === n && (n = 0);
        ...
        return n(e, t), e.prototype._start = function () {
            ...
            var n, r = this, a = this._model.sortie.area_id, _ = this._model.sortie.map_no,
                l = this._model.sortie.getNextCell().no, u = this._model.sortie.map.getGaugeNum();
            if (42 == a && 3 == _ && 25 == l && 3 == u) n = new s.MapEnemy(PIXI.Texture.fromFrame("map04203_icon_E3boss_2"), 5), n.x = 130, n.y = 230; else {
