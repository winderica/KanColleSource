const function626 = function (t, e, i) {
    ...
    var o = i(12), r = i(202), s = i(4), a = i(48), _ = i(6), u = i(9), l = function (t) {
        function e(e, i) {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "model", {
            ...
            var e = this.model.area_id, i = this.model.map_no;
            ...
            var t = this;
            createjs.Tween.get(this._dialog.bg).to({ scaleX: 1, scaleY: 1, alpha: 1 }, 200).call(function () {
                createjs.Tween.get(t._black).to({ alpha: 1 }, 200).call(function () {
                    t._showContent()
                })
            })
            ...
            this._removeChild(this._black), this._black = null, this._dialog.container.removeChild(this._img), this._img = null, this._particle.stopAnimation(), this._dialog.container.removeChild(this._particle), this._particle = null, this._dialog.container.removeChild(this._text), this._text = null
    ...
    var c = function (t) {
        ...
        function e() {
            ...
            return e._animation = function () {
                ...
                e._t1 = createjs.Tween.get(e._img).wait(t).to({ scaleX: 1, scaleY: 1 }, 100).to({
                    scaleX: 0,
                    scaleY: 0
                }, 200).call(e._animation), e._t2 = createjs.Tween.get(e).wait(t).to({ rotation: Math.random() * Math.PI / 5 }, 300)
