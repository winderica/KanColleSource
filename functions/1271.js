    ...
    var o = i(20),
        ...
        s = function (t) {
            ...
            return n(e, t), e.prototype.initialize = function (t, e, i) {
                switch (this._bg.texture = o.MAP_COMMON.getTexture(49), 2 == t ? (this._label1.texture = o.MAP_COMMON.getTexture(176), this._label1.position.set(20, -117), this._label2.texture = o.MAP_COMMON.getTexture(178), this._label2.position.set(20, -41)) : 1 == t ? (this._label1.texture = o.MAP_COMMON.getTexture(177), this._label1.position.set(24, -117), this._label2.texture = o.MAP_COMMON.getTexture(178), this._label2.position.set(20, -41)) : (this._label1.texture = o.MAP_COMMON.getTexture(179), this._label1.position.set(11, -86), this._label2.texture = PIXI.Texture.EMPTY), e) {
                    case 2:
