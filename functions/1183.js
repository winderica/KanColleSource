const function1183 = function (t, e, i) {
    ...
    var a = function (t) {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "type", {
            ...
            var t;
            if (0 == this._type) t = 20; else if (1 == this._type) t = 24; else if (2 == this._type) t = 26; else if (3 == this._type) t = 28; else if (4 == this._type) t = 30; else if (5 == this._type) t = 32; else {
            ...
            var t;
            if (0 == this._type) t = 21; else if (1 == this._type) t = 25; else if (2 == this._type) t = 27; else if (3 == this._type) t = 29; else if (4 == this._type) t = 31; else if (5 == this._type) t = 33; else {
                if (9 != this._type) return PIXI.Texture.EMPTY;
                t = 23
            }
            return o.DUTY_COMMON.getTexture(t)
