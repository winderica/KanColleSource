const function360 = function (t, e, i) {
    ...
    var o = i(0), r = i(2), s = i(324), a = i(8), _ = i(973), u = function (t) {
        function e(e, i, n) {
            ...
            var _ = o.default.model.useItem.getCount(31), u = o.default.model.useItem.getCount(32);
        ...
        return n(e, t), e.prototype._start = function () {
            ...
            var t = this;
            createjs.Tween.get(this._rader.scale).to({ x: 0, y: 0 }, 300, createjs.Ease.quadIn).call(function () {
            ...
            null != e && e.addChild(this._box), this._box.update(this._fuel, this._ammo), createjs.Tween.get(this._box).to({ alpha: 1 }, 500).call(function () {
            ...
            new s.ChargeAPI(e, i, !1).start(function () {
                createjs.Tween.get(t._box).to({ alpha: 0 }, 500).call(function () {
                    t._reShowRader()
                })
            })
