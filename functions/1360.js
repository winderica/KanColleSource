const function1360 = function (t, e, i) {
    ...
    var o = i(5), r = i(0), s = i(2), a = i(12), _ = i(6), u = i(173), l = function (t) {
        function e(e, i) {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "scene", {
            ...
            var t = this, e = this._scene.data.model.deck_f.ships[0], i = 18;
            432 != e.mst_id && 353 != e.mst_id || (i = 918), r.default.sound.voice.play(e.mst_id.toString(), i), 1 == this.scene.shutter2.isOpened() ? this._showTitle() : (this.scene.shutter2.open(), this.scene.shutter2.once("opened", function () {
                t._showTitle()
            }))
