    ...
    var o = i(3),
        ...
        p = function (t) {
            function e() {
                ...
                E.anchor.y = .5, E.position.set(22, 20), A.addChild(E), S.addChild(A), g.onClick = e._onClick, n.position.set(31, 31), l.position.set(15, 226), c.position.set(15, 280), p.position.set(15, 336), y.position.set(15, 390), v.position.set(178, 275), x.position.set(304, 42), m.position.set(229, 49), I.position.set(301, 151), T.position.set(318, 333), O.position.set(318, 389), C.position.set(40, 447), g.position.set(40, 477), b.position.set(61, 177), P.position.set(318, 225), w.position.set(60, 85), k.position.set(156, 441), M.position.set(156, 441), I.anchor.x = 1, x.anchor.x = 1;
                var j = new PIXI.Container,
                    N = new a.TextBox(30, 5523516);
                j.position.set(57, 37);
                var L = h.CreateRect.gradientLeftToRight(170, 42, .5, .98);
                return j.mask = L, j.addChild(N, L), T.anchor.x = 1, O.anchor.x = 1, P.anchor.x = 1, i.interactive = !0, e.addChild(i, n, l, c, p, y, C, g, m, j, x, I, b, v, T, O, P, S, w, M, k), e.textName = N, e.textLevel = x, e.textHp = I, e.textSteel = T, e.textFuel = O, e.textAlert = C, e.hiSpeedToggle = v, e.startButton = g, e.textRequire = P, e.shipBanner = w, e.downArrowAnimationView = k, e.disableDownArrowAnimationView = M, e.hpGaugeView = b, e.headerContainer = S, e.containerName = j, e
            }
