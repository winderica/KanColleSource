const function341 = function (t, e, i) {
    ...
    var o = i(3), r = i(1), s = function (t) {
        function e() {
            ...
            var i = o.ARSENAL_MAIN.getTexture(75), n = o.ARSENAL_MAIN.getTexture(76);
            return e.popup = new PIXI.Sprite(o.ARSENAL_MAIN.getTexture(67)), e.tween = createjs.Tween.get(e.animation), e.popup.position.set(-346, -37), e.popup.visible = !1, e.tween.to({ light: 0 }), e.tween.to({ light: 1 }, 300), e.tween.to({ light: 0 }, 300), e.tween.loop = !0, e.tween.addEventListener("change", function () {
