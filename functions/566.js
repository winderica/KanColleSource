const function566 = function (t, e, i) {
    ...
    var n = i(5), o = i(0), r = i(567), s = i(187), a = i(187), _ = i(187), u = i(24), l = i(569), c = i(571),
        h = i(572), p = i(1), d = function () {
            function t(t) {
                var e = this;
            ...
            return t.prototype.set_portbgm = function (t) {
                ...
                if (!this._jukemode) {
                    this._jukemode = !0;
                    var e = new u.UIImageLoader("jukebox");
                    e.add("jukebox_common.json"), e.load(function () {
                        t._furnitureJukeBoxBGMModel = new r.FurnitureJukeBoxBGMModel, new s.UserFurnitureJukeBoxMusicListAPI(t._furnitureJukeBoxBGMModel).start(function () {
                            for (t._ListMax = 0; t._ListMax < t._furnitureJukeBoxBGMModel.list.length && t._furnitureJukeBoxBGMModel.list[t._ListMax].isLoaded; t._ListMax++) ;
                            t._ListMax >= 5 && (t._ListMax -= 5), t._ListNow = t._ListMax, t._bg_black = new PIXI.Graphics, t._bg_black.beginFill(0), t._bg_black.drawRect(0, 0, n.default.width, n.default.height), t._bg_black.endFill(), t._bg_black.alpha = .2, t._bg_black.interactive = !0, t._bg_black.on(p.EventType.CLICK, t._onMouseout), o.default.view.portMain.overLayer.addChild(t._bg_black), t._jukeBoxList = new l.JukeBoxList, t._jukeBoxList.init(), o.default.view.portMain.overLayer.addChild(t._jukeBoxList), t._jukeBoxList.jukebox_table.on(p.EventType.MOUSEOUT, t._onMouseout), t._jukeBoxList.jukebox_btn_up2.on(p.EventType.CLICK, t._onBtnUp), t._jukeBoxList.jukebox_btn_down2.on(p.EventType.CLICK, t._onBtnDown), t._jukeBoxList.jukebox_btn_up2.on(p.EventType.MOUSEOVER, t._onMouseBtn), t._jukeBoxList.jukebox_btn_up2.on(p.EventType.MOUSEOUT, t._offMouseBtn), t._jukeBoxList.jukebox_btn_down2.on(p.EventType.MOUSEOVER, t._onMouseBtn), t._jukeBoxList.jukebox_btn_down2.on(p.EventType.MOUSEOUT, t._offMouseBtn), t._jukeBoxList.setBGMBtnEvent(t._onMouseBtn, t._offMouseBtn, t._onBGMSelect), t.JukeRedraw(), o.default.view.portMain.furnitureLayer.stopGramophone(), t._fadeinout(!0, 300), t._tween[0] = createjs.Tween.get(t._jukeBoxList.jukebox_table).to({ alpha: 0 }, 1).to({ alpha: 1 }, 300).call(function () {
                                t._tween[0] = null
                            })
                        })
                    })
                ...
                this._bg_black.off(p.EventType.CLICK, this._onMouseout), this._jukeBoxList.jukebox_table.off(p.EventType.MOUSEOUT, this._onMouseout), this._jukeBoxList.jukebox_btn_up2.off(p.EventType.CLICK, this._onBtnUp), this._jukeBoxList.jukebox_btn_down2.off(p.EventType.CLICK, this._onBtnDown), this._jukeBoxList.jukebox_btn_up2.off(p.EventType.MOUSEOVER, this._onMouseBtn), this._jukeBoxList.jukebox_btn_up2.off(p.EventType.MOUSEOUT, this._offMouseBtn), this._jukeBoxList.jukebox_btn_down2.off(p.EventType.MOUSEOVER, this._onMouseBtn), this._jukeBoxList.jukebox_btn_down2.off(p.EventType.MOUSEOUT, this._offMouseBtn), this._jukeBoxList.removeBGMBtnEvent(this._onMouseBtn, this._offMouseBtn, this._onBGMSelect)
                ...
                var t = this;
                this._jukeBoxConfirm = new c.JukeBoxConfirm(this._furnitureJukeBoxBGMModel.list[this._selectedBGM]), this._jukeBoxConfirm.init(), o.default.view.portMain.overLayer.addChild(this._jukeBoxConfirm), this._jukeBoxConfirm.btn_back3.on(p.EventType.CLICK, function () {
                    t._onConfirm(!1)
                }), this._jukeBoxConfirm.btn_kagu.on(p.EventType.CLICK, function () {
                    t._onConfirm(!0)
                })
            }, t.prototype.JukeConfirmRemoveEvents = function () {
                var t = this;
                this._jukeBoxConfirm.btn_back3.off(p.EventType.CLICK, function () {
                    t._onConfirm(!1)
                }), this._jukeBoxConfirm.btn_kagu.off(p.EventType.CLICK, function () {
                    t._onConfirm(!0)
                })
