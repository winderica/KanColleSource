const function837 = function (t, e, i) {
    ...
    var o = i(4), r = i(33), s = i(3), a = i(22), _ = i(1), u = function (t) {
        function e() {
            ...
            var i = new PIXI.Sprite(s.COMMON_MAIN.getTexture(63)), n = new o.TextBox(21, 1949120),
                ...
                y = new r.ShipBanner, m = new o.TextBox(21, 16777215), v = new o.TextBox(24, 16777215),
            ...
            return n.position.set(i.width / 2, -39), n.anchor.set(.5, 0), m.position.set(576, 147), a.position.set(310, 147), y.position.set(576, 180), u.position.set(310, 258), g.position.set(580, 288), l.position.set(577, 258), b.position.set(684, 298), w.position.set(718, 298), x.position.set(685, 294), c.position.set(310, 345), v.position.set(684, 345), p.position.set(687, 342), h.position.set(718, 345), f.position.set(297, 516), d.position.set(580, 516), b.anchor.x = 1, v.anchor.x = 1, n.text = "-\u8266\u8239\u3000\u5165\u6e20-", e._labelArr.push(n), a.text = "\u4fee\u5fa9\u3059\u308b\u8266\u8239", e._labelArr.push(a), u.text = "\u9ad8\u901f\u4fee\u5fa9", e._labelArr.push(u), l.text = "\u4f7f\u7528\u3059\u308b", e._labelArr.push(l), b.text = "9999", x.text = "\u2192", e._labelArr.push(x), w.text = "9999", c.text = "\u6240\u8981\u6642\u9593", e._labelArr.push(c), p.text = "\u2192", e._labelArr.push(p), h.text = "00:00:00", e._labelArr.push(h), d.addListener(_.EventType.CLICK, e._onClickYES), f.addListener(_.EventType.CLICK, e._onClickNO), f.interactive = f.buttonMode = !0, d.interactive = d.buttonMode = !0, e.addChild(i, n, a, u, c, m, v, g, l, p, h, f, d, y, b, x, w), e.textName = m, e.textRequireTime = v, e.buttonYes = d, e.buttonNo = f, e.shipBanner = y, e.beforeRepairKitCount = b, e.afterRepairKitCount = w, e
        }
