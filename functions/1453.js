const function1453 = function (t, e, i) {
    "use strict";
    ...
    var o = i(5), r = i(0), s = i(2), a = i(8), _ = i(57), u = i(12), l = i(9), c = i(36), h = i(470), p = i(1),
        d = function (t) {
            function e(e) {
                var i = t.call(this) || this;
                i._parfect = !0, i._scene = e;
                var n = i._scene.data.battle_model;
                if (i._rank = i._scene.data.battle_result_rank, "S" != i._rank) i._parfect = !1; else for (var r = n.deck_f.ships, s = 0, a = r; s < a.length; s++) {
                    var _ = a[s];
                    if (null != _) {
                        var u = n.ship_info.getFirstData(!0).get(_.mem_id).hp;
                        if (_.hp_now < u) {
                            i._parfect = !1;
                            break
                        }
                ...
                return 1 == i._parfect ? i._view = new v : i._view = new y, i._view.position.set(o.default.width / 2, o.default.height / 2), i
            }
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                i.anchor.set(.5), this._view.bg.addChild(i), this._scene.view.addChild(this._view), createjs.Tween.get(this._view.bg).to({ alpha: 1 }, 233), createjs.Tween.get(i).wait(233).to({ alpha: 0 }, 266).call(function () {
                ...
                if (0 == this._parfect) {
                    var e = this._view;
                    createjs.Tween.get(e.text).to({ alpha: 1, scaleX: 1, scaleY: 1 }, 200)
                } else {
                    var e = this._view;
                    createjs.Tween.get(e.text_kan).to({ alpha: 1, scaleX: 1, scaleY: 1 }, 200).call(function () {
                ...
                createjs.Tween.get(this._view.relief).to({ alpha: 1, scaleX: 1, scaleY: 1 }, 200).call(function () {
                    t._showBlueParticle()
                })
                ...
                "S" == this._rank ? (this._view.particle.startKamihubuki(60), e = 1, r.default.sound.bgm.play(1, !1, 0, "fanfare")) : "A" == this._rank ? (this._view.particle.startKamihubuki(30), r.default.sound.bgm.play(2, !1, 0, "fanfare")) : "B" == this._rank ? (this._view.particle.startKamihubuki(15), r.default.sound.bgm.play(3, !1, 0, "fanfare")) : r.default.sound.bgm.play(4, !1, 0, "fanfare"), this._view.rank.visible = !0, createjs.Tween.get(this._view.rank).to({
                    ...
                    t._showParticle2()
                }), "S" == this._rank && (this._view.congratulations.visible = !0, this._view.congratulations_text.visible = !0, createjs.Tween.get(this._view.congratulations).to({ x: 0 }, 233), createjs.Tween.get(this._view.congratulations_text).wait(100).to({
                    x: 0,
                    alpha: 1
                }, 200))
                ...
                var t = this, e = new _.GearBtnNext;
    ...
    var f = function (t) {
        function e() {
            ...
            return e._bg = new PIXI.Sprite, e._bg.anchor.set(.5), e._congratulations = new PIXI.Sprite, e._congratulations.anchor.set(.5), e._congratulations.position.set(0, 240), e._congratulations_text = new PIXI.Sprite, e._congratulations_text.anchor.set(.5), e._congratulations_text.position.set(0, 240), e._relief = new u.Sprite, e._relief.anchor.set(.5), e._relief.position.set(288, 0), e._texts_canvas = new u.Sprite, e._texts_canvas.position.set(-219, 0), e._rank = new u.Sprite, e._rank.anchor.set(.5), e._rank.position.set(288, 0), e._particle = new g, e.addChild(e._bg), e.addChild(e._congratulations), e.addChild(e._congratulations_text), e.addChild(e._relief), e.addChild(e._texts_canvas), e.addChild(e._rank), e.addChild(e._particle), e
        }
        ...
        function e() {
            var e = t.call(this) || this;
            return e._text = new u.Sprite, e._text.anchor.set(.5), e.texts_canvas.addChild(e._text), e
        }
        ...
        return n(e, t), Object.defineProperty(e.prototype, "text", {
            ...
            this.bg.texture = l.COMMON_MISC.getTexture(120), "S" == t ? (this.congratulations.texture = c.BATTLE_RESULT_MAIN.getTexture(22), this.congratulations_text.texture = c.BATTLE_RESULT_MAIN.getTexture(23)) : (this.congratulations.texture = PIXI.Texture.EMPTY, this.congratulations_text.texture = PIXI.Texture.EMPTY, this.congratulations.visible = !1, this.congratulations_text.visible = !1), this.relief.texture = "D" == t || "E" == t ? PIXI.Texture.EMPTY : c.BATTLE_RESULT_MAIN.getTexture(38);
            var e;
        ...
        function e() {
            var e = t.call(this) || this;
            return e.relief.position.set(375, 0), e.rank.position.set(363, 0), e._text_kan = new u.Sprite, e._text_kan.anchor.set(.5), e._text_kan.position.set(-269, 0), e._text_zen = new u.Sprite, e._text_zen.anchor.set(.5), e._text_zen.position.set(-96, 0), e._text_sho = new u.Sprite, e._text_sho.anchor.set(.5), e._text_sho.position.set(77, 0), e._text_ri = new u.Sprite, e._text_ri.anchor.set(.5), e._text_ri.position.set(249, 0), e._text_ex = new u.Sprite, e._text_ex.anchor.set(.5), e._text_ex.position.set(392, 0), e.texts_canvas.addChild(e._text_kan), e.texts_canvas.addChild(e._text_zen), e.texts_canvas.addChild(e._text_sho), e.texts_canvas.addChild(e._text_ri), e.texts_canvas.addChild(e._text_ex), e
        }
        ...
        return n(e, t), e.prototype.initialize = function () {
            this.texture = l.COMMON_MISC.getTexture(115), this._init()
            ...
            }, 133).to({ scaleX: 0, scaleY: 0 }, 200).call(function () {
                t._startAnim()
            }), this._t2 = createjs.Tween.get(this).wait(e).to({ rotation: (100 * Math.random() - 50) / 180 * Math.PI }, 333)
        ...
        return n(e, t), e.prototype.initialize = function () {
            ...
            var t = this;
            this._stopAnim(), this._init();
            var e = 2500 * Math.random(), i = Math.random() < .5 ? 1 : -1;
            this._t1 = createjs.Tween.get(this).wait(e).to({
                alpha: 1,
                scaleX: this._base_scale,
