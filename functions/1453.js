const function1453 = function (t, e, i) {
    ...
    var o = i(0), r = i(1), s = i(2), a = i(28), _ = i(19), u = i(40), l = i(8), c = i(57), h = i(14), p = i(1454),
        d = i(1455), f = function (t) {
            function e(e) {
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                if (o >= 0 && o < e.length && (i = e[o]), o = this._scene.data.getMvpIndex(!0) + 6, o >= 0 && o < e.length && (n = e[o]), null == i && null == n) this._initMove(); else {
                ...
                if (u >= 0) {
                    ...
                    e.addTween(this._scene.view.layer_mvp.createShowTween(p, d, 300, s - 300));
