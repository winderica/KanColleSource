    ...
    var o = i(854),
        ...
        d = function (t) {
            function e() {
                ...
                var m = new a.TextBox(18, 16777215);
                m.anchor.set(1, 1), m.position.set(234, 64);
                var v = new _.RepairHpGaugeView;
                v.position.set(0, 66);
                var g = new PIXI.Container;
                g.name = "info", g.position.set(436, 20), g.addChild(n, h, p, y, m, v);
                ...
                return x.position.set(66, 36), e.addChild(i, g, b, w, e._craneContainer, x), e.useItemButton = w, e.repairShipBanner = x, e.textHp = m, e.textLevel = h, e.textName = d, e.textTime = b, e.starRateView = p, e.repairHpGaugeView = v, e.containerName = y, e.informationContainer = g, e
            }
            return n(e, t), Object.defineProperty(e.prototype, "state", {
                ...
                var i = createjs.Tween.get(this.ANIMATION_HIGHSPEED, {
                    loop: !0
                });
