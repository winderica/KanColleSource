const function613 = function (t, e, i) {
    "use strict";
    ...
    var o = i(8),
        ...
        _ = function (t) {
            function e() {
                ...
                var n = new PIXI.Sprite(r.PORT_FRIENDLY_REQUEST.getTexture(25));
                n.position.set(73, 34), e._container.addChild(n);
                var s = new PIXI.Sprite(r.PORT_FRIENDLY_REQUEST.getTexture(14));
            ...
            return n(e, t), e.prototype.dispose = function () {
                ...
                return t < 3 ? e >= 40 ? 10 : 3 : 3 == t ? e >= 70 ? 10 : e >= 50 ? 3 : e >= 25 ? 12 : 13 : 4 == t ? e >= 80 ? 10 : e >= 70 ? 3 : e >= 60 ? 12 : e >= 50 ? 13 : e >= 20 ? 11 : e >= 10 ? 8 : 6 : e >= 90 ? 10 : e >= 85 ? 3 : e >= 75 ? 12 : e >= 70 ? 13 : e >= 60 ? 11 : e >= 55 ? 8 : e >= 50 ? 6 : e >= 38 ? 5 : e >= 26 ? 4 : e >= 16 ? 9 : e >= 10 ? 7 : 2
    ...
    var l = function (t) {
            function e() {
                var e = t.call(this) || this,
                    i = new PIXI.Sprite(r.PORT_FRIENDLY_REQUEST.getTexture(26));
                return e.addChild(i), e._ball = new PIXI.Sprite(r.PORT_FRIENDLY_REQUEST.getTexture(27)), e.addChild(e._ball), i.position.set(Math.round(e._ball.width / 2), 9), e._rightX = i.width, e.interactive = !0, e.buttonMode = !0, e
            }
            return n(e, t), e.prototype.dispose = function () {
                ...
                this.interactive = !1, this._ball.texture = r.PORT_FRIENDLY_REQUEST.getTexture(28)
            }, e.prototype.resume = function () {
                this.interactive = !0, this._ball.texture = r.PORT_FRIENDLY_REQUEST.getTexture(27)
        ...
        u = function (t) {
            function e() {
                var e = t.call(this) || this;
                return e._request = new PIXI.Sprite(r.PORT_FRIENDLY_REQUEST.getTexture(15)), e._request.interactive = !0, e._request.buttonMode = !0, e.addChild(e._request), e._requestOn = new PIXI.Sprite(r.PORT_FRIENDLY_REQUEST.getTexture(16)), e.addChild(e._requestOn), e._unnecessary = new PIXI.Sprite(r.PORT_FRIENDLY_REQUEST.getTexture(17)), e._unnecessary.position.set(318, 0), e._unnecessary.interactive = !0, e._unnecessary.buttonMode = !0, e.addChild(e._unnecessary), e._unnecessaryOn = new PIXI.Sprite(r.PORT_FRIENDLY_REQUEST.getTexture(18)), e._unnecessaryOn.position.set(318, 0), e.addChild(e._unnecessaryOn), e._btn = new l, e._btn.position.set(205, 8), e.addChild(e._btn), e
            }
            return n(e, t), e.prototype.dispose = function () {
        ...
        c = function (t) {
            function e() {
                var e = t.call(this) || this;
                return e._powerfulInfo = new PIXI.Sprite(r.PORT_FRIENDLY_REQUEST.getTexture(23)), e._powerfulInfo.position.set(12, 45), e.addChild(e._powerfulInfo), e._normalInfo = new PIXI.Sprite(r.PORT_FRIENDLY_REQUEST.getTexture(24)), e._normalInfo.position.set(330, 45), e.addChild(e._normalInfo), e._powerful = new PIXI.Sprite(r.PORT_FRIENDLY_REQUEST.getTexture(19)), e._powerful.interactive = !0, e._powerful.buttonMode = !0, e.addChild(e._powerful), e._powerfulOn = new PIXI.Sprite(r.PORT_FRIENDLY_REQUEST.getTexture(20)), e.addChild(e._powerfulOn), e._normal = new PIXI.Sprite(r.PORT_FRIENDLY_REQUEST.getTexture(21)), e._normal.position.set(318, 0), e._normal.interactive = !0, e._normal.buttonMode = !0, e.addChild(e._normal), e._normalOn = new PIXI.Sprite(r.PORT_FRIENDLY_REQUEST.getTexture(22)), e._normalOn.position.set(318, 0), e.addChild(e._normalOn), e._btn = new l, e._btn.position.set(205, 8), e.addChild(e._btn), e
            }
            return n(e, t), e.prototype.dispose = function () {
