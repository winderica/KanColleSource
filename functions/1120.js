    ...
    var o = i(204),
        ...
        c = function (t) {
            function e(e, i, n, r) {
                ...
                return c._bg = new PIXI.Sprite, c._bg.position.set(147, 60), c.addChild(c._bg), c._pager = new _.PagerContainer(i), c._pager.position.set(195, 14), c.addChild(c._pager), c._content = new s.MainContainer(n), c._content.position.set(126, 66), c.addChild(c._content), c._tab_container = new u.TabBtnContainer(e), c._tab_container.position.set(0, 89), c.addChild(c._tab_container), c._mini_chara = new a.MiniChara, c._mini_chara.position.set(104, 564), c.addChild(c._mini_chara), c._back_btn = new o.BackBtn, c._back_btn.position.set(0, 659), c.addChild(c._back_btn), c._album_switch_btn = new l.AlbumModeSwitchBtn(r, e), c._album_switch_btn.position.set(0, 419), c.addChild(c._album_switch_btn), c
            }
