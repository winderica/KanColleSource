const function1140 = function (t, e, i) {
    ...
    var o = i(0), r = i(2), s = i(8), a = i(16), _ = i(4), u = i(200), l = i(3), c = i(397), h = i(168),
        p = i(1141), d = i(152), f = i(1), y = function (t) {
            function e(e, i, n) {
    ...
    var v = function (t) {
        function e() {
            ...
            return e._bg = new PIXI.Sprite, e._bg.position.set(48, 102), e.addChild(e._bg), e._header = new PIXI.Sprite, e._header.position.set(439, 123), e.addChild(e._header), e._icon = new PIXI.Sprite, e._icon.position.set(562, 195), e.addChild(e._icon), e._description = new _.TextBox(21, 16774898), e._description.position.set(534, 282), e._description.style.breakWords = !0, e._description.style.wordWrap = !0, e._description.style.wordWrapWidth = 306, e.addChild(e._description), e._count = new _.TextBox(21, 16774898), e._count.anchor.x = 1, e._count.position.set(568, 418), e.addChild(e._count), e._price = new _.TextBox(21, 16724736), e._price.position.set(574, 456), e.addChild(e._price), e._btn_up = new m, e._btn_up.position.set(604, 418), e.addChild(e._btn_up), e._btn_down = new g, e._btn_down.position.set(604, 438), e.addChild(e._btn_down), e._btn_back = new c.BackBtn, e._btn_back.position.set(108, 571), e.addChild(e._btn_back), e._btn_purchase = new b, e._btn_purchase.position.set(424, 568), e.addChild(e._btn_purchase), e
        }
