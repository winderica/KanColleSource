const function454 = function (t, e, i) {
    ...
    var o = i(66), r = i(6), s = i(137), a = function (t) {
        function e(e) {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "friend", {
            ...
            var _, l = new PIXI.Point(this.x, this.y), u = this._createControllPoints(l, t), c = u.c1, h = u.c2;
            if (0 == isNaN(e)) {
                var p = .99, d = 1 - p,
                    ...
                    m = t.y + (e - t.x) * (t.y - y) / (t.x - f), v = t.x - f, g = (e - t.x) / v,
                    b = i / (100 + g) * 100, w = i / (100 + g) * g;
