const function28 = function (t, e, i) {
    "use strict";
    ...
    ! function (t) {
        ...
        function a(t, e) {
            null != t && t.sort(function (t, i) {
                ...
                return 5 == e ? t.getRepairTime() < i.getRepairTime() ? 1 : t.getRepairTime() > i.getRepairTime() ? -1 : t.sortNo > i.sortNo ? 1 : t.sortNo < i.sortNo ? -1 : t.memID > i.memID ? 1 : t.memID < i.memID ? -1 : 0 : 0
            })
        }
