const function376 = function (t, e, i) {
    "use strict";
    ...
    var o = i(2),
        ...
        a = function (t) {
            function e(e, i, n) {
                ...
                return h.filters = [l], a.filters = [u], o._attacker = e, o._chara = a, o._container = s, o._pack = r, o._preload_task = y, o._zuiun = h, o._zuiunMstId = i, o._zuiunFlashFilter = l, o._charaFlashFilter = u, o._mainArmament = p, o._mainArmamentMstID = n, o._mainArmamentText = f, o._zuiunGraphicContainer = c, o
            }
    ...
    var _ = function (t) {
        ...
        d = function () {
            function t() {
                var t = new PIXI.Sprite(u.BATTLE_ZRK.getTexture(7)),
                    e = new PIXI.Sprite(u.BATTLE_ZRK.getTexture(8)),
                    i = new PIXI.Sprite(u.BATTLE_ZRK.getTexture(9)),
                    n = new f,
                    o = new y,
                    r = new PIXI.Sprite(u.BATTLE_ZRK.getTexture(4)),
                    s = new PIXI.Sprite(u.BATTLE_ZRK.getTexture(5)),
                    a = new PIXI.Sprite(u.BATTLE_ZRK.getTexture(6)),
                ...
                this._textZui = t, this._textUn = e, this._textRittaikougeki = i, this._zuiunFrame = n, this._telopBG = o, this._smoke1 = r, this._smoke2 = s, this._smoke3 = a, this._charaContainer = _, this._whiteBg = p, this._zuiunContainer = l, this._mainArmamentContainer = c, this._mainArmamentTextContainer = h, this._blueBg = d
            }
        ...
        f = function (t) {
            ...
            return n(e, t), e.prototype.update = function (t) {
                var e;
                e = t ? u.BATTLE_ZRK.getTexture(0) : u.BATTLE_ZRK.getTexture(1), this.texture = e
            }, e
        }(PIXI.Sprite),
        y = function (t) {
            function e() {
            ...
            return n(e, t), e.prototype.update = function (t) {
                var e;
                e = t ? u.BATTLE_ZRK.getTexture(3) : u.BATTLE_ZRK.getTexture(2), this.texture = e
            }, e
        }(PIXI.Sprite),
        m = function () {
            function t() {}
