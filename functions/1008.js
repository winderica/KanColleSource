const function1008 = function (t, e, i) {
    "use strict";
    ...
    var o = i(4), r = i(8), s = i(37), a = i(1009), _ = i(1010), u = i(373), l = i(1011), c = i(1012), h = i(374),
        p = i(1), d = function (t) {
            function e(e, i) {
            ...
            return n(e, t), e.prototype.initialize = function () {
                ...
                for (var e = 0; e < this._ships.length; e++) {
                    var i = this._ships[e], n = t.ships[e];
                    i.update(n)
                }
                ...
                s.TaskLoadShipResource.abortBy(this._ship_container), this._area_close.off(p.EventType.CLICK, this._onClose), this._btn.dispose(), this._btn_close.dispose();
