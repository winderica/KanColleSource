const function1014 = function (t, e, i) {
    "use strict";
    ...
    var a = function (t) {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "type", {
                ...
                this._update(!1), this._label.texture = this._getTextureLabel(), this._circle.texture = o.SALLY_EVENT.getTexture(60)
                ...
                return 4 == this._type ? o.SALLY_EVENT.getTexture(57) : 3 == this._type ? o.SALLY_EVENT.getTexture(61) : 2 == this._type ? o.SALLY_EVENT.getTexture(54) : 1 == this._type ? o.SALLY_EVENT.getTexture(64) : PIXI.Texture.EMPTY
            }, e.prototype._getTextureOn = function () {
                return 4 == this._type ? o.SALLY_EVENT.getTexture(59) : 3 == this._type ? o.SALLY_EVENT.getTexture(63) : 2 == this._type ? o.SALLY_EVENT.getTexture(56) : 1 == this._type ? o.SALLY_EVENT.getTexture(66) : PIXI.Texture.EMPTY
            }, e.prototype._getTextureOff = function () {
                return 4 == this._type ? o.SALLY_EVENT.getTexture(58) : 3 == this._type ? o.SALLY_EVENT.getTexture(62) : 2 == this._type ? o.SALLY_EVENT.getTexture(55) : 1 == this._type ? o.SALLY_EVENT.getTexture(65) : PIXI.Texture.EMPTY
            }, e.prototype._getTextureLabel = function () {
                return 4 == this._type ? (this._label.position.set(0, 111), o.SALLY_EVENT.getTexture(50)) : 3 == this._type ? (this._label.position.set(6, 111), o.SALLY_EVENT.getTexture(49)) : 2 == this._type ? (this._label.position.set(23, 111), o.SALLY_EVENT.getTexture(48)) : 1 == this._type ? (this._label.position.set(0, 111), o.SALLY_EVENT.getTexture(51)) : PIXI.Texture.EMPTY
            }, e
        }(PIXI.Container),
        _ = function (t) {
            function e(e, i) {
        ...
        u = function (t) {
            ...
            return n(e, t), e.prototype.initialize = function (t) {
                ...
                1 == t ? (this._stoptAnim(), 0 == this._selected_type ? this.texture = o.SALLY_EVENT.getTexture(47) : this.texture = o.SALLY_EVENT.getTexture(53)) : 0 == this._selected_type ? (this.texture = o.SALLY_EVENT.getTexture(46), this._startAnim()) : this.texture = o.SALLY_EVENT.getTexture(52)
