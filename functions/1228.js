const function1228 = function (t, e, i) {
    ...
    var p = function (t) {
            ...
            return n(e, t), e.prototype.initialize = function () {
                ...
                t.models.length > 0 ? this._message.visible = !1 : (9 == t.selected_type ? this._message.texture = s.DUTY_COMMON.getTexture(51) : this._message.texture = s.DUTY_COMMON.getTexture(50), this._message.visible = !0)
            }, e.prototype.dispose = function () {
                for (var t = 0, e = this._items; t < e.length; t++) {
                    e[t].dispose()
                }
