const function1228 = function (t, e, i) {
    ...
    var o = i(5), r = i(0), s = i(141), a = i(2), _ = i(16), u = i(77), l = i(427), c = i(1229), h = i(1230),
        p = function (t) {
            function e(e, i) {
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                h.add(c), h.load(function () {
                    var n = r.default.resources.gauge.getGaugeInfo(c), s = n.vertical;
                    null != s && (t._scene.view.gauge_layer.initialize(s, i, e), s.x < o.default.width / 2 && t._scene.view.frontOfGaugeLayer()), t._loadMapBGM()
                })
