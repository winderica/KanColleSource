const function1228 = function (t, e, i) {
    ...
    var o = i(4),
        ...
        a = function (t) {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "model", {
                ...
                this.texture = r.DUTY_MAIN.getTexture(0), this._bonus.texture = r.DUTY_MAIN.getTexture(15), this._mat.initialize()
            }, e.prototype.update = function (t) {
                this._model = t, null == t ? (this.visible = !1, this._deactivate()) : (this._icon.update(t.category), this._title.text = t.title, this._description.text = t.description.replace(/<br>/g, "\n"), this._bonus.visible = t.hasBonus(), this._mat.update(t.fuel, t.ammo, t.steel, t.baux), this._progress.update(t.progress), this._type.update(t.label_type), this._status.update(t.status), this.visible = !0, this._activate())
    ...
    var _ = function (t) {
            ...
            return n(e, t), e.prototype.update = function (t) {
                ...
                this.texture = r.DUTY_MAIN.getTexture(e)
            }, e
        }(PIXI.Sprite),
        u = function (t) {
            function e() {
            ...
            return n(e, t), e.prototype.initialize = function () {
                var t = r.DUTY_MAIN.getTexture(6),
                    e = new PIXI.Sprite(t);
                e.position.set(0, 1), this.addChild(e), t = r.DUTY_MAIN.getTexture(7), e = new PIXI.Sprite(t), e.position.set(82, 3), this.addChild(e), t = r.DUTY_MAIN.getTexture(8), e = new PIXI.Sprite(t), e.position.set(165, 1), this.addChild(e), t = r.DUTY_MAIN.getTexture(9), e = new PIXI.Sprite(t), e.position.set(247, 1), this.addChild(e), this.addChild(this._fuel), this.addChild(this._ammo), this.addChild(this._steel), this.addChild(this._baux)
        ...
        l = function (t) {
            ...
            return n(e, t), e.prototype.update = function (t) {
                2 == t ? (this.texture = r.DUTY_MAIN.getTexture(11), this.visible = !0) : 1 == t ? (this.texture = r.DUTY_MAIN.getTexture(10), this.visible = !0) : this.visible = !1
            }, e
        }(PIXI.Sprite),
        c = function (t) {
            function e() {
            ...
            return n(e, t), e.prototype.update = function (t) {
                this.texture = 2 == t ? r.DUTY_MAIN.getTexture(14) : 3 == t ? r.DUTY_MAIN.getTexture(19) : 6 == t ? r.DUTY_MAIN.getTexture(16) : 1 == t ? r.DUTY_MAIN.getTexture(17) : 7 == t ? r.DUTY_MAIN.getTexture(18) : 8 == t ? r.DUTY_MAIN.getTexture(20) : PIXI.Texture.EMPTY
            }, e
        }(PIXI.Sprite),
        h = function (t) {
            function e() {
            ...
            return n(e, t), e.prototype.update = function (t) {
                3 == t ? (this._img.texture = r.DUTY_MAIN.getTexture(12), this._over.texture = r.DUTY_MAIN.getTexture(13), this._over.visible = !0, this._startAnimation()) : 2 == t ? (this._img.texture = r.DUTY_MAIN.getTexture(47), this._over.visible = !1, this._stopAnimation()) : (this._img.texture = PIXI.Texture.EMPTY, this._over.visible = !1, this._stopAnimation())
            }, e.prototype.dispose = function () {
                this._stopAnimation()
