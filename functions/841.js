const function841 = function (t, e, i) {
    ...
    var o = i(3), r = i(3), s = i(221), a = i(4), _ = i(34), u = i(23), l = i(111), c = i(1), h = i(13),
        p = function (t) {
            function e() {
                ...
                var i = new PIXI.Sprite(r.COMMON_MAIN.getTexture(12)),
                    ...
                    v = new PIXI.Sprite(o.REPAIR_MAIN.getTexture(42)), m = new d, g = new f,
                ...
                j.anchor.y = .5, j.position.set(22, 20), A.addChild(j), S.addChild(A), g.onClick = e._onClick, n.position.set(31, 31), u.position.set(15, 226), c.position.set(15, 280), p.position.set(15, 336), y.position.set(15, 390), m.position.set(178, 275), x.position.set(304, 42), v.position.set(229, 49), I.position.set(301, 151), T.position.set(318, 333), O.position.set(318, 389), P.position.set(40, 447), g.position.set(40, 477), b.position.set(61, 177), C.position.set(318, 225), w.position.set(60, 85), k.position.set(156, 441), M.position.set(156, 441), I.anchor.x = 1, x.anchor.x = 1;
                ...
                return E.mask = L, E.addChild(N, L), T.anchor.x = 1, O.anchor.x = 1, C.anchor.x = 1, i.interactive = !0, e.addChild(i, n, u, c, p, y, P, g, v, E, x, I, b, m, T, O, C, S, w, M, k), e.textName = N, e.textLevel = x, e.textHp = I, e.textSteel = T, e.textFuel = O, e.textAlert = P, e.hiSpeedToggle = m, e.startButton = g, e.textRequire = C, e.shipBanner = w, e.downArrowAnimationView = k, e.disableDownArrowAnimationView = M, e.hpGaugeView = b, e.headerContainer = S, e.containerName = E, e
            }
