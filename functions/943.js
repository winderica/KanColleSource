const function943 = function (t, e, i) {
    ...
    var o = i(0), r = i(331), s = i(4), a = i(60), _ = i(122), u = i(50), l = i(6), c = i(26), h = i(354),
        p = i(944), d = i(945), f = i(947), y = i(948), m = i(949), v = i(1), g = function (t) {
            function e(e) {
    ...
    var b = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function () {
            ...
            1 != this.buttonMode && (this.buttonMode = !0, this.on(v.EventType.MOUSEOVER, this._onMouseOver), this.on(v.EventType.MOUSEOUT, this._onMouseOut), this.on(v.EventType.CLICK, this._onClick), this._lockicon.on(v.EventType.CLICK, this._onClickLockIcon))
        }, e.prototype.deactivate = function () {
