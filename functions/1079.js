const function1079 = function (t, e, i) {
    "use strict";
    ...
    var o = i(0), r = i(1), s = i(4), a = i(3), _ = i(39), u = i(39), l = i(39), c = i(39), h = function (t) {
        function e(e) {
        ...
        return n(e, t), e.prototype.initialize = function (t) {
            ...
            this._title.initialize(e, i), this._message.text = t.message.replace(/<br>/g, "\n"), this._statusBox.initialize(t), this._etype.update(t.cardType), this._content.initialize(t), this._close_btn.texture = a.ALBUM_MAIN.getTexture(16)
    ...
    var p = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function (t, e) {
            this.texture = a.ALBUM_MAIN.getTexture(84), this._nums.update(t), this._img.texture = o.default.resources.getSlotitem(e, "statustop_item")
        }, e
    }(PIXI.Sprite)
}