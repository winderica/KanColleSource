const function227 = function (t, e, i) {
    ...
    var o = i(30), r = function (t) {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "enabled", {
            ...
            var t = new PIXI.Sprite(o.SALLY_COMMON.getTexture(23));
            ...
            this._supply_max != t && (this._supply_max = t, 1 == t ? (this._on1.texture = o.SALLY_COMMON.getTexture(20), this._on2.texture = o.SALLY_COMMON.getTexture(20), this._on3.texture = o.SALLY_COMMON.getTexture(19)) : (this._on1.texture = o.SALLY_COMMON.getTexture(22), this._on2.texture = o.SALLY_COMMON.getTexture(22), this._on3.texture = o.SALLY_COMMON.getTexture(21)))
        }, e.prototype.activate = function () {
            var t = this;
            this._activated = !0, null == this._t && (this._on1.visible = !1, this._on2.visible = !1, this._on3.visible = !1, 0 != this._enabled && (this._t = createjs.Tween.get(this, { loop: !0 }).wait(300).call(function () {
                t._on1.visible = !0
