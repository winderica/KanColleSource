const function954 = function (t, e, i) {
    ...
    var o = i(12), r = i(42), s = function (t) {
        function e() {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "board", {
            ...
            this._board.initialize(), this._chara.texture = r.SALLY_EVENT.getTexture(30)
        }, e
    }(PIXI.Container);
    ...
    var a = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function () {
            this.texture = r.SALLY_EVENT.getTexture(13), this._content.position.set(-360, -215), this._content.texture = r.SALLY_EVENT.getTexture(41)
        }, e
    }(o.Sprite)
}