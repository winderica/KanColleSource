    ...
    var o = i(5),
        ...
        w = function (t) {
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                var e = this,
                    i = this._mapscene.view.map.bg.getBGLayer("red");
            ...
            switch (t) {
                ...
                case 445:
                    ...
                    o.add("battle_result_event_e5_" + e + ".json"), o.load(function () {
                        n._img1.texture = v.BATTLE_RESULT_EVENT_E5_XBFEYWUBREOFGTCL.getTexture(0), n._img2.texture = v.BATTLE_RESULT_EVENT_E5_XBFEYWUBREOFGTCL.getTexture(1), i()
                    }), this._img1.position.set(-509, -172), this._img2.position.set(-398, -9);
                    break;
                default:
