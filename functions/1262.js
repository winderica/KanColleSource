const function1262 = function (t, e, i) {
    "use strict";
    ...
    var o = i(5), r = i(0), s = i(2), a = i(8), _ = i(54), u = i(21), l = i(41), c = i(57), h = i(247), p = i(18),
        d = i(246), f = i(1), y = function (t) {
            function e(e, i) {
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                if (null != i) {
                    if (5 == i.type) {
                        ...
                        this._bonus_task = new h.TaskBonusUseItem(n, o, r), this._bonus_task.start(function () {
                            t._closeShutter2()
                        })
                    }
    ...
    var v = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function () {
            this._bg.texture = p.MAP_COMMON.getTexture(135), this._txt1.texture = p.MAP_COMMON.getTexture(138), this._txt2.texture = p.MAP_COMMON.getTexture(139), this._txt3.texture = p.MAP_COMMON.getTexture(140), this._img.texture = p.MAP_COMMON.getTexture(136)
        }, e.prototype.activate = function () {
            var t = this;
            null == this._t && (this._img.texture = p.MAP_COMMON.getTexture(136), this._t = createjs.Tween.get(null, { loop: !0 }).wait(300).call(function () {
                t._img.texture = p.MAP_COMMON.getTexture(137)
            }).wait(300).call(function () {
                t._img.texture = p.MAP_COMMON.getTexture(136)
            }))
        }, e.prototype.deactivate = function () {
            null != this._t && (this._t.setPaused(!0), this._t = null, this._img.texture = p.MAP_COMMON.getTexture(136))
