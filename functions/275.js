const function275 = function (t, e, i) {
    ...
    var n = i(5), o = i(0), r = i(7), s = function () {
        ...
        return t.isAreaHit = function (t, e, i) {
            ...
            if (0 == n) for (var _ = o.default.model.ship.getMst(e), l = null == _ ? "" : _.yomi, u = 0, c = t.shipyomi; u < c.length; u++) {
                var a = c[u];
            ...
            if (1 == i) for (var l = null == n ? 0 : n.getClassType(), u = 0, c = t.shipclass; u < c.length; u++) {
                var _ = c[u];
            ...
            if (1 == s) for (var u = 0, c = t.shipclass; u < c.length; u++) {
                var l = c[u];
            ...
            var y = r.ObjUtil.getObjectArray(t.standard, "data"), m = [];
            m.push(p + "_" + s + "_A.png");
