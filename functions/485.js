const function485 = function (t, e, i) {
    ...
    var p = function (t) {
            ...
            return n(e, t), e.prototype.initialize = function (t) {
                ...
                if (e.texture = l.BATTLE_RESULT_EVENT_BASE.getTexture(5), e.position.set(0, 65), e.alpha = .9, this.addChild(e), t) {
                    var i = l.BATTLE_RESULT_EVENT_BASE.getTexture(6),
                        n = new PIXI.Sprite(i);
                    n.position.set(270, 8), this.addChild(n);
                    var o = l.BATTLE_RESULT_EVENT_BASE.getTexture(3),
                        r = new PIXI.Sprite(o);
