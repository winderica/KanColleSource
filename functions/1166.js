const function1166 = function (t, e, i) {
    ...
    var a = function (t) {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "type", {
            ...
            var t;
            if (0 == this._type) t = 27; else if (1 == this._type) t = 31; else if (2 == this._type) t = 33; else if (3 == this._type) t = 35; else if (4 == this._type) t = 37; else if (5 == this._type) t = 39; else {
            ...
            var t;
            if (0 == this._type) t = 28; else if (1 == this._type) t = 32; else if (2 == this._type) t = 34; else if (3 == this._type) t = 36; else if (4 == this._type) t = 38; else if (5 == this._type) t = 40; else {
                if (9 != this._type) return PIXI.Texture.EMPTY;
                t = 30
            }
            return o.DUTY_COMMON.getTexture(t)
