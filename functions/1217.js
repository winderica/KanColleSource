const function1217 = function (t, e, i) {
    ...
    var h = (function (t) {
        ...
        p = function (t) {
            function e() {
                var e = t.call(this) || this;
                return e.TEXT_OFFSET_X = 3, e.TEXT_OFFSET_Y = 2, e.textName = new o.TextBox(21, 16777215), e.textLv = new o.TextBox(18, 16774898), e.containerName = new PIXI.Container, e.textName.position.set(e.TEXT_OFFSET_X - 236, e.TEXT_OFFSET_Y), e.textMask = u.CreateRect.gradientLeftToRight(360, 31, .2, .3), e.textMask.position.set(e.TEXT_OFFSET_X - 236, e.TEXT_OFFSET_Y), e.textName.mask = e.textMask, e.containerName.addChild(e.textName, e.textMask), e.textLv.anchor.x = 1, e.textLv.position.set(e.TEXT_OFFSET_X - 18 - 48, e.TEXT_OFFSET_Y + 4), e.shipFlag = new l.ShipInDeckFlag, e.shipFlag.position.set(e.TEXT_OFFSET_X - 16 - 48, e.TEXT_OFFSET_Y + 2), e.shipFlag.scale.set(.75, .75), e.addChild(e.containerName, e.textLv, e.shipFlag), e
            }
