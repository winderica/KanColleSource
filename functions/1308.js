    ...
    var o = i(0),
        ...
        c = function (t) {
            ...
            return n(e, t), e.prototype.initialize = function () {
                this._taihi.initialize(), this._taihisezu.initialize(), this._txt1.texture = l.MAP_COMMON.getTexture(162), this._txt2.texture = l.MAP_COMMON.getTexture(165), this._title.initialize(!1), this._title.update(l.MAP_COMMON.getTexture(104)), this._title.activate()
