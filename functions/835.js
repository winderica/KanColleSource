    ...
    var o = i(3),
        ...
        h = function (t) {
            function e() {
                ...
                e.btn_no = new PIXI.Sprite(u.REMODEL_GRADEUP.getTexture(3)), e.btn_yes = new PIXI.Sprite(u.REMODEL_GRADEUP.getTexture(8));
