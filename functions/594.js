const function594 = function (t, e, i) {
    ...
    var o = i(5), r = i(0), s = i(1), a = i(2), _ = i(8), l = i(18), u = i(595), c = i(58), h = i(51), p = i(15),
        d = i(147), f = i(285), y = function (t) {
            function e(e, i) {
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                for (var s = this._expedition_result.ship_mem_ids, a = new createjs.Timeline([], null, { paused: !0 }), _ = this._view.banners, l = 0; l < _.length; l++) {
                    var u = _[l];
                    if (s.length <= l) u.visible = !1; else {
                        var c = r.default.model.ship.get(s[l]);
                        u.y = 68 * l + 15, u.alpha = 0, u.update(c, !1);
                        var h = createjs.Tween.get(u).wait(200 * l).to({ y: u.y - 15, alpha: 1 }, 200);
                        a.addTween(h)
                    }
                }
                for (var p = this._view.infos.items, l = 0; l < p.length; l++) {
                    var d = p[l];
                    if (s.length <= l) d.visible = !1; else {
                        var c = r.default.model.ship.get(s[l]);
