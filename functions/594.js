const function594 = function (t, e, i) {
    "use strict";
    ...
    var o = i(78), r = i(7), s = i(4), a = i(189), _ = i(190), u = i(191), l = i(192), c = i(289), h = i(595),
        p = function (t) {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "username", {
                ...
                this._gear.dispose(), this._btn_record.dispose(), this._btn_friend.dispose(), this._btn_album.dispose(), this._btn_item.dispose(), this._btn_interior.dispose(), this._btn_duty.dispose(), this._btn_shop.dispose()
            }, e
        }(PIXI.Container);
    e.UpperBar = p;
    var d = function (t) {
        ...
        return n(e, t), e.prototype.updateDefaultColor = function (t) {
            ...
            this._max - this._value > 5 ? this.style.fill = this._default_color : this.style.fill = 14442282, this.text = this._value.toString()
        }, e
    }(s.TextBox)
}