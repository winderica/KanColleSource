const function1043 = function (t, e, i) {
    ...
    var o, r = i(11), s = i(0), a = i(17), _ = i(3), u = i(377), l = i(233), c = i(378), h = i(1046), p = i(379),
        d = i(1047), f = i(1048), y = i(17), v = i(13), g = i(152), m = i(1);
    !function (t) {
    ...
    var b = function (t) {
        function e(e) {
            ...
            i._selected = null, i._recordRankingModel = new Array(101), i._onKeyDown = function () {
                var t = v.EditTextBoxUtil.text;
                i._validation = v.EditTextBoxUtil.validation(t, i._nowComment), i._keydownInput()
            }, i._updateComment = function () {
                if (i._nowComment != v.EditTextBoxUtil.text && 0 != i._validation) {
                    var t = v.EditTextBoxUtil.text;
                ...
                i._topView.btn_modeInfo.interactive = i._topView.btn_modeInfo.buttonMode = !1, i._topView.btn_modeInfo.texture = u.RECORD_MENU.getTexture(4), i._topView.btn_modeRanking.interactive = i._topView.btn_modeRanking.buttonMode = !0, i._topView.btn_modeRanking.texture = u.RECORD_MENU.getTexture(1), i._viewRanking.visible = !1, i._viewInfo.visible = !0, i._topView.sideMenu_light1.texture = u.RECORD_MENU.getTexture(5), i._topView.sideMenu_light1.position.set(i._topView.btn_modeInfo.x, i._topView.btn_modeInfo.y), i._NowMode = o.MODE_INFO, -1 != i._rankingMyPage && (i._rankingLastPage < 51 && i._viewRanking.btn_Rank500.position.set(-150, -150), i._rankingNowPage = i._rankingMyPage, v.EditTextBoxUtil.setVisibility(!0)), i._keydownInput()
            }, i._onClickBtnModeRanking = function () {
                i._topView.btn_modeInfo.interactive = i._topView.btn_modeInfo.buttonMode = !0, i._topView.btn_modeInfo.texture = u.RECORD_MENU.getTexture(4), i._topView.btn_modeRanking.interactive = i._topView.btn_modeRanking.buttonMode = !1, i._topView.btn_modeRanking.texture = u.RECORD_MENU.getTexture(1), i._viewRanking.visible = !0, i._viewInfo.visible = !1, i._setRankingPage(0), i._NowMode = o.MODE_RANKING, i._topView.sideMenu_light1.texture = u.RECORD_MENU.getTexture(2), i._topView.sideMenu_light1.position.set(i._topView.btn_modeRanking.x, i._topView.btn_modeRanking.y), v.EditTextBoxUtil.setVisibility(!1)
            ...
            return i._rankingNowPage = 1, i._rankingLastPage = 1, i._rankingMyPage = -1, v.EditTextBoxUtil.init(277, 337, 300, 16, 4473924, "font_j"), v.EditTextBoxUtil.onLengthCheck(12, i._onKeyDown), i
        }
        ...
        return n(e, t), e.prototype.cancel = function () {
            ...
            var t = this;
            this._topView.btn_back.on(m.EventType.CLICK, this._onClickBtnBack), this._topView.btn_modeInfo.on(m.EventType.CLICK, this._onClickBtnModeInfo), this._topView.btn_modeRanking.on(m.EventType.CLICK, this._onClickBtnModeRanking), this._viewInfo.btn_USER_BTN_EDIT.on(m.EventType.CLICK, this._updateComment), this._viewRanking.btn_RankMy.on(m.EventType.CLICK, function () {
                t._onClickBtnLists(0)
            }), this._viewRanking.btn_RankTop.on(m.EventType.CLICK, function () {
                t._onClickBtnLists(1)
            }), this._viewRanking.btn_Rank500.on(m.EventType.CLICK, function () {
                t._onClickBtnLists(2)
            }), this._viewRanking.btn_ArrowPrev.on(m.EventType.CLICK, function () {
                t._onClickBtnLists(3)
            }), this._viewRanking.btn_ArrowNext.on(m.EventType.CLICK, function () {
                t._onClickBtnLists(4)
            }), this._setInfoPage()
        }, e.prototype._setInfoPage = function () {
            var t = this;
            new h.RecordInfoAPI(this._recordInfoModel).start(function () {
                t._nowComment = t._recordInfoModel.comment, v.EditTextBoxUtil.text = t._nowComment, t._setInfoParam(), t._onClickBtnModeInfo()
            })
        }, e.prototype._keydownInput = function () {
            this._viewInfo.btn_USER_BTN_EDIT.dispose(), this._nowComment == v.EditTextBoxUtil.text || 0 == this._validation ? this._viewInfo.btn_USER_BTN_EDIT.initialize(32, 32) : this._viewInfo.btn_USER_BTN_EDIT.initialize(33, 34)
            ...
            var t = s.default.model.basic.port_bgm_id, e = s.default.model.mst_bgm.getMst(t).name;
            ...
            var e = this;
            if (100 == t && (t = 0), this._recordRankingModel[t].isLoaded) this.__drawRanking(t); else {
            ...
            for (var e = 0; e < 10; e++) if (this._recordRankingModel[t].list[e].isLoaded) {
                var i = [8931, 1201, 1156, 5061, 4569, 4732, 3779, 4568, 5695, 4619, 4912, 5669, 6586],
                    n = i[this._recordRankingModel[t].list[e].rank % 13];
                this._viewRanking.textN_Rank[e].text = this._recordRankingModel[t].list[e].rank + "", this._viewRanking.textJ_Name[e].text = this._recordRankingModel[t].list[e].nickname, this._recordRankingModel[t].list[e].classrank <= 2 ? this._viewRanking.obj_flag[e].texture = l.RECORD_PARTS.getTexture(15) : this._recordRankingModel[t].list[e].classrank <= 6 ? this._viewRanking.obj_flag[e].texture = l.RECORD_PARTS.getTexture(16) : this._viewRanking.obj_flag[e].texture = l.RECORD_PARTS.getTexture(14), this._viewRanking.obj_flag[e].visible = !0, this._viewRanking.textJ_RankName[e].text = a.RANK_NAME[this._recordRankingModel[t].list[e].classrank] + "", this._viewRanking.obj_balloon[e].visible = !0, this._viewRanking.textJ_Comment[e].text = this._recordRankingModel[t].list[e].comment;
            ...
            var t = this;
            v.EditTextBoxUtil.onEventDestroy(), this._topView.btn_back.off(m.EventType.CLICK, this._onClickBtnBack), this._topView.btn_modeInfo.off(m.EventType.CLICK, this._onClickBtnModeInfo), this._topView.btn_modeRanking.off(m.EventType.CLICK, this._onClickBtnModeRanking), this._viewInfo.btn_USER_BTN_EDIT.off(m.EventType.CLICK, this._updateComment), this._viewRanking.btn_RankMy.off(m.EventType.CLICK, function () {
                t._onClickBtnLists(0)
            }), this._viewRanking.btn_RankTop.off(m.EventType.CLICK, function () {
                t._onClickBtnLists(1)
            }), this._viewRanking.btn_Rank500.off(m.EventType.CLICK, function () {
                t._onClickBtnLists(2)
            }), this._viewRanking.btn_ArrowPrev.off(m.EventType.CLICK, function () {
                t._onClickBtnLists(3)
            }), this._viewRanking.btn_ArrowNext.off(m.EventType.CLICK, function () {
                t._onClickBtnLists(4)
            })
        }, e.prototype._endTask = function (e) {
            void 0 === e && (e = !1), this._scene = null, this._topView = null, this._selected = null, this._tweens = null, this._selected = null, this._tweens = null, this._NowMode = null, this._o = null, this._rankingNowPage = null, this._rankingLastPage = null, this._rankingMyPage = null, this._recordInfoModel = null, this._recordRankingModel = null;
            for (var i = 0; i < 101; i++) this._recordRankingModel[i].remove_list();
            delete this._recordRankingModel, v.EditTextBoxUtil.setVisibility(!1), t.prototype._endTask.call(this)
        }, e
    }(r.TaskBase);
    e.TaskTop = b
}