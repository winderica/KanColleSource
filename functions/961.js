const function961 = function (t, e, i) {
    ...
    var o = i(2), r = i(962), s = i(963), a = i(966), _ = i(1), l = function (t) {
        function e(e, i, n, o) {
            void 0 === o && (o = !1);
            ...
            return s._onClick = function () {
                ...
                e.start(function () {
                    0 == e.cancel && (s._dialog.board.selectView.deactivate(), s._dialog.board.selectView.showCircle(t, function () {
                        if (1 == s._skip_api_connection) s._close(); else {
        ...
        return n(e, t), e.prototype._start = function () {
            ...
            var t = this._model.mst_id, e = this._model.getSelectedOperationType();
            ...
            var t = this;
            this._dialog.operation.visible = !1, this._dialog.change_btn.visible = !1, createjs.Tween.get(this._dialog.chara).to({ alpha: 0 }, 150), createjs.Tween.get(this._dialog.board).wait(100).to({ scaleY: 0 }, 150).call(function () {
