const function420 = function (t, e, i) {
    "use strict";
    ...
    var o = i(120), r = i(4), s = i(0), a = i(1), _ = function (t) {
        function e() {
            ...
            for (var i = 4; i < 6; i++) e._slotItemParams[i] = new r.TextBox(17, 4999235), e._slotItemParams[i].position.set(37 + 64 * (i - 4), 129), e._slotItemParams[i].text = "", e.addChild(e._slotItemParams[i]);
        ...
        return n(e, t), Object.defineProperty(e.prototype, "isCertainly", {
            ...
            for (var t = 0; t < 6; t++) this._slotItemParams[t].text = (t > 3 ? "\xd7" : "") + this._slotItemParamsValue[t].toString()
        }, e.prototype.SetNumbers = function (t, e) {
            this._slotItemParams[4].text = "\xd7" + t, this._slotItemParams[5].text = "\xd7" + e, this._req_buildkit = t, this._req_remodelkit = e
            ...
            this._isBtnAnime || (this._isBtnAnime = !0, this._isCertainly ? (this._isCertainly = !1, this._tween0 = createjs.Tween.get(this._switch_btn_maru).to({ x: 402 }, 233, createjs.Ease.cubicOut).call(function () {
                ...
                t._switch_btn.dispose(), t._switch_btn.initialize(8, 8), t._slotItemParams[4].text = "\xd7" + t._req_buildkit, t._slotItemParams[5].text = "\xd7" + t._req_remodelkit, t.CheckGoBtnNyCertainly()
                ...
                t._switch_btn.dispose(), t._switch_btn.initialize(9, 9), t._slotItemParams[4].text = "\xd7" + t._certain_buildkit, t._slotItemParams[5].text = "\xd7" + t._certain_remodelkit, t.CheckGoBtnNyCertainly()
            })))
            ...
            this._switch_btn.dispose(), this._switch_btn.initialize(8, 8), this._slotItemParams[4].text = "\xd7" + this._req_buildkit, this._slotItemParams[5].text = "\xd7" + this._req_remodelkit, this._isCertainly = !1
            ...
            this.removeChildren(), this._slotItemParams = null, this._icon_m16_light = null, this._icon_stars = null
        }, e
    }(PIXI.Container);
    e.RevampRecipeBox = _;
    var u = function (t) {
