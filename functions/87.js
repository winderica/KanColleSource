const function87 = function (t, e, i) {
    ...
    var n = i(52), o = i(132), r = i(30), s = i(0), a = i(781);
    !function (t) {
        function e(t, e) {
        ...
        function u(t, e) {
            ...
            var P = i.gradeUpHoug + l, C = i.gradeUpRaig + u, k = i.gradeUpTyku + c, M = i.gradeUpSouk + h;
        ...
        function h(t, e) {
            ...
            var _ = s.default.model.slot.createUnsetList(a), l = [];
            -1 < r.indexOf(17) && (l = s.default.model.slot.createUnsetListFromMstId(33));
        ...
        function p(t, e, i) {
            ...
            var l = [], u = {}, c = s.default.model.shipType.getAllExId(),
