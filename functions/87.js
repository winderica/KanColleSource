const function87 = function (t, e, i) {
    ...
    ! function (t) {
        ...
        function c(t, e) {
            ...
            var j = n.gradeUpHoug + l,
                E = n.gradeUpRaig + c,
                N = n.gradeUpTyku + h,
                L = n.gradeUpSouk + p;
            r <= j && (l = r - n.gradeUpHoug), s <= E && (c = s - n.gradeUpRaig), _ <= N && (h = _ - n.gradeUpTyku), u <= L && (p = u - n.gradeUpSouk);
            var B = Math.max(o.luckMax - o.luckMin - n.gradeUpLuck, 0);
            d = Math.min(d, B);
            var R = !1,
                D = !1;
            return g >= 1 && (R = !0, D = !0, B <= 0 && (D = !1), n.gradeUpTaisen >= n.VAS ? R = !1 : n.taisenMax <= 0 && (R = !1)), new a.PowerUpCheckModel(l, c, h, p, d, D, M, R)
        }
