        ...
        _ = function (t) {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "model", {
                ...
                if (620 == t) {
                    ...
                    var i = "\u7b2c\u4e00\u822a\u7a7a\u6226\u968a\u300c\u6d41\u661f\u6539\u300d\u7cbe\u92ed\u8266\u653b\u968a\u306e\u7de8\u6210\u4e2d\u2026",
                        n = this.model.message2;
                    return e.setMessage(i, n), e.addMeltIntoUseitem([32, 34], 1), e.addMeltIntoUseitem([70, 70], 2), e
                }
                if (621 == t) {
                    var e = new r.ModelChangeModelEdit;
                    e.setItemFrom(this.model.mst_id_from), e.setItemTobe(this.model.mst_id_to);
                    var i = "\u9678\u6226\u7528\u88c5\u5099\u306e\u8266\u8f09\u904b\u7528\u3092\u7814\u7a76\u4e2d",
                        n = this.model.message2;
                    return e.setMessage(i, n), e.addMeltIntoUseitem([32, 3], 1), e.addMeltIntoUseitem([2], 2), e
                }
                if (629 == t || 630 == t) {
                    var e = new r.ModelChangeModelEdit;
                    e.setItemFrom(this.model.mst_id_from), e.setItemTobe(this.model.mst_id_to);
