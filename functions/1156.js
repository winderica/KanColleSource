const function1156 = function (t, e, i) {
    ...
    var o = i(1157), r = i(4), s = i(31), a = i(1), _ = function (t) {
        function e() {
            var e = t.call(this) || this;
            e._btn_lists = [], e._lists_str = [], e._btn_list_goFigure = [], e._btn_list_goFigureStr = [], e._btn_back = new s.BackBtn, e._btn_back.position.set(15, 653), e._btn_change = new u, e._btn_change.position.set(862, 645), e._btn_mess_icon = new u, e._btn_mess_icon.position.set(1101, 684), e._btn_wall = new u, e._btn_wall.position.set(10, 39), e._btn_floor = new u, e._btn_floor.position.set(10, 102), e._btn_desk = new u, e._btn_desk.position.set(10, 165), e._btn_window = new u, e._btn_window.position.set(10, 228), e._btn_object = new u, e._btn_object.position.set(10, 291), e._btn_chest = new u, e._btn_chest.position.set(10, 354), e._btn_goShop = new u, e._btn_goShop.position.set(0, 477);
            for (var i = 0; i < 10; i++) e._btn_lists[i] = new u, e._btn_lists[i].position.set(327, 48 * i + 54);
            e._btn_list_goTop = new u, e._btn_list_goTop.position.set(273, 573), e._btn_list_goPrev = new u, e._btn_list_goPrev.position.set(330, 573), e._btn_list_goNext = new u, e._btn_list_goNext.position.set(645, 573), e._btn_list_goLowest = new u, e._btn_list_goLowest.position.set(699, 573);
            for (var i = 0; i < 5; i++) e._btn_list_goFigure[i] = new u;
            return e
        }
        ...
        return n(e, t), Object.defineProperty(e.prototype, "btn_back", {
            ...
            this._btn_lists = null, this._lists_str = null, this._btn_list_goTop.dispose(), this._btn_list_goTop = null, this._btn_list_goLowest.dispose(), this._btn_list_goLowest = null, this._btn_list_goPrev.dispose(), this._btn_list_goPrev = null, this._btn_list_goNext.dispose(), this._btn_list_goNext = null, this._itemName = null, this._itemDescription = null, this._itemDescriptionLength = null, this._iconEquipment = null;
            for (var t = 0; t < 5; t++) this._btn_list_goFigure[t].dispose();
            this._btn_list_goFigure = null, this._btn_list_goFigureStr = null, this._frame1_bg = null, this._frame2_bg = null, this._thumbnail = null, this._thumbnailBG = null, this._thumbnailBG2 = null, this._thumbnailMask = null, this._menumoji = null, this._bgm_fairy = null, this.removeChildren()
        }, e
    }(PIXI.Container);
    e.ViewTop = _;
    var u = function (t) {
