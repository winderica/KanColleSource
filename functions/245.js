const function245 = function (t, e, i) {
    "use strict";
    ...
    var o = i(5), r = i(0), s = i(19), a = i(12), _ = i(8), u = i(15), l = i(25), c = i(6), h = i(1328),
        p = function (t) {
            function e(e, i, n) {
                var o = t.call(this) || this;
                if (o.ship_mstid = e, o.ship_damaged = i, o.slot_mstids = [0, 0, 0], null != n) for (var r = 0; r < n.length && !(r >= o.slot_mstids.length); r++) o.slot_mstids[r] = n[r];
            ...
            return n(e, t), e.prototype.preload = function (t) {
                ...
                this.text = [];
                for (var n = 0; n < 5; n++) {
                    var o = h.BATTLE_CUTIN_ANTI_AIR.getTexture(i[n]), s = new a.Sprite(o);
                ...
                t = createjs.Tween.get(this.bg).call(function () {
                    e.bg.activate()
                }).to({ alpha: 1 }, 500).wait(2e3).to({ alpha: 0 }, 500).call(function () {
                    e.bg.deactivate()
                ...
                for (var n = 0; n < this.text_f.length; n++) t = createjs.Tween.get(this.text_f[n]).wait(800 + 100 * n).to({ alpha: 1 }, 1).to({
                    alpha: 0,
                    scaleX: 1.3,
                    scaleY: 1.3
                ...
                return t = createjs.Tween.get(this.white).wait(1300).to({ alpha: 1 }, 0).to({ alpha: 0 }, 100).to({ alpha: 1 }, 0).to({ alpha: 0 }, 100).to({ alpha: 1 }, 0).to({ alpha: 0 }, 100), t.ignoreGlobalPause = !0, i.addTween(t), i
    ...
    var d = function (t) {
        ...
        return n(e, t), e.prototype.init = function (t) {
            ...
            var e, i = [];
            return e = createjs.Tween.get(this.line).wait(t).to({ x: 0 }, 200).to({ alpha: 0 }, 200), e.ignoreGlobalPause = !0, i.push(e), e = createjs.Tween.get(this.name_txt).wait(t + 200).to({ alpha: 1 }, 50).wait(500).to({ alpha: 0 }, 200), e.ignoreGlobalPause = !0, i.push(e), i
        }, e
        ...
        return n(e, t), e.prototype.initialize = function () {
            ...
            if (null == this._aTween) {
                ...
                this._aTween = createjs.Tween.get(this, { loop: !0 }).to({ alpha: 1 }, t).to({ alpha: 1 }, t)
            }
            if (null == this._rTween) {
                var e = (Math.random() > .5 ? 1 : -1) * Math.PI * 2, t = 2400 * Math.random() + 2400;
                this._rTween = createjs.Tween.get(this, { loop: !0 }).to({ rotation: e }, t)
            }
        }, e.prototype.deactivate = function () {
        ...
        return n(e, t), e.prototype.initialize = function () {
            ...
            var e = [], i = createjs.Tween.get(this._img1).wait(t).to({ scaleX: 1, scaleY: 1 }, 400).to({
                scaleX: 1.15,
                scaleY: 1.15,
                alpha: 0
            }, 300);
            return i.ignoreGlobalPause = !0, e.push(i), i = createjs.Tween.get(this._img2).wait(t + 400).to({ alpha: 1 }, 200).to({
                scaleX: 1.3,
                scaleY: 1.3,
                alpha: 0
