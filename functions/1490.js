const function1490 = function (t, e, i) {
    "use strict";
    ...
    var f = function (t) {
            function e() {
                ...
                return e._bg = new PIXI.Sprite, e._bg.anchor.set(.5), e._congratulations = new PIXI.Sprite, e._congratulations.anchor.set(.5), e._congratulations.position.set(0, 240), e._congratulations_text = new PIXI.Sprite, e._congratulations_text.anchor.set(.5), e._congratulations_text.position.set(0, 240), e._relief = new l.Sprite, e._relief.anchor.set(.5), e._relief.position.set(288, 0), e._texts_canvas = new l.Sprite, e._texts_canvas.position.set(-219, 0), e._rank = new l.Sprite, e._rank.anchor.set(.5), e._rank.position.set(288, 0), e._particle = new g, e.addChild(e._bg), e.addChild(e._congratulations), e.addChild(e._congratulations_text), e.addChild(e._relief), e.addChild(e._texts_canvas), e.addChild(e._rank), e.addChild(e._particle), e
            }
