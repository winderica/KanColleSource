const function1132 = function (t, e, i) {
    "use strict";
    ...
    var o = i(0), r = i(2), s = i(8), a = i(16), _ = i(4), u = i(200), l = i(3), c = i(397), h = i(167),
        p = i(1133), d = i(152), f = i(1), y = function (t) {
            function e(e, i, n) {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "layer", {
                ...
                var t = this;
                this._dialog = new v, this._dialog.initialize(this._type, this._mst, this._onUp, this._onDown, this._onBack, this._onBuy), this._dialog.update(this._count, this._mst.price * this._count, this._limit), this._dialog.alpha = 0, this._layer.addChild(this._dialog), createjs.Tween.get(this._dialog).to({ alpha: 1 }, 300).call(function () {
                    t._dialog.activate()
                })
    ...
    var v = function (t) {
        function e() {
            ...
            return e._bg = new PIXI.Sprite, e._bg.position.set(48, 102), e.addChild(e._bg), e._header = new PIXI.Sprite, e._header.position.set(439, 123), e.addChild(e._header), e._icon = new PIXI.Sprite, e._icon.position.set(562, 195), e.addChild(e._icon), e._description = new _.TextBox(21, 16774898), e._description.position.set(534, 282), e._description.style.breakWords = !0, e._description.style.wordWrap = !0, e._description.style.wordWrapWidth = 306, e.addChild(e._description), e._count = new _.TextBox(21, 16774898), e._count.anchor.x = 1, e._count.position.set(568, 418), e.addChild(e._count), e._price = new _.TextBox(21, 16724736), e._price.position.set(574, 456), e.addChild(e._price), e._btn_up = new g, e._btn_up.position.set(604, 418), e.addChild(e._btn_up), e._btn_down = new m, e._btn_down.position.set(604, 438), e.addChild(e._btn_down), e._btn_back = new c.BackBtn, e._btn_back.position.set(108, 571), e.addChild(e._btn_back), e._btn_purchase = new b, e._btn_purchase.position.set(424, 568), e.addChild(e._btn_purchase), e
        }
        ...
        return n(e, t), e.prototype.initialize = function (t, e, i, n, o, r) {
            ...
            s.position.set(267, 18), this._bg.addChild(s), s = new PIXI.Sprite(l.ITEM_ISHOP.getTexture(9)), s.position.set(366, 183), this._bg.addChild(s), s = new PIXI.Sprite(l.ITEM_ISHOP.getTexture(10)), s.position.set(366, 316), this._bg.addChild(s), s = new PIXI.Sprite(l.ITEM_ISHOP.getTexture(11)), s.position.set(366, 354), this._bg.addChild(s), s = new PIXI.Sprite(l.ITEM_ISHOP.getTexture(12)), s.position.set(499, 358), this._bg.addChild(s);
            var a = new _.TextBox(21, 16777215);
            a.text = "\u500b", a.position.set(520, 316), this._bg.addChild(a), this._header.texture = 0 == t ? l.ITEM_ISHOP.getTexture(29) : 1 == t ? l.ITEM_ISHOP.getTexture(28) : 2 == t ? l.ITEM_ISHOP.getTexture(27) : l.ITEM_ISHOP.getTexture(31), this._icon.texture = h.getPayitemIcon(e.id), this._description.text = e.description.replace(/<br>/g, "\n"), this._btn_up.initialize(i), this._btn_down.initialize(n), this._btn_back.initialize(o), this._btn_purchase.initialize(r)
            ...
            this._btn_up.dispose(), this._btn_down.dispose(), this._btn_back.dispose(), this._btn_purchase.dispose()
        }, e
