const function1132 = function (t, e, i) {
    ...
    var o = i(0), r = i(403), s = i(404), a = i(405), _ = i(170), l = i(170), u = i(90), c = i(33), h = i(91),
        p = function (t) {
            function e(e, i) {
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                var t = this, e = this._target.mstID, i = this._seleced.no, n = this._layer,
                    o = new h.TaskItemOverflowConfirm(n);
                o.start(function () {
                    if (1 == o.result) {
                        var n = new u.UseItemUseAPI(e, !0, i), r = n.result;
                        n.start(function () {
