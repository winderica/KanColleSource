const function556 = function (t, e, i) {
    "use strict";
    ...
    var o = i(5), r = i(0), s = i(275), a = i(557), _ = i(559), u = i(564), l = i(565), c = i(278), h = i(6),
        p = function (t) {
            function e(e) {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "id", {
                ...
                this._data.loadAnimationData(t, function () {
                    ...
                    if (null != i) {
                        var r = n._data.model.shogo;
                        null != r ? i.startAnimation(r) : i.stopAnimation()
                    }
                    var s = !1;
                    if (0 == n.children.length ? s = !0 : (n.id != t || n._data.model.reloadFlag) && (s = !0, n.removeChildren()), s) {
                        n._id = t;
                        var a = n._data.currentStateName, _ = n._data.model.getState(a);
                        n._reCreate(_)
                    }
                })
                    ...
                    if (null != r && 0 == this._data.animationState) {
                        ...
                        if (this._preCheckedTimeStr != s) {
                            ...
                            if (r.hasOwnProperty(s) ? a = r[s] : r.hasOwnProperty("XX" + e + i) && (a = r["XX" + e + i]), "" != a) {
                                ...
                                if (_.length > 1) {
                                    a = _[0];
                                    var u = parseFloat(_[1]), l = 100 * Math.random();
                ...
                if (this.removeChildren(), this._hit_area_map = null, this._hit_area_updated = !1, this._sprites = [], this._hitAreaLayer = null, null != t) {
                    for (var e = t.layers, i = 0; i < e.length; i++) {
                        var n = e[i], o = n.frames[0], r = (o.filename, new u.FurnitureLayer(n));
                ...
                null != i && null == this._popupLayer && 0 == r.default.scene.now && (r.default.scene.isChangingNow() || (this._popupLayer = new l.FurniturePopupLayer(i), r.default.view.overLayer.addChild(this._popupLayer), this._popupLayer.show(function () {
                    e._removePopup()
                })))
