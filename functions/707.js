const function707 = function (t, e, i) {
    ...
    var n = i(0), o = i(5), r = i(17), s = i(13), a = i(6), _ = i(708), l = i(316), u = i(317), c = i(318),
        h = i(158), p = function () {
            function t(t) {
                var e = this;
            ...
            return Object.defineProperty(t.prototype, "mainLayer", {
                ...
                createjs.Tween.get(null).call(function () {
                    ...
                    n._white.alpha = 1, null != e && e(), l(), n._OrganizeView.visible = !0, createjs.Tween.get(n._white).to({ alpha: 0 }, 1e3).set({ visible: !1 })
