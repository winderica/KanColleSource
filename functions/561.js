    ...
    var n = i(7), o = i(562), r = function () {
        ...
        return Object.defineProperty(t.prototype, "reloadFlag", {
            ...
            get: function () {
                ...
                var e = n.ObjUtil.getNumber(t, "type"), i = n.ObjUtil.getNumArray(t, "pos");
                return null == i || i.length < 2 ? null : { type: e, pos: new PIXI.Point(i[0], i[1]) }
            }, enumerable: !0, configurable: !0
            ...
            if (this._data = t, this._shift = [], t.hasOwnProperty("shift")) for (var e = 0; e < t.shift.length; e++) {
                var i = t.shift[e].filename, n = t.shift[e].pos[0], o = t.shift[e].pos[1],
                    r = { filename: i, x: n, y: o };
                this._shift.push(r)
            }
            ...
            if (this._data.hasOwnProperty(t)) {
                var e = this._data[t], i = new o.FurnitureStateModel;
