const function561 = function (t, e, i) {
    ...
    ! function () {
        ...
        function k(t) {
            t.g && c(t.f, [t.a.c("wf", "loading")]), M(t, "loading")
        }
        ...
        function G(t) {
            0 == --t.f && t.j && (t.m ? (t = t.a, t.g && c(t.f, [t.a.c("wf", "active")], [t.a.c("wf", "loading"), t.a.c("wf", "inactive")]), M(t, "active")) : S(t.a))
        }
        ...
        z.prototype.g = function (t) {
            var e = this.a;
            e.g && c(e.f, [e.a.c("wf", t.c, T(t).toString(), "active")], [e.a.c("wf", t.c, T(t).toString(), "loading"), e.a.c("wf", t.c, T(t).toString(), "inactive")]), M(e, "fontactive", t), this.m = !0, G(this)
