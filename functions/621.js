const function621 = function (t, e, i) {
    ...
    var o = i(0), r = i(2), s = i(25), a = i(67), _ = i(23), u = i(66), l = i(9), c = i(622), h = i(623),
        p = i(624), d = i(200), f = function (t) {
            function e(e, i, n, o) {
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                e.initialize(function () {
                    ...
                    e.filters = [s];
                    for (var a = new PIXI.Point(n, 720), h = new PIXI.Point(r, 0), p = new PIXI.Point(o, 240), d = u.TweenUtil.signOut, f = u.TweenUtil.create2BezierPoints(a, h, p, 1e3, d), y = createjs.Tween.get(e), m = 0, v = f; m < v.length; m++) {
                        var g = v[m];
                ...
                e.initialize(function () {
                    ...
                    e.filters = [s];
                    for (var a = new PIXI.Point(n, 720), c = new PIXI.Point(r, 0), p = new PIXI.Point(o, 240), d = u.TweenUtil.signOut, f = u.TweenUtil.create2BezierPoints(a, c, p, 1e3, d), y = createjs.Tween.get(e), m = 0, v = f; m < v.length; m++) {
                        var g = v[m];
                        y.to({ x: g.x, y: g.y }, g.t)
                    }
                    var b = { rate: 1, grad: .4 };
