const function621 = function (t, e, i) {
    ...
    var o = i(0), r = i(2), s = i(25), a = i(66), _ = i(22), u = i(65), l = i(9), c = i(622), h = i(623),
        p = i(624), d = i(202), f = function (t) {
            function e(e, i, n, o) {
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                e.initialize(function () {
                    ...
                    e.filters = [s];
                    for (var a = new PIXI.Point(n, 720), h = new PIXI.Point(r, 0), p = new PIXI.Point(o, 240), d = u.TweenUtil.signOut, f = u.TweenUtil.create2BezierPoints(a, h, p, 1e3, d), y = createjs.Tween.get(e), v = 0, m = f; v < m.length; v++) {
                        var g = m[v];
                ...
                e.initialize(function () {
                    ...
                    e.filters = [s];
                    for (var a = new PIXI.Point(n, 720), c = new PIXI.Point(r, 0), p = new PIXI.Point(o, 240), d = u.TweenUtil.signOut, f = u.TweenUtil.create2BezierPoints(a, c, p, 1e3, d), y = createjs.Tween.get(e), v = 0, m = f; v < m.length; v++) {
                        var g = m[v];
                        y.to({ x: g.x, y: g.y }, g.t)
                    }
                    var b = { rate: 1, grad: .4 };
