const function226 = function (t, e, i) {
    ...
    var o = i(200), r = i(30), s = function (t) {
        function e(e, i, n) {
    ...
    var a = function (t) {
        ...
        return n(e, t), Object.defineProperty(e.prototype, "type", {
            ...
            switch (this._type) {
                case 0:
                    return void(1 == t || 1 == this._selected ? this.texture = r.SALLY_COMMON.getTexture(56) : this.texture = r.SALLY_COMMON.getTexture(55));
                case 1:
                    return void(1 == t || 1 == this._selected ? this.texture = r.SALLY_COMMON.getTexture(51) : this.texture = r.SALLY_COMMON.getTexture(50));
                case 2:
                    return void(0 == this.enabled && 0 == this._selected ? this.texture = r.SALLY_COMMON.getTexture(53) : 1 == t || 1 == this._selected ? this.texture = r.SALLY_COMMON.getTexture(54) : this.texture = r.SALLY_COMMON.getTexture(52))
            }
