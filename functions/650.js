const function650 = function (t, e, i) {
    "use strict";
    ...
    var o = i(141), r = i(4), s = i(81), a = i(5), _ = i(651), u = i(105), l = i(0), c = i(152), h = i(1),
        p = function (t) {
            function e(e) {
                ...
                return i._ev = e, i._maxTextLength = 12, i._deleteInputText = function () {
                    ...
                    var e = t;
                    e = e.replace(/%/g, "\uff05"), e = e.replace(/\t/g, " "), e = e.replace(/</g, "\uff1c"), e = e.replace(/>/g, "\uff1e"), e = e.replace(/&/g, "\uff06"), e = e.replace(/\"/g, ""), e = e.replace(/\'/g, ""), e = e.replace(/\`/g, ""), i._NickName = e, i._GadgetIP = "http://" + l.default.settings.osapi_root;
                    var n = i._GadgetIP;
            ...
            return n(e, t), e.prototype.initialize = function () {
                var t = new PIXI.Container, e = 0, i = new r.TextBox(30, 0);
                ...
                var u = new PIXI.Point(t.x + n.x + 8, t.y + 7), l = this.toGlobal(u);
                o.EditTextBoxUtil.init(l.x, l.y, n.width - this._btnDelete.width - 22, 22, 0), o.EditTextBoxUtil.text = "", o.EditTextBoxUtil.onLengthCheck(12, this._inputAndSubmitManage), this._inputExtend = document.getElementById("r_editbox"), this._inputExtend.addEventListener("blur", this._inputAndSubmitManage);
                var c = new PIXI.Container, p = { x: t.x + t.width, y: t.y + t.height }, d = new r.TextBox(30, 0);
                ...
                this._ev.emit("tutorial-title", !0, 21), createjs.Tween.get(this).wait(800).to({ alpha: 1 }, 400, createjs.Ease.linear).call(function () {
