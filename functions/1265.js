        ...
        h = function (t) {
            function e(e, i, n) {
                ...
                return r._selected_formation = 1, r._showText = function () {
                    ...
                    t.position.set(750, o.default.height / 2), t.alpha = 0, t.texture = l.MAP_COMMON.getTexture(108), createjs.Tween.get(t).to({
                        x: 630,
                        alpha: 1
                    }, 500).to({
                        x: 585
                    ...
                    e.position.set(o.default.width / 2, o.default.height / 2), e.texture = l.MAP_COMMON.getTexture(107), createjs.Tween.get(t).to({
                        alpha: 1,
                        scaleY: 1
                    }, 200).wait(950).to({
                        alpha: 0,
            ...
            return n(e, t), Object.defineProperty(e.prototype, "selected_formation", {
                ...
                t.position.set(o.default.width / 2, o.default.height / 2), t.scaleY = 0, t.alpha = 0, t.texture = l.MAP_COMMON.getTexture(105), createjs.Tween.get(t).to({
                    alpha: 1,
                    scaleY: 1
