const function1022 = function (t, e, i) {
    ...
    var o = i(0), r = i(108), s = i(31), a = i(373), _ = i(29), l = i(38), u = i(225), c = i(226), h = i(1023),
        p = i(1027), d = i(1033), f = i(1035), y = i(1036), m = i(1040), v = i(1041), g = i(1042),
        b = function (t) {
            function e(e, i) {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "items", {
                ...
                for (var s = 0; s < this._items.length; s++) {
                    ...
                    if (_ < 0 || _ >= this._datalist.length) a.update(null, -1); else {
                        var l = this._datalist[_], u = e.indexOf(l.mstID);
                        a.update(l, u)
                    }
                }
