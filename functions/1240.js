const function1240 = function (t, e, i) {
    ...
    var o = i(2), r = i(6), s = i(18), a = i(1), _ = function (t) {
        function e(e, i) {
        ...
        return n(e, t), e.prototype._start = function () {
            ...
            var t = this, e = this._model.sortie.now_cell_no, i = this._scene.resInfo.getRationConfirmOffset(e),
            ...
            createjs.Tween.get(this._confirm).wait(200).to({ y: e, alpha: 0 }, 300).call(function () {
    ...
    var u = function (t) {
        function e(e, i) {
            ...
            }, n._cb_onSelect = i, n._box = new PIXI.Sprite, n._box.position.set(-120, -135), n.addChild(n._box), n._beak = new PIXI.Sprite, n._beak.position.set(30, -59), n.addChild(n._beak), null != e && (n._box.x += e.x, n._box.y += e.y, n._beak.x += e.x, n._beak.y += e.y), n._btn_yes = new l(n._onClickYes), n._btn_yes.position.set(-65, 42), n.addChild(n._btn_yes), n._btn_no = new l(n._onClickNo), n._btn_no.position.set(68, 42), n.addChild(n._btn_no), n
        }
