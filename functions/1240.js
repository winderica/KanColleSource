const function1240 = function (t, e, i) {
    "use strict";
    ...
    var c = function (t) {
        function i() {
            ...
            return i.Dispose = function () {
                ...
                switch (i._type) {
                    case 1:
                        t = function () {
                            createjs.Tween.get(i._girl).to({ y: 368, alpha: 1 }, e.COMPASS_FADEIN)
                        };
                        break;
                    case 2:
                    case 3:
                        t = function () {
                            createjs.Tween.get(i._girl).to({ y: 353, alpha: 1 }, e.COMPASS_FADEIN)
                        };
                        break;
                    case 4:
                        t = function () {
                            createjs.Tween.get(i._girl).to({ x: 960, y: 353, alpha: 1 }, e.COMPASS_FADEIN)
                        }
                }
                createjs.Tween.get(null).call(function () {
                    createjs.Tween.get(i._compass).to({ alpha: 1 }, 300), createjs.Tween.get(i._compass.scale).to({
                        x: 1,
                        y: 1
                    }, 300), createjs.Tween.get(i._pin).to({ alpha: 1 }, 300), createjs.Tween.get(i._pin.scale).to({
                        x: 1,
                        y: 1
                    }, 300), createjs.Tween.get(i._light).to({ alpha: .8 }, 300), createjs.Tween.get(i._light.scale).to({
                        x: 1,
                        y: 1
                    }, 300), createjs.Tween.get(i._bg).to({ alpha: .3 }, 300)
                ...
                switch (i._type) {
                    ...
                    case 4:
                        ...
                        createjs.Tween.get(i._girl).to({ y: 363 }, 33).to({ y: 321 }, 133).to({ y: 384 }, 133).to({ y: 351 }, 33).wait(100).call(function () {
                            e()
                        })
                }
            }, i
        ...
        return o(i, t), i.prototype.initialize = function (t) {
            ...
            switch (this._type) {
                case 1:
                    createjs.Tween.get(this._compass).to({ rotation: n(360) }, 700).call(function () {
                        t._text.text = t._message3, t.speedDown()
                    });
                    break;
                case 2:
                    createjs.Tween.get(this._compass).to({ rotation: n(720 + this._targetR) }, 1e3).call(function () {
                        t._text.text = t._message3, t.vibrateCompass()
                    });
                    break;
                case 3:
                    createjs.Tween.get(this._compass).to({ rotation: n(1080) }, 700).call(function () {
                        t._text.text = t._message3, t.speedDown()
                    ...
                    break;
                case 4:
                    createjs.Tween.get(this._compass).to({ rotation: n(2160) }, 900).call(function () {
                        t._text.text = t._message3, t.speedDown()
                    })
            }
            ...
            switch (this._type) {
                case 1:
                    createjs.Tween.get(this._compass).to({ rotation: n(360 + this._targetR) }, 600, createjs.Ease.quadOut).call(function () {
                        t.outAnimation()
                    });
                    break;
                case 3:
                    this._span = 0, createjs.Tween.get(this._compass).to({ rotation: n(1440 + this._targetR) }, 1300, createjs.Ease.quadOut).call(function () {
                        t.outAnimation()
                    ...
                    break;
                case 4:
                    createjs.Tween.get(this._compass).to({ rotation: n(2520 + this._targetR) }, 700, createjs.Ease.quadOut).call(function () {
                        t.outAnimation()
                    })
            }
            ...
            switch (this._type) {
                ...
                case 3:
                    i = function () {
                        createjs.Tween.get(t._girl).to({ alpha: 0 }, 433)
                    };
                    break;
                case 4:
                    i = function () {
                        createjs.Tween.get(t._girl).to({ x: 1185, y: t._girl.y - 53, alpha: 0 }, 433)
                    }
            }
            createjs.Tween.get(null).wait(800).call(function () {
                t._isSwing = !1, e(), createjs.Tween.get(t._compass).to({ alpha: 0 }, 300), createjs.Tween.get(t._compass.scale).to({
                    x: 1.36,
                    y: 1.36
                }, 300), createjs.Tween.get(t._pin).to({ alpha: 0 }, 300), createjs.Tween.get(t._pin.scale).to({
                    x: 1.36,
                    y: 1.36
                }, 300), createjs.Tween.get(t._light).to({ alpha: 0 }, 300), createjs.Tween.get(t._light.scale).to({
                    x: 1.36,
                    y: 1.36
                }, 300), createjs.Tween.get(t._text).to({ alpha: 0 }, 300), createjs.Tween.get(t._txtBox).to({ alpha: 0 }, 300), createjs.Tween.get(t._bg).to({ alpha: 0 }, 300), i()
