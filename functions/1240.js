const function1240 = function (t, e, i) {
    ...
    var o = i(0), r = i(2), s = i(241), a = i(27), _ = i(14), l = i(1241), u = i(1242), c = i(1243), h = i(1244),
        p = i(1246), d = i(1248), f = i(1249), y = i(1253), m = i(1258), v = i(1259), g = i(1260), b = i(1261),
        w = i(1263), x = i(1265), I = i(1269), T = i(435), O = function (t) {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "battle_model", {
                ...
                if (0 == this._next.balloonID) this._underwayReplenishment(); else {
                    ...
                    1 == n.direction && (s = 7);
                    var _ = this._model.sortie.map_id, l = this._next.no, u = null;
                    if (423 == _) {
                        if (11 == l) s = 1; else if (13 == l || 21 == l) s = 7; else if (25 == l) {
                ...
                var t = this, e = this._scene.model.sortie.area_id, i = this._scene.model.sortie.map_no,
                    ...
                    a = this._scene.resInfo, l = this._scene.view.map.plane_layer, u = o.default.view.overLayer,
                ...
                if (this._battle_model.map_info.init(o, r, a, t, _), 1 == e.hasEventMapData()) {
                    var l = this._model.sortie.getNextCell().gauge_max, u = this._model.sortie.getNextCell().gauge_now,
                    ...
                    var l = this._model.sortie.map.defeat_required, u = l - this._model.sortie.map.defeat_count,
