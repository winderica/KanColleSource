const function928 = function (t, e, i) {
    "use strict";
    ...
    var o = i(0), r = i(1), s = i(142), a = i(8), _ = i(4), u = i(25), l = i(354), c = i(355), h = i(356),
        p = i(936), d = i(358), f = function (t) {
            function e(e, i, n) {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "selected_airunit_id", {
                ...
                if (void 0 === e && (e = !1), (0 != e || this._selected_airunit_id != t) && !(t <= 0 || t > this._models.length)) {
                    ...
                    this._banner.update(t, _), 0 == _ ? (this._tag.update(0, !1), this._tag.enabled = !1) : (this._tag.update(i.airUnitState, !1), this._tag.enabled = !0), this._supply_btn.update(u)
                }
