const function728 = function (t, e, i) {
    "use strict";
    ...
    var o = i(1), r = i(110), s = i(329), a = i(32), _ = i(81), u = i(4), l = i(20), c = i(9), h = i(55),
        p = i(319), d = i(13), f = function (t) {
            function e() {
                ...
                return e.containerName.mask = T, e.containerName.addChild(e.textName, T), n.addChild(y), e.addChild(i, e.starRateView, e.containerName, v, e.textLevel, g, e.textHoug, m, e.textRaig, I, e.textTaiku, x, e.textSoukou, b, e.fuelMeterView, w, e.ammoMeterView, e.hpGaugeView, e.slotItemSlotContainer, e.textHp, e.shipBanner, e.changeButton, n), e._defaultPosition(), e
            }

            return n(e, t), e.prototype.dispose = function () {
                this.containerName.removeChildren(), this.fuelMeterView.dispose(), this.ammoMeterView.dispose(), this.hpGaugeView.dispose(), this.shipBanner.dispose(), this.starRateView.dispose(), this.slotItemSlotContainer.dispose(), this.changeButton.removeAllListeners(o.EventType.MOUSEOVER), this.changeButton.removeAllListeners(o.EventType.MOUSEOUT), this.changeButton.removeAllListeners(o.EventType.CLICK), this.containerName.mask = null, this.containerName = null, this.onMouseOut = this.onMouseOver = this.onClick = this.onClickChange = null, this.fuelMeterView = null, this.ammoMeterView = null, this.hpGaugeView = null, this.shipBanner = null, this.starRateView = null, this.slotItemSlotContainer = null, this.changeButton = null, this.textHp = null, this.textLevel = null, this.textHoug = null, this.textRaig = null, this.textTaiku = null, this.textSoukou = null, this.textName = null, this.removeChildren()
