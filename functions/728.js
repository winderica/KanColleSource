const function728 = function (t, e, i) {
    ...
    var n = i(14), o = i(0), r = function () {
        ...
        return Object.defineProperty(t.prototype, "presetID", {
            ...
            for (var t = 0; t < this._ships.length; t++) if (null != this._ships[t]) return this._ships[t];
            return null
        }, t.prototype.hasOtherDeckShip = function (t) {
            for (var e = 0; e < this._ships.length; e++) if (this.isOtherDeckShip(e, t)) return !0;
            return !1
        }, t.prototype.isOtherDeckShip = function (t, e) {
            if (null != this._ships[t]) {
                var i = this._ships[t], n = o.default.model.deck.isInDeck(i.memID);
                return null != n && n[0] != e
            }
            return !1
        }, t.prototype.getFirstOtherDeckShip = function (t) {
            for (var e = 0; e < this._ships.length; e++) if (this.isOtherDeckShip(e, t)) return this._ships[e];
            return null
        }, t.prototype.hasLostShip = function () {
            for (var t = 0; t < this._ships.length; t++) if (this.isLostShip(t)) return !0;
            return !1
            ...
            if (null != t) for (var e = 0; e < t.length; e++) {
                var i = t[e], n = o.default.model.ship.get(i);
                this._ships.push(n)
            }
