const function317 = function (t, e, i) {
    "use strict";
    ...
    var o = i(0), r = i(31), s = i(677), a = i(67), _ = i(37), u = i(9), l = function (t) {
        function e(e, i) {
            var n = t.call(this) || this;
            n.kira = !1;
            var o = new PIXI.Sprite, r = new PIXI.Sprite, _ = new PIXI.Sprite, u = new c, l = new s.CardKirakira,
                h = new a.RingLarge;
            return h.initialize(), h.activate(), h.position.set(263, 383), _.position.set(200, 342), n.addChild(o, r, _), u.position.x = 165, i && n.addChild(u), e && (n.addChild(l), l.visible = !1, l.play()), n.addChild(h), n.shipCard = o, n.burned = r, n.state = _, n.tired = u, n.cardKirakira = l, n.kira = e, n.ring = h, n
        }
        ...
        return n(e, t), e.prototype.dispose = function () {
            ...
            var i = t.isRepair();
            if (this.ring.visible = !1, t.isMarriage() && (this.ring.visible = !0), i) this.__updateState__(5); else if (e) this.__updateState__(4); else {
            ...
            switch (t) {
                case 0:
                    ...
                    break;
                case 1:
                    this.state.texture = u.COMMON_MISC.getTexture(93);
                    break;
                case 2:
                    this.state.texture = u.COMMON_MISC.getTexture(90);
                    break;
                case 3:
                    this.state.texture = u.COMMON_MISC.getTexture(95);
                    break;
                case 4:
                    this.state.texture = u.COMMON_MISC.getTexture(91);
                    break;
                case 5:
                    this.state.texture = u.COMMON_MISC.getTexture(94)
            }
    ...
    var c = function (t) {
        ...
        return n(e, t), e.prototype.updateTired = function (t) {
            this.removeChildren(), this.bg.texture = PIXI.Texture.EMPTY, this.face.texture = PIXI.Texture.EMPTY, t < 20 ? (this.bg.texture = u.COMMON_MISC.getTexture(34), this.face.texture = u.COMMON_MISC.getTexture(113)) : t < 30 && (this.bg.texture = u.COMMON_MISC.getTexture(33), this.face.texture = u.COMMON_MISC.getTexture(112)), this.addChild(this.bg, this.face)
