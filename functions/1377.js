const function1377 = function (t, e, i) {
    ...
    var o = i(0), r = i(16), s = i(12), a = i(6), _ = i(88), u = i(255), l = function (t) {
        function e() {
    ...
    var c = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function (t) {
            this.scale.x = t ? 1 : -1;
            var e = t ? 1 : 0;
            this._bg1.texture = _.BATTLE_TELOP_SP.getTexture(e), this._bg2.texture = _.BATTLE_TELOP_SP.getTexture(e)
        ...
        return n(e, t), e.prototype.initialize = function (t, e) {
            ...
            var i = t ? 1 : 0;
            this._bg.texture = _.BATTLE_TELOP_SP.getTexture(i), this._item.texture = o.default.resources.getSlotitem(e, "item_up")
        }, e.prototype.show = function (t) {
            var e = this;
            createjs.Tween.get(this._bg).wait(t).to({ x: 18, y: 399, alpha: 1 }, 366).wait(200).call(function () {
                ...
                a.SE.play("105")
            }).to({ scaleX: 2, scaleY: 2, alpha: 1 }, 500).call(function () {
                a.SE.play("109")
            })
        }, e
