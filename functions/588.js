const function588 = function (t, e, i) {
    ...
    var o = i(5), r = i(0), s = i(1), a = i(2), _ = i(8), u = i(16), l = i(589), c = i(58), h = i(51), p = i(14),
        d = i(145), f = i(285), y = function (t) {
            function e(e, i) {
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                for (var t = this, e = new p.ShipLoader, i = this._expedition_result.ship_mem_ids, n = 0; n < i.length; n++) {
                    var o = i[n], s = r.default.model.ship.get(o), a = s.mstID, _ = s.isDamaged();
                ...
                var e = r.default.model.basic.nickName, i = this._expedition_result.user_level,
                    n = r.default.model.basic.rankName, o = r.default.model.deck.get(this._deck_id).name;
                this._view.user_info.update(e, i, n, o), this._view.user_info.visible = !0;
                for (var s = this._expedition_result.ship_mem_ids, a = new createjs.Timeline([], null, { paused: !0 }), _ = this._view.banners, u = 0; u < _.length; u++) {
                    var l = _[u];
                    if (s.length <= u) l.visible = !1; else {
                        var c = r.default.model.ship.get(s[u]);
                        l.y = 68 * u + 15, l.alpha = 0, l.update(c, !1);
                        var h = createjs.Tween.get(l).wait(200 * u).to({ y: l.y - 15, alpha: 1 }, 200);
                        a.addTween(h)
                    }
                }
                for (var p = this._view.infos.items, u = 0; u < p.length; u++) {
                    var d = p[u];
                    if (s.length <= u) d.visible = !1; else {
                        var c = r.default.model.ship.get(s[u]);
                ...
                var t = this;
                createjs.Tween.get(this._telop_label).to({ alpha: 0 }, 100), createjs.Tween.get(this._telop_result).to({ alpha: 0 }, 100), createjs.Tween.get(this._telop_bg.scale).wait(100).to({ y: 0 }, 50).call(function () {
                ...
                var t = this;
                this._view.bonus.alpha = 0, this._view.bonus.visible = !0, createjs.Tween.get(this._view.bonus).to({ alpha: 1 }, 100), this._view.item.alpha = 0, this._view.item.visible = !0, createjs.Tween.get(this._view.item).wait(50).to({ alpha: 1 }, 100).call(function () {
                    t._waitClick2()
                });
                var e = this._expedition_result.ship_mem_ids[0], i = r.default.model.ship.get(e),
                    n = r.default.resources.getShip(i.mstID, i.isDamaged(), "full"), o = new PIXI.Sprite(n),
                ...
                var t = this;
                this._gear_btn.deactivate(), this._gear_btn.dispose(), this._removeChild(this._gear_btn), createjs.Tween.get(this._view).to({ alpha: 0 }, 200), createjs.Tween.get(this._shutter).to({ alpha: 0 }, 200).call(function () {
