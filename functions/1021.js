        ...
        g = function (t) {
            ...
            return n(e, t), e.prototype.initialize = function (t, e, i) {
                ...
                if (_.position.set(24, 11), this._decks.initialize(e), this._rader.initialize(), this._arrow.initialize(), this.addChild(n), this.addChild(a), this.addChild(_), this.addChild(this._banners), this.addChild(this._decks), this.addChild(this._rader), this.addChild(this._arrow), this._alert.initialize(), this.addChild(this._alert), o.default.model.deck.exist3rdUnit) {
                    var u = new PIXI.Sprite(r.COMMON_MISC.getTexture(188));
                ...
                var _ = o.default.model.ndock.getShipMemIDs(),
                    u = this._airunit_limit,
                    l = this._selected_map.area_id,
                    c = o.default.model.airunit.getReadyAirUnitList(l),
                    h = !1,
                ...
                if (this._btn.enabled = g.result, this._btn.air_unit = u > 0 && c.length > 0, this._alert.update(g.reason), this._arrow.enabled = g.result, this._arrow.update(r), this._arrow.activate(), 0 == o.default.model.basic.getExtraSupplySortie()) this._temp_supply_btn.visible = !1;
