const function304 = function (t, e, i) {
    "use strict";
    ...
    var o = i(0), r = i(1), s = i(2), a = i(8), _ = i(58), u = i(41), l = i(28), c = i(23), h = i(65), p = i(9),
        d = i(202), f = i(613), y = i(614), v = i(615), g = function (t) {
            function e(e, i) {
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                for (var t = this, e = new l.SerialTask, i = 0, n = this._model.melt_into_items; i < n.length; i++) {
                    var o = n[i], r = o.items, s = o.direction, a = o.eff_type,
                        _ = new v.MeltIntoTask(this._layer, r, s, a);
                    e.add(_)
                }
                e.start(function () {
                    t._change()
