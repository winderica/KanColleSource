        ...
        v = function (t) {
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                if (1 == this._scene.view.bannerGroupLayer.isEnteredEnemy()) {
                    var u = i.getCountMainDeck(),
                        l = i.getCountSubDeck();
                    t.model.map_info.isLongRangeFires() ? this._scene.view.raderLayer.rader_e.show(a, _, 0, 0, !0) : this._scene.view.raderLayer.rader_e.show(a, _, u, l, !1)
                ...
                if (46 == n && 1 == o && a > 1 && 8 == s) return void this._endTask();
                if (46 == n && 3 == o && a > 1 && (13 == s || 22 == s)) return void this._endTask();
                if (46 == n && 4 == o && a > 1 && 16 == s) return void this._endTask();
                if (46 == n && 5 == o && a > 1 && 10 == s) return void this._endTask();
                if (46 == n && 6 == o && a > 1 && 16 == s) return void this._endTask();
                var _ = l.GaugeSetModel.createKey(n, o, a),
                    u = r.default.resources.gauge.createLoaderHorizontal();
