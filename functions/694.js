const function694 = function (t, e, i) {
    ...
    var o = i(3), r = i(57), s = function (t) {
        function e() {
            ...
            var f = o.ORGANIZE_RENGO.getTexture(1), y = new PIXI.Sprite(f), v = o.ORGANIZE_RENGO.getTexture(4),
                m = new PIXI.Sprite(v), g = o.ORGANIZE_RENGO.getTexture(7), b = new PIXI.Sprite(g);
            return e.buttonKido.onClick = e._onClickKido, e.buttonSuijo.onClick = e._onClickSuijo, e.buttonYuso.onClick = e._onClickYuso, e.buttonBack.onClick = e._onClickBack, a.position.set(189, 25), e.buttonKido.position.set(84, 61), e.buttonSuijo.position.set(298, 61), e.buttonYuso.position.set(84, 124), e.buttonBack.position.set(211, 192), y.position.set(84, 61), m.position.set(298, 61), b.position.set(84, 124), e.buttonSuijo.visible = e.buttonYuso.visible = e.buttonKido.visible = !1, e.addChild(s, y, m, b, e.buttonKido, e.buttonSuijo, e.buttonYuso, e.buttonBack, a), e
        }
