const function1248 = function (t, e, i) {
    ...
    var o = i(2), r = i(28), s = i(20), a = i(1249), _ = function (t) {
        function e(e, i, n) {
        ...
        return n(e, t), e.prototype._start = function () {
            ...
            this._balloon = new u, this._balloon.initialize(), this._balloon.x = t.x + 21, this._balloon.y = t.y - 6, this._balloon.alpha = 0, null != this._offset && (this._balloon.x += this._offset[0].x, this._balloon.y += this._offset[0].y), this._scene.view.universal_layer.addChild(this._balloon), createjs.Tween.get(this._balloon).wait(200).to({
