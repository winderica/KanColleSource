const function1165 = function (t, e, i) {
    "use strict";
    ...
    var o = i(0), r = i(1), s = i(2), a = i(18), _ = i(4), l = i(6), u = i(108), c = i(407), h = function (t) {
        function e(e, i) {
            var n = t.call(this) || this;
            return n._result = !1, n._showDialog = function () {
                var t = o.default.model.useItem.getCount(44), e = o.default.model.useItem.getCount(52);
                n._dialog = new p(n._onResult), n._dialog.initialize(n._model, t, e), n._dialog.alpha = 0, n._fade.addChild(n._dialog), createjs.Tween.get(n._dialog).to({ alpha: 1 }, 150).call(function () {
                    n._dialog.activate()
                })
    ...
    var p = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function (t, e, i) {
            this._bg.texture = u.ITEM_FSHOP.getTexture(52);
            var n = t.price;
            this._btn_nominal.initialize(n, e >= n), n = t.getDiscountPrice(), this._btn_discount.initialize(n, e >= n && i > 0), this._btn_back.texture = u.ITEM_FSHOP.getTexture(1)
        ...
        return n(e, t), e.prototype.initialize = function (t, e) {
            this._enabled = e, this.texture = 1 == e ? u.ITEM_FSHOP.getTexture(2) : u.ITEM_FSHOP.getTexture(3), this._price.text = t.toString(), this._price.x = Math.floor(72 - this._price.width / 2)
        }, e.prototype.activate = function () {
        ...
        return n(e, t), e.prototype.initialize = function (t, e) {
            this._enabled = e, this.texture = 1 == e ? u.ITEM_FSHOP.getTexture(4) : u.ITEM_FSHOP.getTexture(5), this._price.text = t.toString(), this._price.x = Math.floor(70 - this._price.width / 2)
        }, e.prototype.activate = function () {
            0 != this._enabled && (this.buttonMode = !0, this.once(r.EventType.CLICK, this._onClick))
        }, e.prototype.deactivate = function () {
            this.buttonMode = !1, this.off(r.EventType.CLICK, this._onClick)
