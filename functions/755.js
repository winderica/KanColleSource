    ...
    var o = i(3), r = i(1), s = function (t) {
        function e() {
            ...
            var i = o.SUPPLY_MAIN.getTexture(10), n = o.SUPPLY_MAIN.getTexture(9), s = o.SUPPLY_MAIN.getTexture(11),
                a = o.SUPPLY_MAIN.getTexture(4), _ = o.SUPPLY_MAIN.getTexture(3), l = o.SUPPLY_MAIN.getTexture(5),
                u = o.SUPPLY_MAIN.getTexture(7), c = o.SUPPLY_MAIN.getTexture(6), h = o.SUPPLY_MAIN.getTexture(8),
                p = new PIXI.Sprite(i), d = new PIXI.Sprite(u), f = new PIXI.Sprite(a);
