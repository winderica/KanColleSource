const function1033 = function (t, e, i) {
    "use strict";
    ...
    var o = i(0), r = i(4), s = i(13), a = i(38), _ = i(1034), u = i(1035), l = i(1036), c = i(1),
        h = function (t) {
            function e(e) {
                ...
                return i._target_id = -1, i._onMouseOver = function () {
                    ...
                    var e = t.data, n = o.default.model.basic.member_id,
                ...
                }, i._cb_onClick = e, i._focus = new PIXI.extras.TilingSprite(PIXI.Texture.EMPTY, 655, 45), i.addChild(i._focus), i._txt_id = new r.TextBox(21, 4999235), i._txt_id.anchor.set(1, 0), i._txt_id.position.set(43, 12), i.addChild(i._txt_id), i._txt_name = new r.TextBox(21, 4999235), i._txt_name.position.set(49, 12), i.addChild(i._txt_name), i._txt_numship = new r.TextBox(28, 3768020), i._txt_numship.anchor.x = 1, i._txt_numship.position.set(420, 4), i.addChild(i._txt_numship), i._txt_numship_label = new r.TextBox(16, 4999235), i._txt_numship_label.position.set(420, 15), i.addChild(i._txt_numship_label), i._difficulty = new _.ExpeditionDifficulty, i._difficulty.position.set(495, 7), i.addChild(i._difficulty), i._state = new u.ExpeditionStateIcon, i._state.position.set(543, 7), i.addChild(i._state), i._deckIcon = new l.ExpeditionDeckIcon, i._deckIcon.position.set(616, 22), i.addChild(i._deckIcon), i._hit_area = new PIXI.Graphics, i._hit_area.beginFill(0, 0), i._hit_area.drawRect(0, 0, 655, 45), i._hit_area.endFill(), i.addChild(i._hit_area), i
            }
            ...
            return n(e, t), Object.defineProperty(e.prototype, "target_id", {
                ...
                if (null == t) this._target_id = -1, this.visible = !1; else {
