const function425 = function (t, e, i) {
    "use strict";
    ...
    var o = i(5), r = i(0), s = i(6), a = i(9), _ = i(4), u = i(58), l = i(426), c = i(41), h = i(23),
        p = function (t) {
            function e() {
            ...
            return n(e, t), Object.defineProperty(e.prototype, "whiteMask", {
                ...
                var n = r.default.model.slot.getMst(e), o = n.rarity;
                ...
                var t = this;
                this._IsAnime = !0, this._tween = createjs.Tween.get(this).wait(10).to({ alpha: 1 }, 1e3).call(function () {
                    t._scene.visible = !1, t._CMB_getbg.alpha = 1, t._ItemCard_before.alpha = 1, t._ItemCard_after.alpha = .01, t._CMM_mes_j_bg.alpha = 1, t._message.alpha = .01, t._tween = null, t._tween2 = createjs.Tween.get(t._whiteMask).wait(100).to({ alpha: .75 }, 250).call(function () {
                        t._tween2 = null, t._scene1()
                    })
                })
            }, e.prototype._scene1 = function () {
                var t = this;
                this._whiteMask.interactive = !0, this._tween2 = createjs.Tween.get(this._whiteMask).to({ alpha: 0 }, 750).call(function () {
                    t._tween2 = null
                }), this._tween = createjs.Tween.get(this._ItemCard_before).to({ y: 243 }, 1e3).wait(1e3).to({
                    x: 408,
                    width: 351,
                    height: 351
                    ...
                    t._tween1 = null
                }), this._tween2 = createjs.Tween.get(this._CMM_mes_j_bg).wait(500).to({ y: 480 }, 500).call(function () {
                    t._tween2 = null, t._message.text = " \u88c5\u5099\u6539\u4fee\u4e2d\u2026", t._message.position.set(600 - Math.floor(t._message.width / 2), 600), t._tween2 = createjs.Tween.get(t._message).to({ alpha: 1 }, 250).wait(2500).to({ alpha: 0 }, 250).call(function () {
                        t._message.text = r.default.model.slot.getMst(t._ItemID_after).name + "\u306b\u88c5\u5099\u304c\u6539\u4fee\u66f4\u65b0\u3055\u308c\u307e\u3057\u305f\uff01", t._message.position.set(600 - Math.floor(t._message.width / 2), 600), t._revampRingParticleLayer.initialize()
                    }).to({ alpha: 1 }, 250).wait(1e3).call(function () {
                ...
                this._revampRingParticleLayer.dispose(), null != this.btn && (this.btn.dispose(), this.btn = null), this._tween = createjs.Tween.get(this).wait(10).call(function () {
                    ...
                    t._tween = null, t._whiteMask.alpha = 1, t._whiteMask.interactive = !1, t._IsFinished = !0, t._IsAnime = !1, t.removeChildren()
                })
            }, e
        }(PIXI.Container);
