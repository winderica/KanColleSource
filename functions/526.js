const function526 = function (t, e, i) {
    ...
    var a = i(0), _ = i(266), u = i(22), l = i(76), c = i(527), h = function () {
        function t() {
            var t = this;
        ...
        return Object.defineProperty(t.prototype, "num_of_simultaneous_playback", {
            ...
            if (this._voices.length >= this._num_of_simultaneous_playback) {
                this._voices.shift().dispose()
            }
            var n = new p(this._onVoiceEnd, i);
            return this._voices.push(n), n.play(t, e), n
    ...
    var p = function (t) {
        ...
        return s(e, t), Object.defineProperty(e.prototype, "cb_onEnd", {
            ...
            null != this._howl && this._howl.stop(), this._howl = null, this._cb_onEndToManager = null, this._cb_onEnd = null
        }, e
    }(c.VoiceModel)
}