    ...
    var o = i(3), r = function (t) {
        function e() {
            ...
            for (var n = 0; n < e.STAR; n++) {
                ...
                var s = Math.sin(Math.PI / 180 * (360 * i)), a = Math.cos(Math.PI / 180 * (360 * i)),
                    _ = { x: 0, y: 0 };
        ...
        return n(e, t), e.prototype.updateStarPosition = function () {
            for (var t = 0; t < this.stars.length; t++) {
                var e = Math.PI / 180 * (360 * Math.random()), i = Math.sin(e), n = Math.cos(e);
            ...
            for (var e = Math.PI / 180 * (180 * t), i = 0; i < this.stars.length; i++) {
                var n = this.stars[i], o = this.starTables[i];
