const function1487 = function (t, e, i) {
    ...
    var _ = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function () {
            this._text1.texture = r.BATTLE_RESULT_EVENT_ED1_GYKQXDKFPZIHNCFT.getTexture(5), this._text1.position.set(124, 271), this._text2.texture = r.BATTLE_RESULT_EVENT_ED1_GYKQXDKFPZIHNCFT.getTexture(6), this._text2.position.set(329, 514), this._text3.texture = r.BATTLE_RESULT_EVENT_ED1_GYKQXDKFPZIHNCFT.getTexture(7), this._text3.position.set(305, 577)
        }, e
    }(s.TextsBase)
}