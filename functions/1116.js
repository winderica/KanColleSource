    ...
    var o = i(0),
        ...
        _ = function (t) {
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                var t = this,
                    e = new s.UIImageLoader("item");
                e.add("item_ilist_medal.json"), e.add("item_ilist_medal_kou.json"), e.add("item_ilist_presentbox.json"), e.add("item_ilist_hishimochi.json"), e.add("item_ilist_sanma.json"), e.add("item_ilist_iwashi.json"), e.load(function () {
                    t._loadSkinResource()
                })
