const function1419 = function (t, e, i) {
    ...
    var o = i(15), r = function (t) {
        ...
        return n(e, t), e.prototype.dispose = function () {
            ...
            var i = Math.min(this.from.x, this.to.x), n = Math.min(this.from.y, this.to.y) - t,
                o = Math.abs(this.to.x - this.from.x), r = Math.abs(this.to.y - this.from.y) + 2 * t;
            ...
            var i = this;
            void 0 === t && (t = 1800), void 0 === e && (e = null), createjs.Tween.get(this.sprite).to({ alpha: 1 }, 200).wait(Math.max(t - 400, 0)).to({ alpha: 0 }, 200).call(function () {
                i.removeChildren(), null != e && e()
            }), createjs.Tween.get(this.sprite).to({ x: this.to.x, y: this.to.y }, t)
        }, e.prototype._aerial1 = function (t) {
            var e = this;
            switch (void 0 === t && (t = null), this.type) {
                case 3:
                    createjs.Tween.get(this).to({ y: this.from.y + 90 }, 800, createjs.Ease.sineIn).call(function () {
                        e.removeChildren(), e._aerial2(t)
                    });
                    break;
                case 5:
                    var i = new s;
                    i.initialize(), i.activate(), i.scale.x = this.friend ? -1 : 1, this.addChild(i), createjs.Tween.get(this).to({ y: this.from.y + 90 }, 500, createjs.Ease.sineIn).call(function () {
            ...
            switch (this.type) {
                case 3:
                    ...
                    n.anchor.set(1, .5), n.scale.set(0, 1), n.rotation = i, this.addChild(n), createjs.Tween.get(n.scale).to({ x: 1 }, 100), createjs.Tween.get(this).to({
                        x: this.to.x,
                        y: this.to.y
                    }, 700).to({ alpha: 0 }, 50).call(function () {
                        e.removeChildren(), e.emit("complete")
                    });
                    break;
                case 5:
                    var r = new a;
                    r.scale.set(0, 1), r.initialize(), r.activate(), r.rotation = i, this.addChild(r), createjs.Tween.get(r.scale).to({ x: 1 }, 100), createjs.Tween.get(this).to({
                        x: this.to.x,
                        y: this.to.y
                    }, 700).to({ alpha: 0 }, 50).call(function () {
                ...
                case 4:
                    ...
                    n.anchor.set(1, .5), n.scale.set(0, 1), n.rotation = i, this.addChild(n), createjs.Tween.get(n.scale).to({ x: 1 }, 50), createjs.Tween.get(this).to({
                        x: this.to.x,
                        y: this.to.y
                    }, 560).to({ alpha: 0 }, 50).call(function () {
    ...
    var s = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function () {
            ...
            if (null == this._tweens) {
                ...
                var t = createjs.Tween.get(this._bullet1, { loop: !0 }).to({ x: 3, y: 9 }, 300).to({
                    x: 2,
                    y: 8
                }, 300).to({ x: 6, y: 6 }, 200);
                this._tweens.push(t), this._bullet2.position.set(5, 17), t = createjs.Tween.get(this._bullet2, { loop: !0 }).to({
                    x: 6,
                    y: 18
                }, 200).to({ x: 3, y: 20 }, 300).to({
                    x: 53,
                    y: 17
                }, 300), this._tweens.push(t), this._bullet3.position.set(-8, -3), t = createjs.Tween.get(this._bullet3, { loop: !0 }).to({
                    x: -6,
                    y: -5
                }, 250).to({ x: -5, y: 0 }, 300).to({ x: -8, y: -3 }, 250), this._tweens.push(t)
            }
        ...
        return n(e, t), e.prototype.initialize = function () {
            ...
            if (null == this._tweens) {
                ...
                var t = createjs.Tween.get(this._bullet1, { loop: !0 }).to({ x: -8, y: 0 }, 250).to({
                    x: -2,
                    y: -12
                }, 250).to({ x: 6, y: 0 }, 250).to({ x: -3, y: 11 }, 250);
                this._tweens.push(t), this._bullet3.position.set(-14, -8), t = createjs.Tween.get(this._bullet3, { loop: !0 }).to({
                    x: 3,
                    y: 0
                }, 250).to({ x: -14, y: 8 }, 250).to({ x: -21, y: 0 }, 250).to({
                    x: -14,
                    y: -8
        ...
        function e(e) {
            var i = this, n = o.BATTLE_MAIN.getTexture(116);
