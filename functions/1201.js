const function1201 = function (t, e, i) {
    ...
    var o = i(0), r = i(50), s = i(2), a = i(6), _ = i(130), u = i(416), l = i(239), c = i(417), h = i(1204),
        p = i(1205), d = i(1206), f = i(23), y = i(1), v = i(25), m = i(14), g = function (t) {
            function e(e) {
            ...
            return n(e, t), e.prototype._start = function () {
                ...
                if (this._topView.revampBaloon._setBalloon1(0), this._topView.revampBaloon._setBalloon2(0), this._topView.revampBaloon._setBalloon3(0, 0), this._topView.revampakashi.AkashiMove(!0), this._topView.revampakashi.Spark(), a.SE.play("203"), this._topView.revampRecipeBox[this._NowSelectedBox].RevampFlash(t), 0 != t.voice_ship_id) {
                    ...
                    this._topView.revamp2ndShip.texture = PIXI.Texture.fromImage(m.ShipLoader.getPath(i, !1, "full"));
                ...
                for (var t = 10 * this._ListNowPage, e = this._items.slice(t, t + 10), i = 0; i < 10; i++) {
                    var n = null == e[i];
                    this._listView.focus_txt[i].dispose(), this._listView.focus_txt[i].initialize(2, 8), this._listView.focus_txt[i].interactive = this._listView.focus_txt[i].buttonMode = !n, this._listView.containerName[i].cacheAsBitmap = !1, this._listView.text_slotName[i].style.fill = 4999235, this._listView.text_slotName[i].text = n ? "" : e[i].name, this._listView.text_slotName[i].visible = !0, n && (this._listView.containerName[i].cacheAsBitmap = !0), this._listView.type_icon[i].texture = n ? PIXI.Texture.EMPTY : _.COMMON_ICON_WEAPON.getTextureFromMstID(e[i].iconType), this._listView.type_icon[i].visible = !n, this._listView.skill_lv[i].texture = n ? PIXI.Texture.EMPTY : this._skill2Texture(e[i].skillLevel), this._listView.skill_lv[i].visible = !n, this._listView.setStars(i, n ? 0 : e[i].level), this._listView.lock_on[i].visible = !n && e[i].isLocked()
                }
                ...
                for (var t = 0; t < 10; t++) this._listView.containerName[t].cacheAsBitmap = !1;
