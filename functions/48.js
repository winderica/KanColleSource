        ...
        r = function (t) {
            function e(e, i) {
                ...
                return n._onClose = function () {
                    n._dialog.get_icon.deactivate(), n._dialog.close_btn.deactivate(), n._dialog.message.update(null), createjs.Tween.get(n._dialog.bg).to({
                        alpha: 0
                    }, 200), createjs.Tween.get(n._dialog.light).to({
                        alpha: 0
                    }, 200), createjs.Tween.get(n._dialog.container).to({
                        alpha: 0
                    }, 200).call(function () {
