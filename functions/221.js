const function221 = function (t, e, i) {
    "use strict";
    ...
    var o = i(3), r = function (t) {
        function e() {
            var e = t.call(this) || this, i = new PIXI.Sprite(o.REPAIR_MAIN.getTexture(21)),
                n = new PIXI.Sprite(o.REPAIR_MAIN.getTexture(22)),
                r = new PIXI.Sprite(o.REPAIR_MAIN.getTexture(23)), s = new PIXI.Graphics;
        ...
        return n(e, t), e.prototype.update = function (t, e) {
            ...
            var e = .7 * (1 - t);
            this.redLight.visible = !0, this.redLight.alpha = 0, this.tween = createjs.Tween.get(this.redLight), this.tween.to({ alpha: e }, 1e3).to({ alpha: 0 }, 1e3), this.tween.loop = !0, this.tween.play(null)
