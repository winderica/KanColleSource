const function1161 = function (t, e, i) {
    ...
    var o = i(4), r = i(29), s = i(3), a = i(119), _ = i(119), u = i(119), l = i(119), c = i(119),
        h = function (t) {
            function e(e, i, n) {
    ...
    var p = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function () {
            ...
            t.models.length > 0 ? this._message.visible = !1 : (9 == t.selected_type ? this._message.texture = s.DUTY_COMMON.getTexture(62) : this._message.texture = s.DUTY_COMMON.getTexture(61), this._message.visible = !0)
        }, e.prototype.dispose = function () {
            for (var t = 0, e = this._items; t < e.length; t++) {
                e[t].dispose()
            }
