const function652 = function (t, e, i) {
    ...
    var o = i(3), r = function (t) {
        function e() {
            ...
            return i.position.set(195, 10), e.conBg = new PIXI.Sprite(o.COMMON_MAIN.getTexture(13)), e.titBg = new PIXI.Sprite(o.COMMON_MAIN.getTexture(60)), e.titBg.addChild(i), e.addChild(e.conBg), e.addChild(e.titBg), e
        }
