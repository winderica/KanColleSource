const function161 = function (t, e, i) {
    "use strict";
        ...
        a = function (t) {
            ...
            return n(e, t), e.prototype.dispose = function () {
                for (var t in this.PLACE_INFOS)
                    if (!1 !== this.PLACE_INFOS.hasOwnProperty(t)) {
                        var e = this.PLACE_INFOS[t];
                        for (var i in e)
                            if (!1 !== e.hasOwnProperty(i)) {
                                var n = this._lastTweens[i],
                                    o = this._materials[i];
                ...
                for (var s = this, a = i; a < n; a++) ! function (t) {
                    var e = s._materialKeys[t],
                        n = s._materials[e],
                        r = 50 * (t - i),
                        a = createjs.Tween.get(n),
                        _ = s._lastTweens[e];
