const function951 = function (t, e, i) {
    "use strict";
    ...
    var o = i(5), r = i(0), s = i(17), a = i(1), _ = i(2), u = i(21), l = i(8), c = i(4), h = i(22), p = i(65),
        d = i(6), f = i(9), y = i(25), v = i(952), g = function (t) {
            function e(e, i, n) {
                var o = t.call(this) || this;
                return o._onSelect = function (t) {
                    if (o._dialog.deactivate(), 0 == t) o._removeDialog(), o._endTask(); else {
                        new v.AirUnitExtendAPI(o._area_id).start(function () {
            ...
            return n(e, t), e.prototype._start = function () {
                this._bg = new l.AreaBox(.6), this._layer.addChild(this._bg), this._dialog = new m(this._onSelect), this._dialog.initialize();
                ...
                n.add(i), n.load(function () {
                    ...
                    var s = new PIXI.Sprite(y.SALLY_AIRUNIT.getTexture(106));
    ...
    var m = function (t) {
        ...
        return n(e, t), e.prototype.initialize = function () {
            this._bg.texture = y.SALLY_AIRUNIT.getTexture(66), this._title.texture = y.SALLY_AIRUNIT.getTexture(113), this._icon.texture = r.default.resources.getUseitem(73, 0), this._item_num.text = "1\u21920", this._logo.texture = y.SALLY_AIRUNIT.getTexture(46), this._btn_yes.texture = y.SALLY_AIRUNIT.getTexture(32), this._btn_no.texture = y.SALLY_AIRUNIT.getTexture(15)
