const function804 = function (t, e, i) {
    "use strict";
    ...
    var o = i(4), r = i(113), s = i(3), a = i(3), _ = i(339), u = i(84), l = i(805), c = i(806), h = i(807),
        p = i(808), d = function (t) {
            function e() {
                ...
                var g = new PIXI.Sprite(a.REMODEL_GRADEUP.getTexture(25));
            ...
            return n(e, t), e.prototype.activate = function (t, e) {
                ...
                if (0 == e.validate(58) ? (this._alertPanel.showAlertLackOfItem(58), l = !0) : 0 == e.validate(65) ? (this._alertPanel.showAlertLackOfItem(65), l = !0) : 0 == e.validate(75) ? (this._alertPanel.showAlertLackOfItem(75), l = !0) : 0 == e.validate(78) ? (this._alertPanel.showAlertLackOfItem(78), l = !0) : o > 0 && r > 0 && s > 0 ? this._alertPanel.showMessageThreeItems(58, o, 65, r, 78, s, _, u) : o > 0 && r > 0 ? this._alertPanel.showMessageTwoItems(58, o, 65, r, _, u) : o > 0 && s > 0 && a > 0 ? this._alertPanel.showMessageThreeItems(78, s, 75, a, 58, o, _, u) : o > 0 && s > 0 ? this._alertPanel.showMessageTwoItems(58, o, 78, s, _, u) : o > 0 ? this._alertPanel.showMessageOneItem(58, o, _, u) : s > 0 ? this._alertPanel.showMessageOneItem(78, s, _, u) : _ > 0 || u > 0 ? this._alertPanel.showMessageKits(_, u) : this._alertPanel.hideAll(), this._alertMessage.visible = !1, this._alertOverLimit.visible = !1, 0 == l) {
                ...
                this.deactivate(), this._shipPanelBefore.dispose(), this._shipPanelBefore = null, this._shipPanelAfter.dispose(), this._shipPanelAfter = null, this._textAmmoNow = null, this._textAmmoNeed = null, this._textSteelNow = null, this._textSteelNeed = null, this._cancelBtn.dispose(), this._cancelBtn = null, this._startBtn.dispose(), this._startBtn = null, this._arrow.dispose(), this._arrow = null, this._alertPanel.dispose(), this._alertPanel = null, this._alertMessage = null, this._alertOverLimit = null, this._header.dispose(), this._header = null, this._titleBar.dispose(), this._titleBar = null, this.removeChildren()
            }, e
        }(PIXI.Container);
    e.KaizoDetail = d
}