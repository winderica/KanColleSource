const function1469 = function (t, e, i) {
    ...
    var o = i(0), r = i(2), s = i(202), a = i(475), _ = i(242), u = i(6), l = i(36), c = i(476), h = function (t) {
        function e(e, i) {
        ...
        return n(e, t), e.prototype._start = function () {
            ...
            if (1 == i.isUseitem()) {
                var n = this._canvas, r = i.mst_id, u = new _.TaskBonusUseItem(n, r, i.count, !1, t);
                u.start(function () {
                    e._bonus(u)
                })
            } else if (1 == i.isShip()) {
                var n = this._canvas, r = i.mst_id, l = new s.TaskBonusShip(n, r, !1, t);
                l.start(function () {
                    e._bonus(l)
                })
            } else {
