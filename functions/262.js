const function262 = function (t, e, i) {
    ...
    var o = i(0), r = i(2), s = i(68), a = i(7), _ = i(28), u = i(13), l = function () {
        function t(t, e) {
            var i = this;
        ...
        return Object.defineProperty(t.prototype, "count", {
            ...
            for (var i = {}, n = new _.SerialTask, o = 0, r = this._keys; o < r.length; o++) {
                var s = r[o], a = this._version_map[s];
                n.add(new p(s, a, i))
            }
            n.start(function () {
    ...
    var c = function (t) {
        ...
        return n(e, t), e.prototype._onInfoLoadComplete = function (t) {
            ...
            for (var n in t) {
                ...
                var s = this._version_map[n] ? "?version=" + this._version_map[n] : "", a = r.image_path;
                -1 == i.indexOf(a) && null == PIXI.utils.TextureCache[a] && (i.push(a), e.add(a, "resources/gauge/" + a + ".png" + s)), a = r.image_light_path, -1 == i.indexOf(a) && null == PIXI.utils.TextureCache[a] && (i.push(a), e.add(a, "resources/gauge/" + a + ".png" + s))
            }
    ...
    var h = function (t) {
        ...
        return n(e, t), e.prototype._onInfoLoadComplete = function (t) {
            ...
            for (var n in t) {
                ...
                var s = r.vertical;
                if (null != s) {
                    var a = this._version_map[n] ? "?version=" + this._version_map[n] : "", _ = s.image_path;
                    -1 == i.indexOf(_) && null == PIXI.utils.TextureCache[_] && (i.push(_), e.add(_, "resources/gauge/" + _ + ".png" + a)), _ = r.vertical.image_light_path, -1 == i.indexOf(_) && null == PIXI.utils.TextureCache[_] && (i.push(_), e.add(_, "resources/gauge/" + _ + ".png?" + a))
                }
            }
            0 == i.length ? this._onImageLoadComplete(null, null) : e.load(this._onImageLoadComplete)
        }, e
